...
bool __builtin_usubll_overflow (unsigned long long int a, unsigned long long int b, unsigned long int *res) ;
bool __builtin_smul_overflow (int a, int b, int *res) ;
bool __builtin_smull_overflow (long int a, long int b, long int *res) ;
bool __builtin_smulll_overflow (long long int a, long long int b, long int *res) ;
...
bool __builtin_umulll_overflow (unsigned long long int a, unsigned long long int b, unsigned long int *res) ;
