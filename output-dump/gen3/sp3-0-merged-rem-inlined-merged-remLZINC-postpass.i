...
#pragma omp parallel
    {
        ...
        double fac1;
        double fac2;
        double ru1_imopVarPre18;
        int i_imopVarPre12;
        int j_imopVarPre13;
        int k_imopVarPre14;
        for (j_imopVarPre13 = 1; j_imopVarPre13 <= grid_points[1] - 2; j_imopVarPre13++) {
            for (k_imopVarPre14 = 1; k_imopVarPre14 <= grid_points[2] - 2; k_imopVarPre14++) {
#pragma omp for nowait
                for (i_imopVarPre12 = 0; i_imopVarPre12 <= grid_points[0] - 1; i_imopVarPre12++) {
                    ru1_imopVarPre18 = c3c4 * rho_i[i_imopVarPre12][j_imopVarPre13][k_imopVarPre14];
                    cv[i_imopVarPre12] = us[i_imopVarPre12][j_imopVarPre13][k_imopVarPre14];
                    int _imopVarPre715;
                    ...
                    _imopVarPre715 = ((dxmax + ru1_imopVarPre18) > dx1);
                    if (_imopVarPre715) {
                        _imopVarPre716 = (dxmax + ru1_imopVarPre18);
                    } else {
                        _imopVarPre716 = dx1;
                    }
                    _imopVarPre717 = ((dx5 + c1c5 * ru1_imopVarPre18) > _imopVarPre716);
                    if (_imopVarPre717) {
                        _imopVarPre718 = (dx5 + c1c5 * ru1_imopVarPre18);
                    } else {
                        _imopVarPre725 = ((dxmax + ru1_imopVarPre18) > dx1);
                        if (_imopVarPre725) {
                            _imopVarPre726 = (dxmax + ru1_imopVarPre18);
                        } else {
                            _imopVarPre726 = dx1;
                        }
                        _imopVarPre718 = _imopVarPre726;
                    }
                    _imopVarPre727 = ((dx2 + con43 * ru1_imopVarPre18) > _imopVarPre718);
                    if (_imopVarPre727) {
                        _imopVarPre728 = (dx2 + con43 * ru1_imopVarPre18);
                    } else {
                        _imopVarPre821 = ((dxmax + ru1_imopVarPre18) > dx1);
                        if (_imopVarPre821) {
                            _imopVarPre822 = (dxmax + ru1_imopVarPre18);
                        } else {
                            _imopVarPre822 = dx1;
                        }
                        _imopVarPre823 = ((dx5 + c1c5 * ru1_imopVarPre18) > _imopVarPre822);
                        if (_imopVarPre823) {
                            _imopVarPre824 = (dx5 + c1c5 * ru1_imopVarPre18);
                        } else {
                            _imopVarPre831 = ((dxmax + ru1_imopVarPre18) > dx1);
                            if (_imopVarPre831) {
                                _imopVarPre832 = (dxmax + ru1_imopVarPre18);
                            } else {
                                _imopVarPre832 = dx1;
                            }
                    ...
                    rhon[i_imopVarPre12] = _imopVarPre728;
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for nowait
                for (i_imopVarPre12 = 1; i_imopVarPre12 <= grid_points[0] - 2; i_imopVarPre12++) {
                    lhs[0][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = 0.0;
                    lhs[1][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = -dttx2 * cv[i_imopVarPre12 - 1] - dttx1 * rhon[i_imopVarPre12 - 1];
                    lhs[2][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = 1.0 + c2dttx1 * rhon[i_imopVarPre12];
                    lhs[3][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = dttx2 * cv[i_imopVarPre12 + 1] - dttx1 * rhon[i_imopVarPre12 + 1];
                    lhs[4][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = 0.0;
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
            }
...
#pragma omp for nowait
        for (j_imopVarPre13 = 1; j_imopVarPre13 <= grid_points[1] - 2; j_imopVarPre13++) {
            for (k_imopVarPre14 = 1; k_imopVarPre14 <= grid_points[2] - 2; k_imopVarPre14++) {
                lhs[2][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[2][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] + comz5;
                lhs[3][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[3][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] - comz4;
                lhs[4][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[4][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] + comz1;
                lhs[1][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] = lhs[1][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] - comz4;
                lhs[2][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] = lhs[2][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] + comz6;
                lhs[3][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] = lhs[3][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] - comz4;
                lhs[4][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] = lhs[4][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] + comz1;
            }
        }
#pragma omp for nowait
        for (i_imopVarPre12 = 3; i_imopVarPre12 <= grid_points[0] - 4; i_imopVarPre12++) {
            for (j_imopVarPre13 = 1; j_imopVarPre13 <= grid_points[1] - 2; j_imopVarPre13++) {
                for (k_imopVarPre14 = 1; k_imopVarPre14 <= grid_points[2] - 2; k_imopVarPre14++) {
                    lhs[0][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[0][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] + comz1;
                    lhs[1][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[1][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] - comz4;
                    lhs[2][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[2][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] + comz6;
                    lhs[3][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[3][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] - comz4;
                    lhs[4][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[4][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] + comz1;
                }
            }
        }
        i_imopVarPre12 = grid_points[0] - 3;
#pragma omp for nowait
        for (j_imopVarPre13 = 1; j_imopVarPre13 <= grid_points[1] - 2; j_imopVarPre13++) {
            for (k_imopVarPre14 = 1; k_imopVarPre14 <= grid_points[2] - 2; k_imopVarPre14++) {
                lhs[0][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[0][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] + comz1;
                ...
                lhs[2][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[2][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] + comz6;
                lhs[3][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[3][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] - comz4;
                lhs[0][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] = lhs[0][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] + comz1;
                lhs[1][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] = lhs[1][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] - comz4;
                lhs[2][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] = lhs[2][i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14] + comz5;
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for nowait
        for (i_imopVarPre12 = 1; i_imopVarPre12 <= grid_points[0] - 2; i_imopVarPre12++) {
            for (j_imopVarPre13 = 1; j_imopVarPre13 <= grid_points[1] - 2; j_imopVarPre13++) {
                for (k_imopVarPre14 = 1; k_imopVarPre14 <= grid_points[2] - 2; k_imopVarPre14++) {
                    lhs[0 + 5][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[0][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14];
                    lhs[1 + 5][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[1][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] - dttx2 * speed[i_imopVarPre12 - 1][j_imopVarPre13][k_imopVarPre14];
                    lhs[2 + 5][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[2][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14];
                    lhs[3 + 5][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[3][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] + dttx2 * speed[i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14];
                    lhs[4 + 5][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[4][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14];
                    lhs[0 + 10][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[0][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14];
                    lhs[1 + 10][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[1][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] + dttx2 * speed[i_imopVarPre12 - 1][j_imopVarPre13][k_imopVarPre14];
                    lhs[2 + 10][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[2][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14];
                    lhs[3 + 10][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[3][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] - dttx2 * speed[i_imopVarPre12 + 1][j_imopVarPre13][k_imopVarPre14];
                    lhs[4 + 10][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14] = lhs[4][i_imopVarPre12][j_imopVarPre13][k_imopVarPre14];
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        n = 0;
        for (i_imopVarPre15 = 0; i_imopVarPre15 <= grid_points[0] - 3; i_imopVarPre15++) {
            i1 = i_imopVarPre15 + 1;
            i2 = i_imopVarPre15 + 2;
#pragma omp for nowait
            for (j_imopVarPre16 = 1; j_imopVarPre16 <= grid_points[1] - 2; j_imopVarPre16++) {
                for (k_imopVarPre17 = 1; k_imopVarPre17 <= grid_points[2] - 2; k_imopVarPre17++) {
                    fac1 = 1. / lhs[n + 2][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                    lhs[n + 3][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] = fac1 * lhs[n + 3][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                    lhs[n + 4][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] = fac1 * lhs[n + 4][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                    for (m = 0; m < 3; m++) {
                        rhs[m][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] = fac1 * rhs[m][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                    }
                    lhs[n + 2][i1][j_imopVarPre16][k_imopVarPre17] = lhs[n + 2][i1][j_imopVarPre16][k_imopVarPre17] - lhs[n + 1][i1][j_imopVarPre16][k_imopVarPre17] * lhs[n + 3][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                    lhs[n + 3][i1][j_imopVarPre16][k_imopVarPre17] = lhs[n + 3][i1][j_imopVarPre16][k_imopVarPre17] - lhs[n + 1][i1][j_imopVarPre16][k_imopVarPre17] * lhs[n + 4][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                    for (m = 0; m < 3; m++) {
                        rhs[m][i1][j_imopVarPre16][k_imopVarPre17] = rhs[m][i1][j_imopVarPre16][k_imopVarPre17] - lhs[n + 1][i1][j_imopVarPre16][k_imopVarPre17] * rhs[m][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                    }
                    lhs[n + 1][i2][j_imopVarPre16][k_imopVarPre17] = lhs[n + 1][i2][j_imopVarPre16][k_imopVarPre17] - lhs[n + 0][i2][j_imopVarPre16][k_imopVarPre17] * lhs[n + 3][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                    lhs[n + 2][i2][j_imopVarPre16][k_imopVarPre17] = lhs[n + 2][i2][j_imopVarPre16][k_imopVarPre17] - lhs[n + 0][i2][j_imopVarPre16][k_imopVarPre17] * lhs[n + 4][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                    for (m = 0; m < 3; m++) {
                        rhs[m][i2][j_imopVarPre16][k_imopVarPre17] = rhs[m][i2][j_imopVarPre16][k_imopVarPre17] - lhs[n + 0][i2][j_imopVarPre16][k_imopVarPre17] * rhs[m][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        ...
        i_imopVarPre15 = grid_points[0] - 2;
        i1 = grid_points[0] - 1;
#pragma omp for nowait
        for (j_imopVarPre16 = 1; j_imopVarPre16 <= grid_points[1] - 2; j_imopVarPre16++) {
            for (k_imopVarPre17 = 1; k_imopVarPre17 <= grid_points[2] - 2; k_imopVarPre17++) {
                fac1 = 1.0 / lhs[n + 2][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                lhs[n + 3][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] = fac1 * lhs[n + 3][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                lhs[n + 4][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] = fac1 * lhs[n + 4][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                for (m = 0; m < 3; m++) {
                    rhs[m][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] = fac1 * rhs[m][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17];
                ...
                fac2 = 1. / lhs[n + 2][i1][j_imopVarPre16][k_imopVarPre17];
                for (m = 0; m < 3; m++) {
                    rhs[m][i1][j_imopVarPre16][k_imopVarPre17] = fac2 * rhs[m][i1][j_imopVarPre16][k_imopVarPre17];
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
            for (j_imopVarPre16 = 1; j_imopVarPre16 <= grid_points[1] - 2; j_imopVarPre16++) {
                for (k_imopVarPre17 = 1; k_imopVarPre17 <= grid_points[2] - 2; k_imopVarPre17++) {
                    rhs[m][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] = rhs[m][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] - lhs[n + 3][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] * rhs[m][i1][j_imopVarPre16][k_imopVarPre17];
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp barrier
        ...
        n = 0;
        for (i_imopVarPre15 = grid_points[0] - 3; i_imopVarPre15 >= 0; i_imopVarPre15--) {
            i1 = i_imopVarPre15 + 1;
            i2 = i_imopVarPre15 + 2;
#pragma omp for nowait
            for (m = 0; m < 3; m++) {
                for (j_imopVarPre16 = 1; j_imopVarPre16 <= grid_points[1] - 2; j_imopVarPre16++) {
                    for (k_imopVarPre17 = 1; k_imopVarPre17 <= grid_points[2] - 2; k_imopVarPre17++) {
                        rhs[m][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] = rhs[m][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] - lhs[n + 3][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] * rhs[m][i1][j_imopVarPre16][k_imopVarPre17] - lhs[n + 4][i_imopVarPre15][j_imopVarPre16][k_imopVarPre17] * rhs[m][i2][j_imopVarPre16][k_imopVarPre17];
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp barrier
        ...
        int j_imopVarPre10;
        int k_imopVarPre11;
        double r1_imopVarPre19;
        double r2_imopVarPre20;
        double r3_imopVarPre21;
        double r4_imopVarPre22;
        double r5_imopVarPre23;
        double t1_imopVarPre24;
        double t2_imopVarPre25;
#pragma omp for nowait
        for (i_imopVarPre9 = 1; i_imopVarPre9 <= grid_points[0] - 2; i_imopVarPre9++) {
            for (j_imopVarPre10 = 1; j_imopVarPre10 <= grid_points[1] - 2; j_imopVarPre10++) {
                for (k_imopVarPre11 = 1; k_imopVarPre11 <= grid_points[2] - 2; k_imopVarPre11++) {
                    r1_imopVarPre19 = rhs[0][i_imopVarPre9][j_imopVarPre10][k_imopVarPre11];
                    r2_imopVarPre20 = rhs[1][i_imopVarPre9][j_imopVarPre10][k_imopVarPre11];
                    r3_imopVarPre21 = rhs[2][i_imopVarPre9][j_imopVarPre10][k_imopVarPre11];
                    r4_imopVarPre22 = rhs[3][i_imopVarPre9][j_imopVarPre10][k_imopVarPre11];
                    r5_imopVarPre23 = rhs[4][i_imopVarPre9][j_imopVarPre10][k_imopVarPre11];
                    t1_imopVarPre24 = bt * r3_imopVarPre21;
                    t2_imopVarPre25 = 0.5 * (r4_imopVarPre22 + r5_imopVarPre23);
                    rhs[0][i_imopVarPre9][j_imopVarPre10][k_imopVarPre11] = -r2_imopVarPre20;
                    rhs[1][i_imopVarPre9][j_imopVarPre10][k_imopVarPre11] = r1_imopVarPre19;
                    rhs[2][i_imopVarPre9][j_imopVarPre10][k_imopVarPre11] = bt * (r4_imopVarPre22 - r5_imopVarPre23);
                    rhs[3][i_imopVarPre9][j_imopVarPre10][k_imopVarPre11] = -t1_imopVarPre24 + t2_imopVarPre25;
                    rhs[4][i_imopVarPre9][j_imopVarPre10][k_imopVarPre11] = t1_imopVarPre24 + t2_imopVarPre25;
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp barrier
        ...
        int j2;
        int m_imopVarPre33;
        double fac1_imopVarPre34;
        double fac2_imopVarPre35;
        double ru1_imopVarPre36;
        int i_imopVarPre6;
        int j_imopVarPre7;
        int k_imopVarPre8;
        for (i_imopVarPre6 = 1; i_imopVarPre6 <= grid_points[0] - 2; i_imopVarPre6++) {
            for (k_imopVarPre8 = 1; k_imopVarPre8 <= grid_points[2] - 2; k_imopVarPre8++) {
#pragma omp for nowait
                for (j_imopVarPre7 = 0; j_imopVarPre7 <= grid_points[1] - 1; j_imopVarPre7++) {
                    ru1_imopVarPre36 = c3c4 * rho_i[i_imopVarPre6][j_imopVarPre7][k_imopVarPre8];
                    cv[j_imopVarPre7] = vs[i_imopVarPre6][j_imopVarPre7][k_imopVarPre8];
                    int _imopVarPre1343;
                    ...
                    _imopVarPre1343 = ((dymax + ru1_imopVarPre36) > dy1);
                    if (_imopVarPre1343) {
                        _imopVarPre1344 = (dymax + ru1_imopVarPre36);
                    } else {
                        _imopVarPre1344 = dy1;
                    }
                    _imopVarPre1345 = ((dy5 + c1c5 * ru1_imopVarPre36) > _imopVarPre1344);
                    if (_imopVarPre1345) {
                        _imopVarPre1346 = (dy5 + c1c5 * ru1_imopVarPre36);
                    } else {
                        _imopVarPre1353 = ((dymax + ru1_imopVarPre36) > dy1);
                        if (_imopVarPre1353) {
                            _imopVarPre1354 = (dymax + ru1_imopVarPre36);
                        } else {
                            _imopVarPre1354 = dy1;
                        }
                        _imopVarPre1346 = _imopVarPre1354;
                    }
                    _imopVarPre1355 = ((dy3 + con43 * ru1_imopVarPre36) > _imopVarPre1346);
                    if (_imopVarPre1355) {
                        _imopVarPre1356 = (dy3 + con43 * ru1_imopVarPre36);
                    } else {
                        _imopVarPre1449 = ((dymax + ru1_imopVarPre36) > dy1);
                        if (_imopVarPre1449) {
                            _imopVarPre1450 = (dymax + ru1_imopVarPre36);
                        } else {
                            _imopVarPre1450 = dy1;
                        }
                        _imopVarPre1451 = ((dy5 + c1c5 * ru1_imopVarPre36) > _imopVarPre1450);
                        if (_imopVarPre1451) {
                            _imopVarPre1452 = (dy5 + c1c5 * ru1_imopVarPre36);
                        } else {
                            _imopVarPre1459 = ((dymax + ru1_imopVarPre36) > dy1);
                            if (_imopVarPre1459) {
                                _imopVarPre1460 = (dymax + ru1_imopVarPre36);
                            } else {
                                _imopVarPre1460 = dy1;
                            }
                    ...
                    rhoq[j_imopVarPre7] = _imopVarPre1356;
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for nowait
                for (j_imopVarPre7 = 1; j_imopVarPre7 <= grid_points[1] - 2; j_imopVarPre7++) {
                    lhs[0][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = 0.0;
                    lhs[1][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = -dtty2 * cv[j_imopVarPre7 - 1] - dtty1 * rhoq[j_imopVarPre7 - 1];
                    lhs[2][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = 1.0 + c2dtty1 * rhoq[j_imopVarPre7];
                    lhs[3][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = dtty2 * cv[j_imopVarPre7 + 1] - dtty1 * rhoq[j_imopVarPre7 + 1];
                    lhs[4][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = 0.0;
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
            }
...
#pragma omp for nowait
        for (i_imopVarPre6 = 1; i_imopVarPre6 <= grid_points[0] - 2; i_imopVarPre6++) {
            for (k_imopVarPre8 = 1; k_imopVarPre8 <= grid_points[2] - 2; k_imopVarPre8++) {
                lhs[2][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[2][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] + comz5;
                lhs[3][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[3][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] - comz4;
                lhs[4][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[4][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] + comz1;
                lhs[1][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] = lhs[1][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] - comz4;
                lhs[2][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] = lhs[2][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] + comz6;
                lhs[3][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] = lhs[3][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] - comz4;
                lhs[4][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] = lhs[4][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] + comz1;
            }
        }
#pragma omp for nowait
        for (i_imopVarPre6 = 1; i_imopVarPre6 <= grid_points[0] - 2; i_imopVarPre6++) {
            for (j_imopVarPre7 = 3; j_imopVarPre7 <= grid_points[1] - 4; j_imopVarPre7++) {
                for (k_imopVarPre8 = 1; k_imopVarPre8 <= grid_points[2] - 2; k_imopVarPre8++) {
                    lhs[0][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[0][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] + comz1;
                    lhs[1][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[1][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] - comz4;
                    lhs[2][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[2][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] + comz6;
                    lhs[3][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[3][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] - comz4;
                    lhs[4][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[4][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] + comz1;
                }
            }
        }
        j_imopVarPre7 = grid_points[1] - 3;
#pragma omp for nowait
        for (i_imopVarPre6 = 1; i_imopVarPre6 <= grid_points[0] - 2; i_imopVarPre6++) {
            for (k_imopVarPre8 = 1; k_imopVarPre8 <= grid_points[2] - 2; k_imopVarPre8++) {
                lhs[0][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[0][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] + comz1;
                ...
                lhs[2][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[2][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] + comz6;
                lhs[3][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[3][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] - comz4;
                lhs[0][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] = lhs[0][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] + comz1;
                lhs[1][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] = lhs[1][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] - comz4;
                lhs[2][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] = lhs[2][i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8] + comz5;
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for nowait
        for (i_imopVarPre6 = 1; i_imopVarPre6 <= grid_points[0] - 2; i_imopVarPre6++) {
            for (j_imopVarPre7 = 1; j_imopVarPre7 <= grid_points[1] - 2; j_imopVarPre7++) {
                for (k_imopVarPre8 = 1; k_imopVarPre8 <= grid_points[2] - 2; k_imopVarPre8++) {
                    lhs[0 + 5][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[0][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8];
                    lhs[1 + 5][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[1][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] - dtty2 * speed[i_imopVarPre6][j_imopVarPre7 - 1][k_imopVarPre8];
                    lhs[2 + 5][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[2][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8];
                    lhs[3 + 5][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[3][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] + dtty2 * speed[i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8];
                    lhs[4 + 5][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[4][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8];
                    lhs[0 + 10][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[0][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8];
                    lhs[1 + 10][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[1][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] + dtty2 * speed[i_imopVarPre6][j_imopVarPre7 - 1][k_imopVarPre8];
                    lhs[2 + 10][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[2][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8];
                    lhs[3 + 10][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[3][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] - dtty2 * speed[i_imopVarPre6][j_imopVarPre7 + 1][k_imopVarPre8];
                    lhs[4 + 10][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8] = lhs[4][i_imopVarPre6][j_imopVarPre7][k_imopVarPre8];
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        n_imopVarPre32 = 0;
        for (j_imopVarPre30 = 0; j_imopVarPre30 <= grid_points[1] - 3; j_imopVarPre30++) {
            j1 = j_imopVarPre30 + 1;
            j2 = j_imopVarPre30 + 2;
#pragma omp for nowait
            for (i_imopVarPre29 = 1; i_imopVarPre29 <= grid_points[0] - 2; i_imopVarPre29++) {
                for (k_imopVarPre31 = 1; k_imopVarPre31 <= grid_points[2] - 2; k_imopVarPre31++) {
                    fac1_imopVarPre34 = 1. / lhs[n_imopVarPre32 + 2][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31];
                    lhs[n_imopVarPre32 + 3][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31] = fac1_imopVarPre34 * lhs[n_imopVarPre32 + 3][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31];
                    lhs[n_imopVarPre32 + 4][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31] = fac1_imopVarPre34 * lhs[n_imopVarPre32 + 4][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31];
                    for (m_imopVarPre33 = 0; m_imopVarPre33 < 3; m_imopVarPre33++) {
                        rhs[m_imopVarPre33][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31] = fac1_imopVarPre34 * rhs[m_imopVarPre33][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31];
                    }
                    lhs[n_imopVarPre32 + 2][i_imopVarPre29][j1][k_imopVarPre31] = lhs[n_imopVarPre32 + 2][i_imopVarPre29][j1][k_imopVarPre31] - lhs[n_imopVarPre32 + 1][i_imopVarPre29][j1][k_imopVarPre31] * lhs[n_imopVarPre32 + 3][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31];
                    lhs[n_imopVarPre32 + 3][i_imopVarPre29][j1][k_imopVarPre31] = lhs[n_imopVarPre32 + 3][i_imopVarPre29][j1][k_imopVarPre31] - lhs[n_imopVarPre32 + 1][i_imopVarPre29][j1][k_imopVarPre31] * lhs[n_imopVarPre32 + 4][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31];
                    for (m_imopVarPre33 = 0; m_imopVarPre33 < 3; m_imopVarPre33++) {
                        rhs[m_imopVarPre33][i_imopVarPre29][j1][k_imopVarPre31] = rhs[m_imopVarPre33][i_imopVarPre29][j1][k_imopVarPre31] - lhs[n_imopVarPre32 + 1][i_imopVarPre29][j1][k_imopVarPre31] * rhs[m_imopVarPre33][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31];
                    }
                    lhs[n_imopVarPre32 + 1][i_imopVarPre29][j2][k_imopVarPre31] = lhs[n_imopVarPre32 + 1][i_imopVarPre29][j2][k_imopVarPre31] - lhs[n_imopVarPre32 + 0][i_imopVarPre29][j2][k_imopVarPre31] * lhs[n_imopVarPre32 + 3][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31];
                    lhs[n_imopVarPre32 + 2][i_imopVarPre29][j2][k_imopVarPre31] = lhs[n_imopVarPre32 + 2][i_imopVarPre29][j2][k_imopVarPre31] - lhs[n_imopVarPre32 + 0][i_imopVarPre29][j2][k_imopVarPre31] * lhs[n_imopVarPre32 + 4][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31];
                    for (m_imopVarPre33 = 0; m_imopVarPre33 < 3; m_imopVarPre33++) {
                        rhs[m_imopVarPre33][i_imopVarPre29][j2][k_imopVarPre31] = rhs[m_imopVarPre33][i_imopVarPre29][j2][k_imopVarPre31] - lhs[n_imopVarPre32 + 0][i_imopVarPre29][j2][k_imopVarPre31] * rhs[m_imopVarPre33][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31];
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        ...
        j_imopVarPre30 = grid_points[1] - 2;
        j1 = grid_points[1] - 1;
#pragma omp for nowait
        for (i_imopVarPre29 = 1; i_imopVarPre29 <= grid_points[0] - 2; i_imopVarPre29++) {
            for (k_imopVarPre31 = 1; k_imopVarPre31 <= grid_points[2] - 2; k_imopVarPre31++) {
                ...
                fac2_imopVarPre35 = 1. / lhs[n_imopVarPre32 + 2][i_imopVarPre29][j1][k_imopVarPre31];
                for (m_imopVarPre33 = 0; m_imopVarPre33 < 3; m_imopVarPre33++) {
                    rhs[m_imopVarPre33][i_imopVarPre29][j1][k_imopVarPre31] = fac2_imopVarPre35 * rhs[m_imopVarPre33][i_imopVarPre29][j1][k_imopVarPre31];
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        for (m_imopVarPre33 = 3; m_imopVarPre33 < 5; m_imopVarPre33++) {
            n_imopVarPre32 = (m_imopVarPre33 - 3 + 1) * 5;
            for (j_imopVarPre30 = 0; j_imopVarPre30 <= grid_points[1] - 3; j_imopVarPre30++) {
                j1 = j_imopVarPre30 + 1;
                j2 = j_imopVarPre30 + 2;
#pragma omp for nowait
...
#pragma omp for nowait
            for (i_imopVarPre29 = 1; i_imopVarPre29 <= grid_points[0] - 2; i_imopVarPre29++) {
                for (k_imopVarPre31 = 1; k_imopVarPre31 <= grid_points[2] - 2; k_imopVarPre31++) {
                    rhs[m_imopVarPre33][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31] = rhs[m_imopVarPre33][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31] - lhs[n_imopVarPre32 + 3][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31] * rhs[m_imopVarPre33][i_imopVarPre29][j1][k_imopVarPre31];
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp barrier
        ...
        n_imopVarPre32 = 0;
        for (m_imopVarPre33 = 0; m_imopVarPre33 < 3; m_imopVarPre33++) {
            for (j_imopVarPre30 = grid_points[1] - 3; j_imopVarPre30 >= 0; j_imopVarPre30--) {
                j1 = j_imopVarPre30 + 1;
                j2 = j_imopVarPre30 + 2;
#pragma omp for nowait
                for (i_imopVarPre29 = 1; i_imopVarPre29 <= grid_points[0] - 2; i_imopVarPre29++) {
                    for (k_imopVarPre31 = 1; k_imopVarPre31 <= grid_points[2] - 2; k_imopVarPre31++) {
                        rhs[m_imopVarPre33][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31] = rhs[m_imopVarPre33][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31] - lhs[n_imopVarPre32 + 3][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31] * rhs[m_imopVarPre33][i_imopVarPre29][j1][k_imopVarPre31] - lhs[n_imopVarPre32 + 4][i_imopVarPre29][j_imopVarPre30][k_imopVarPre31] * rhs[m_imopVarPre33][i_imopVarPre29][j2][k_imopVarPre31];
                    }
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp barrier
        ...
        int j_imopVarPre27;
        int k_imopVarPre28;
        double r1_imopVarPre37;
        double r2_imopVarPre38;
        double r3_imopVarPre39;
        double r4_imopVarPre40;
        double r5_imopVarPre41;
        double t1_imopVarPre42;
        double t2_imopVarPre43;
#pragma omp for nowait
        for (i_imopVarPre26 = 1; i_imopVarPre26 <= grid_points[0] - 2; i_imopVarPre26++) {
            for (j_imopVarPre27 = 1; j_imopVarPre27 <= grid_points[1] - 2; j_imopVarPre27++) {
                for (k_imopVarPre28 = 1; k_imopVarPre28 <= grid_points[2] - 2; k_imopVarPre28++) {
                    r1_imopVarPre37 = rhs[0][i_imopVarPre26][j_imopVarPre27][k_imopVarPre28];
                    r2_imopVarPre38 = rhs[1][i_imopVarPre26][j_imopVarPre27][k_imopVarPre28];
                    r3_imopVarPre39 = rhs[2][i_imopVarPre26][j_imopVarPre27][k_imopVarPre28];
                    r4_imopVarPre40 = rhs[3][i_imopVarPre26][j_imopVarPre27][k_imopVarPre28];
                    r5_imopVarPre41 = rhs[4][i_imopVarPre26][j_imopVarPre27][k_imopVarPre28];
                    t1_imopVarPre42 = bt * r1_imopVarPre37;
                    t2_imopVarPre43 = 0.5 * (r4_imopVarPre40 + r5_imopVarPre41);
                    rhs[0][i_imopVarPre26][j_imopVarPre27][k_imopVarPre28] = bt * (r4_imopVarPre40 - r5_imopVarPre41);
                    rhs[1][i_imopVarPre26][j_imopVarPre27][k_imopVarPre28] = -r3_imopVarPre39;
                    rhs[2][i_imopVarPre26][j_imopVarPre27][k_imopVarPre28] = r2_imopVarPre38;
                    rhs[3][i_imopVarPre26][j_imopVarPre27][k_imopVarPre28] = -t1_imopVarPre42 + t2_imopVarPre43;
                    rhs[4][i_imopVarPre26][j_imopVarPre27][k_imopVarPre28] = t1_imopVarPre42 + t2_imopVarPre43;
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp parallel
    ...
    int no_time_steps;
    char *class_imopVarPre4;
    int *verified_imopVarPre5;
    no_time_steps = niter;
    class_imopVarPre4 = _imopVarPre172;
    verified_imopVarPre5 = _imopVarPre171;
    double xcrref[5];
    double xceref[5];
    double xcrdif[5];
    double xcedif[5];
...
#pragma omp barrier
    ...
    *verified_imopVarPre5 = 1;
    ...
    if (*class_imopVarPre4 != 'U') {
        char _imopVarPre2190;
        _imopVarPre2190 = *class_imopVarPre4;
    ...
    c_print_results("SP", class, _imopVarPre186, _imopVarPre185, _imopVarPre184, niter, nthreads, tmax, mflops, "          floating point", verified, "3.0 structured", "09 Jul 2020", "gcc", "gcc", "-lm", "-I../common", "-O3 -fopenmp", "-fopenmp", "(none)");
}
static void add(void ) {
    int i;
    int j;
