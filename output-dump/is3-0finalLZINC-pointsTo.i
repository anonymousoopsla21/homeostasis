...
void full_verify() {
    /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell, key_buff1.f];
    ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
    ptsTo(key_buff2.f) := [key_array.f];
    ptsTo(key_buff1.f) := [prv_buff1.f, prv_buff1.f, prv_buff1.f, nullCell];
    ptsTo(test_index_array.f) := [S_test_index_array.f];
    ptsTo(test_rank_array.f) := [S_test_rank_array.f];
    ]*/
    INT_TYPE i;
...
#pragma omp parallel
    {
        ...
        int iteration_imopVarPre0;
        /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
        ptsTo(argv) := [heapCell#0];
        ptsTo(test_index_array.f) := [S_test_index_array.f];
        ptsTo(test_rank_array.f) := [S_test_rank_array.f];
        ]*/
        iteration_imopVarPre0 = 1;
        /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
        ptsTo(argv) := [heapCell#0];
        ptsTo(test_index_array.f) := [S_test_index_array.f];
        ptsTo(test_rank_array.f) := [S_test_rank_array.f];
        ]*/
        INT_TYPE i_imopVarPre1;
        /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
        ptsTo(argv) := [heapCell#0];
        ptsTo(test_index_array.f) := [S_test_index_array.f];
        ptsTo(test_rank_array.f) := [S_test_rank_array.f];
...
#pragma omp master
        {
            ...
            key_array[iteration_imopVarPre0] = iteration_imopVarPre0;
            /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
            ptsTo(argv) := [heapCell#0];
            ptsTo(test_index_array.f) := [S_test_index_array.f];
            ptsTo(test_rank_array.f) := [S_test_rank_array.f];
            ]*/
            key_array[iteration_imopVarPre0 + 10] = (1 << 11) - iteration_imopVarPre0;
            /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
            ptsTo(argv) := [heapCell#0];
            ptsTo(test_index_array.f) := [S_test_index_array.f];
            ptsTo(test_rank_array.f) := [S_test_rank_array.f];
            ...
            for (i_imopVarPre1 = 0; i_imopVarPre1 < 5; i_imopVarPre1++) {
                /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
                ptsTo(argv) := [heapCell#0];
                ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
                ptsTo(test_index_array.f) := [S_test_index_array.f];
                ...
                partial_verify_vals[i_imopVarPre1] = key_array[test_index_array[i_imopVarPre1]];
            }
            /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
            ptsTo(argv) := [heapCell#0];
            ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
            ...
            for (i_imopVarPre1 = 0; i_imopVarPre1 < (1 << 11); i_imopVarPre1++) {
                /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
                ptsTo(argv) := [heapCell#0];
                ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
                ptsTo(key_buff1.f) := [nullCell];
...
#pragma omp for nowait
        ...
        for (i_imopVarPre1 = 0; i_imopVarPre1 < (1 << 16); i_imopVarPre1++) {
            /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
            ptsTo(argv) := [heapCell#0];
            ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
            ptsTo(key_buff2.f) := [key_array.f];
            ...
            key_buff2[i_imopVarPre1] = key_array[i_imopVarPre1];
            /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
            ptsTo(argv) := [heapCell#0];
            ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
            ptsTo(key_buff2.f) := [key_array.f];
            ...
            prv_buff1[key_buff2[i_imopVarPre1]]++;
        }
        /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
        ptsTo(argv) := [heapCell#0];
        ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
        ...
        for (i_imopVarPre1 = 0; i_imopVarPre1 < (1 << 11) - 1; i_imopVarPre1++) {
            /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
            ptsTo(argv) := [heapCell#0];
            ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
            ptsTo(key_buff2.f) := [key_array.f];
            ...
            prv_buff1[i_imopVarPre1 + 1] += prv_buff1[i_imopVarPre1];
        }
        /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
        ptsTo(argv) := [heapCell#0];
        ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
...
#pragma omp critical
        {
            ...
            for (i_imopVarPre1 = 0; i_imopVarPre1 < (1 << 11); i_imopVarPre1++) {
                ...
                key_buff1[i_imopVarPre1] += prv_buff1[i_imopVarPre1];
            }
        }
        /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
        ptsTo(argv) := [heapCell#0];
...
#pragma omp master
        {
            ...
            for (i_imopVarPre1 = 0; i_imopVarPre1 < 5; i_imopVarPre1++) {
                ...
                k = partial_verify_vals[i_imopVarPre1];
                /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
                ptsTo(argv) := [heapCell#0];
                ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
                ptsTo(key_buff2.f) := [key_array.f];
                ...
                if (_imopVarPre35) {
                    ...
                    switch ('S') {
                        ...
                        case 'S': if (i_imopVarPre1 <= 2) {
                            ...
                            if (key_buff1[k - 1] != test_rank_array[i_imopVarPre1] + iteration_imopVarPre0) {
                                /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
                                ptsTo(argv) := [heapCell#0];
                                ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
                                ptsTo(key_buff2.f) := [key_array.f];
                                ...
                                printf("Failed partial verification: " "iteration %d, test key %d\n", iteration_imopVarPre0, i_imopVarPre1);
                                /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell];
                                ptsTo(argv) := [heapCell#0];
                                ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
                                ptsTo(key_buff2.f) := [key_array.f];
                        ...
                        break;
                        case 'W': if (i_imopVarPre1 < 2) {
                            if (key_buff1[k - 1] != test_rank_array[i_imopVarPre1] + (iteration_imopVarPre0 - 2)) {
                                printf("Failed partial verification: " "iteration %d, test key %d\n", iteration_imopVarPre0, i_imopVarPre1);
                            } else {
                                passed_verification++;
                            }
                        ...
                        break;
                        case 'A': if (i_imopVarPre1 <= 2) {
                            if (key_buff1[k - 1] != test_rank_array[i_imopVarPre1] + (iteration_imopVarPre0 - 1)) {
                                printf("Failed partial verification: " "iteration %d, test key %d\n", iteration_imopVarPre0, i_imopVarPre1);
                            } else {
                                passed_verification++;
                            }
                        ...
                        int _imopVarPre36;
                        int _imopVarPre37;
                        _imopVarPre36 = i_imopVarPre1 == 1;
                        if (!_imopVarPre36) {
                            _imopVarPre37 = i_imopVarPre1 == 2;
                            if (!_imopVarPre37) {
                                _imopVarPre37 = i_imopVarPre1 == 4;
                            }
                            _imopVarPre36 = _imopVarPre37;
                        }
                        if (_imopVarPre36) {
    ...
    ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
    ptsTo(key_buff2.f) := [key_array.f];
    ptsTo(key_buff1.f) := [prv_buff1.f, prv_buff1.f, nullCell];
    ptsTo(test_index_array.f) := [S_test_index_array.f];
    ptsTo(test_rank_array.f) := [S_test_rank_array.f];
    ]*/
...
#pragma omp for nowait
            ...
            for (i_imopVarPre77 = 0; i_imopVarPre77 < (1 << 16); i_imopVarPre77++) {
                ...
                prv_buff1[key_buff2[i_imopVarPre77]]++;
            }
            /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell, key_buff1.f];
            ptsTo(argv) := [heapCell#0];
            ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
            ...
            for (i_imopVarPre77 = 0; i_imopVarPre77 < (1 << 11) - 1; i_imopVarPre77++) {
                ...
                prv_buff1[i_imopVarPre77 + 1] += prv_buff1[i_imopVarPre77];
            }
            /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell, key_buff1.f];
            ptsTo(argv) := [heapCell#0];
            ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
...
#pragma omp critical
            {
                ...
                for (i_imopVarPre77 = 0; i_imopVarPre77 < (1 << 11); i_imopVarPre77++) {
                    ...
                    key_buff1[i_imopVarPre77] += prv_buff1[i_imopVarPre77];
                }
            }
            /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell, key_buff1.f];
            ptsTo(argv) := [heapCell#0];
...
#pragma omp master
            {
                ...
                for (i_imopVarPre77 = 0; i_imopVarPre77 < 5; i_imopVarPre77++) {
                    ...
                    k = partial_verify_vals[i_imopVarPre77];
                    /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell, key_buff1.f];
                    ptsTo(argv) := [heapCell#0];
                    ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
                    ptsTo(key_buff2.f) := [key_array.f];
                    ...
                    if (_imopVarPre35) {
                        ...
                        switch ('S') {
                            ...
                            case 'S': if (i_imopVarPre77 <= 2) {
                                ...
                                if (key_buff1[k - 1] != test_rank_array[i_imopVarPre77] + iteration) {
                                    /*OUT: [ptsTo(key_buff_ptr_global) := [nullCell, key_buff1.f];
                                    ptsTo(argv) := [heapCell#0];
                                    ptsTo(partial_verify_vals.f) := [test_index_array.f, key_array.f];
                                    ptsTo(key_buff2.f) := [key_array.f];
                            ...
                            case 'W': if (i_imopVarPre77 < 2) {
                                if (key_buff1[k - 1] != test_rank_array[i_imopVarPre77] + (iteration - 2)) {
                                    printf("Failed partial verification: " "iteration %d, test key %d\n", iteration, i_imopVarPre77);
                                } else {
                                    passed_verification++;
                                }
                            ...
                            case 'A': if (i_imopVarPre77 <= 2) {
                                if (key_buff1[k - 1] != test_rank_array[i_imopVarPre77] + (iteration - 1)) {
                                    printf("Failed partial verification: " "iteration %d, test key %d\n", iteration, i_imopVarPre77);
                                } else {
                                    passed_verification++;
                                }
