...
static int xstart[3];
/*READ_S: []
WRITE_S: [ystart, ystart.f]*/
static int ystart[3];
/*READ_S: []
WRITE_S: [zstart, zstart.f]*/
static int zstart[3];
/*READ_S: []
WRITE_S: [xend.f, xend]*/
static int xend[3];
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [xend.f, zstart, checksum, is, print_timers, xout, u.f, d, exp, y1.f, is, u1, ilog2, timer_clear, logd, k, tmp.f, d, fftblockpad, u, xend, j, y0.f, d, _imopVarPre324, cfftz, u1, tmp, i, logd.f, u0, fftblock, log, ystart.f, _imopVarPre325, logd, yend, y0.f, x, evolve, _imopVarPre274, zstart.f, logd.f, cos, verify, _imopVarPre272, c_print_results, logd.f, xout, _imopVarPre326, yend.f, y1.f, _imopVarPre266, xout, indexmap, cffts1, _imopVarPre294, _imopVarPre284, timer_read, k, _imopVarPre315, logd, ex.f, randlc, timer_stop, cffts2, dims, _imopVarPre267, exit, compute_indexmap, indexmap.f, _imopVarPre295, _imopVarPre285, u2, u1.f, fftz2, sin, _imopVarPre316, compute_initial_conditions, ystart, x, ex, xstart.f, dims.f, x, cffts3, _imopVarPre286, _imopVarPre296, u1, u0.f, _imopVarPre304, _imopVarPre276, y1.f, niter, xstart, setup, u0, indexmap, timer_start, zend, t, sums.f, _imopVarPre305, ipow46, is, _imopVarPre314, indexmap, j, k, vranlc, d, y0.f, fft_init, fft, fabs, i, printf, zend.f, sums, u2.f, _imopVarPre306]
WRITE_S: [u0, xend.f, u.f, fftblock, y1.f, ystart.f, ex.f, an, niter, y1.f, y0.f, indexmap.f, sums.f, tmp.f, u1.f, fftblockpad, u2, zstart.f, y0.f, xstart.f, dims.f, y0.f, yend.f, y1.f, indexmap, zend.f, tmp, u2.f, u0.f, u1]*/
...
WRITE_S: [u0, xend.f, u.f, fftblock, y1.f, ystart.f, ex.f, an, niter, y1.f, y0.f, indexmap.f, sums.f, tmp.f, u1.f, fftblockpad, u2, zstart.f, y0.f, xstart.f, dims.f, y0.f, yend.f, y1.f, indexmap, zend.f, tmp, u2.f, u0.f, u1]*/
    ...
    /*READ_S: [compute_initial_conditions, u1]
    WRITE_S: []*/
    ...
    /*READ_S: []
    WRITE_S: []*/
    /*READ_S: [xend.f, zstart, checksum, k, is, xout, u.f, d, logd, ex.f, y1.f, is, u1, timer_stop, cffts2, dims, exit, _imopVarPre267, indexmap.f, ilog2, logd, k, u1.f, d, u2, fftblockpad, fftz2, u, xend, j, y0.f, ystart, d, cfftz, x, xstart.f, ex, dims.f, x, u1, cffts3, logd.f, u1, u0.f, u0, _imopVarPre276, y1.f, fftblock, ystart.f, logd, niter, xstart, u0, timer_start, yend, y0.f, zend, t, x, sums.f, evolve, _imopVarPre274, zstart.f, is, logd.f, _imopVarPre272, j, k, indexmap, logd.f, xout, d, y0.f, fft, yend.f, y1.f, _imopVarPre266, xout, i, indexmap, cffts1, printf, zend.f, sums, u2.f]
    WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, sums.f, u2.f, u1.f, u0.f]*/
    for (iter = 1; iter <= niter; iter++) {
    /*READ_S: [xend.f, zstart, checksum, k, is, xout, u.f, d, logd, ex.f, y1.f, is, u1, timer_stop, cffts2, dims, exit, _imopVarPre267, indexmap.f, ilog2, logd, k, u1.f, d, u2, fftblockpad, fftz2, u, xend, j, y0.f, ystart, d, cfftz, x, xstart.f, ex, dims.f, x, u1, cffts3, logd.f, u1, u0.f, u0, _imopVarPre276, y1.f, fftblock, ystart.f, logd, xstart, u0, timer_start, yend, y0.f, zend, t, x, sums.f, evolve, _imopVarPre274, zstart.f, is, logd.f, _imopVarPre272, j, k, indexmap, logd.f, xout, d, y0.f, fft, yend.f, y1.f, _imopVarPre266, xout, i, indexmap, cffts1, printf, zend.f, sums, u2.f]
    WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, sums.f, u2.f, u1.f, u0.f]*/
        /*READ_S: []
        WRITE_S: []*/
        /*READ_S: [timer_start]
...
#pragma omp parallel
    ...
    /*READ_S: []
    WRITE_S: []*/
    /*READ_S: [print_timers, printf, timer_read]
    WRITE_S: []*/
    if (0 == 1) {
    /*READ_S: [print_timers, printf, timer_read]
    WRITE_S: []*/
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [dims.f, u0, u1, indexmap.f, t, indexmap, d, ex.f, k, ex, u1.f, u0.f]
WRITE_S: [u1.f]*/
static void evolve(dcomplex u0[64][64][64], dcomplex u1[64][64][64] , int t , int indexmap[64][64][64] , int d[3]) {
/*READ_S: [dims.f, u0, u1, indexmap.f, t, indexmap, d, ex.f, k, ex, u1.f, u0.f]
WRITE_S: [u1.f]*/
...
#pragma omp for nowait
        ...
        WRITE_S: []*/
        for (k = 0; k < d[2]; k++) {
        /*READ_S: [dims.f, u0, u1, indexmap.f, t, indexmap, d, ex.f, ex, u1.f, u0.f]
        WRITE_S: [u1.f]*/
            /*READ_S: []
            WRITE_S: []*/
            /*READ_S: [dims.f, d]
            ...
            WRITE_S: [u1.f]*/
                ...
                WRITE_S: [u1.f]*/
                for (i = 0; i < d[0]; i++) {
                /*READ_S: [u0, u1, indexmap.f, t, indexmap, ex.f, ex, u1.f, u0.f]
                WRITE_S: [u1.f]*/
                    /*READ_S: [u0, u1, indexmap.f, t, indexmap, ex.f, ex, u1.f, u0.f]
                    WRITE_S: [u1.f]*/
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [ipow46, dims.f, zstart, zstart.f, dims, ystart, randlc, ystart.f, tmp, vranlc, tmp.f, u1.f]
WRITE_S: [an, tmp, tmp.f, u1.f]*/
static void compute_initial_conditions(dcomplex u0[64][64][64], int d[3]) {
/*READ_S: [ipow46, dims.f, zstart, zstart.f, dims, ystart, randlc, ystart.f, tmp, vranlc, tmp.f, u1.f]
WRITE_S: [an, tmp, tmp.f, u1.f]*/
    /*READ_S: []
    ...
    WRITE_S: []*/
    _imopVarPre192 = &an;
    /*READ_S: [zstart, zstart.f, ystart, ystart.f]
    WRITE_S: []*/
    ...
    /*READ_S: []
    WRITE_S: []*/
    /*READ_S: [dims.f, dims, randlc, tmp, tmp.f, vranlc, u1.f]
    WRITE_S: [tmp.f, u1.f]*/
    ...
    WRITE_S: [tmp.f, u1.f]*/
        ...
        /*READ_S: []
        WRITE_S: []*/
        /*READ_S: [dims.f, dims, tmp, tmp.f, u1.f]
        WRITE_S: [u1.f]*/
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [dims.f, zstart, yend, dims, xend, zend, fftblock, ystart, printf, niter, xstart]
WRITE_S: [dims.f, xend.f, zstart.f, yend.f, fftblock, ystart.f, zend.f, niter, xstart.f, fftblockpad]*/
static void setup(void ) {
/*READ_S: [dims.f, zstart, yend, dims, xend, zend, fftblock, ystart, printf, niter, xstart]
WRITE_S: [dims.f, xend.f, zstart.f, yend.f, fftblock, ystart.f, zend.f, niter, xstart.f, fftblockpad]*/
    /*READ_S: []
    ...
    /*READ_S: []
    WRITE_S: []*/
    /*READ_S: [zstart, yend, xend, zend, ystart, xstart]
    WRITE_S: [xend.f, zstart.f, yend.f, ystart.f, zend.f, xstart.f]*/
    for (i = 0; i < 3; i++) {
    /*READ_S: [zstart, yend, xend, zend, ystart, xstart]
    WRITE_S: [xend.f, zstart.f, yend.f, ystart.f, zend.f, xstart.f]*/
        /*READ_S: [xstart]
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [zstart, zstart.f, ystart, ex.f, ystart.f, xstart, ex, exp, xstart.f, dims.f, indexmap, dims, indexmap.f, i]
...
WRITE_S: [indexmap.f, ex.f]*/
    ...
    WRITE_S: []*/
    double ap;
    /*READ_S: [dims.f, zstart, indexmap, zstart.f, dims, indexmap.f, ystart, ystart.f, xstart, i, xstart.f]
    WRITE_S: [indexmap.f]*/
...
#pragma omp for nowait
        ...
        /*READ_S: [dims.f, indexmap, zstart, zstart.f, dims, indexmap.f, ystart, ystart.f, xstart, xstart.f]
        WRITE_S: [indexmap.f]*/
            ...
            /*READ_S: []
            WRITE_S: []*/
            /*READ_S: [dims.f, indexmap, zstart, zstart.f, dims, indexmap.f, ystart, ystart.f]
            WRITE_S: [indexmap.f]*/
            for (j = 0; j < dims[2][1]; j++) {
            /*READ_S: [dims.f, indexmap, zstart, zstart.f, dims, indexmap.f, ystart, ystart.f]
            WRITE_S: [indexmap.f]*/
                /*READ_S: [ystart, ystart.f]
                WRITE_S: []*/
                ...
                /*READ_S: []
                WRITE_S: []*/
                /*READ_S: [dims.f, indexmap, zstart, zstart.f, dims, indexmap.f]
                WRITE_S: [indexmap.f]*/
                for (k = 0; k < dims[2][2]; k++) {
                /*READ_S: [indexmap, zstart, zstart.f, indexmap.f]
                WRITE_S: [indexmap.f]*/
                    /*READ_S: [zstart, zstart.f]
                    WRITE_S: []*/
                    kk = (k + 1 + zstart[2] - 2 + 64 / 2) % 64 - 64 / 2;
                    /*READ_S: [indexmap, indexmap.f]
                    WRITE_S: [indexmap.f]*/
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [k, is, xout, u.f, d, logd, y1.f, fftblock, logd, y1.f, is, cffts2, dims, y0.f, exit, _imopVarPre267, x, ilog2, logd, u1.f, d, fftblockpad, fftz2, is, u, logd.f, j, y0.f, k, cfftz, logd.f, x, xout, d, dims.f, y0.f, x, cffts3, y1.f, _imopVarPre266, xout, cffts1, printf, u2.f, logd.f, u0.f]
WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u2.f, u1.f, u0.f]*/
static void fft(int dir, dcomplex x1[64][64][64] , dcomplex x2[64][64][64]) {
/*READ_S: [k, is, xout, u.f, d, logd, y1.f, fftblock, logd, y1.f, is, cffts2, dims, y0.f, exit, _imopVarPre267, x, ilog2, logd, u1.f, d, fftblockpad, fftz2, is, u, logd.f, j, y0.f, k, cfftz, logd.f, x, xout, d, dims.f, y0.f, x, cffts3, y1.f, _imopVarPre266, xout, cffts1, printf, u2.f, logd.f, u0.f]
WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u2.f, u1.f, u0.f]*/
    /*READ_S: []
    ...
    /*READ_S: [k, is, xout, u.f, d, logd, y1.f, fftblock, logd, y1.f, is, cffts2, y0.f, exit, _imopVarPre267, dims, x, ilog2, logd, u1.f, d, fftblockpad, fftz2, is, u, logd.f, j, y0.f, k, cfftz, logd.f, x, xout, d, dims.f, y0.f, x, cffts3, y1.f, _imopVarPre266, xout, cffts1, printf, u2.f, logd.f, u0.f]
    WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u2.f, u1.f, u0.f]*/
        /*READ_S: []
        WRITE_S: []*/
        int ( *_imopVarPre232 );
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [k, u.f, y1.f, fftblock, logd, y1.f, y0.f, _imopVarPre267, exit, x, ilog2, u1.f, fftblockpad, fftz2, u, is, y0.f, cfftz, logd.f, xout, d, y0.f, dims.f, y1.f, _imopVarPre266, printf]
...
WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u1.f]*/
    ...
    /*READ_S: [k, u.f, y1.f, fftblock, logd, y1.f, y0.f, _imopVarPre267, exit, x, u1.f, fftblockpad, fftz2, u, is, y0.f, cfftz, logd.f, xout, d, y0.f, dims.f, y1.f, _imopVarPre266, printf]
    WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u1.f]*/
...
#pragma omp for nowait
        ...
        WRITE_S: []*/
        for (k = 0; k < d[2]; k++) {
        /*READ_S: [fftz2, u, is, u.f, y0.f, y1.f, fftblock, cfftz, logd.f, xout, logd, d, y0.f, dims.f, y1.f, y0.f, _imopVarPre267, exit, y1.f, _imopVarPre266, x, printf, u1.f, fftblockpad]
        WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u1.f]*/
            /*READ_S: []
            WRITE_S: []*/
            ...
            WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u1.f]*/
                ...
                /*READ_S: []
                WRITE_S: []*/
                /*READ_S: [dims.f, fftblock, x, d, u1.f]
                WRITE_S: []*/
                for (j = 0; j < fftblock; j++) {
                /*READ_S: [dims.f, x, d, u1.f]
                WRITE_S: []*/
                    /*READ_S: []
                    WRITE_S: []*/
                    /*READ_S: [dims.f, d]
                ...
                /*READ_S: []
                WRITE_S: []*/
                /*READ_S: [dims.f, fftblock, xout, d, u1.f]
                WRITE_S: [u1.f]*/
                for (j = 0; j < fftblock; j++) {
                /*READ_S: [dims.f, xout, d, u1.f]
                WRITE_S: [u1.f]*/
                    /*READ_S: []
                    WRITE_S: []*/
                    /*READ_S: [dims.f, d]
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [is, xout, u.f, d, y1.f, fftblock, y1.f, y0.f, _imopVarPre267, exit, ilog2, logd, u1.f, fftblockpad, fftz2, u, y0.f, k, cfftz, y0.f, dims.f, x, y1.f, _imopVarPre266, printf, logd.f]
WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u1.f]*/
static void cffts2(int is, int d[3] , dcomplex x[64][64][64] , dcomplex xout[64][64][64] , dcomplex y0[64][18] , dcomplex y1[64][18]) {
/*READ_S: [is, xout, u.f, d, y1.f, fftblock, y1.f, y0.f, _imopVarPre267, exit, ilog2, logd, u1.f, fftblockpad, fftz2, u, y0.f, k, cfftz, y0.f, dims.f, x, y1.f, _imopVarPre266, printf, logd.f]
WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u1.f]*/
    ...
    /*READ_S: [is, xout, u.f, d, y1.f, fftblock, y1.f, y0.f, _imopVarPre267, exit, logd, u1.f, fftblockpad, fftz2, u, y0.f, k, cfftz, y0.f, dims.f, x, y1.f, _imopVarPre266, printf, logd.f]
    WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u1.f]*/
...
#pragma omp for nowait
        ...
        WRITE_S: []*/
        for (k = 0; k < d[2]; k++) {
        /*READ_S: [fftz2, is, xout, u, u.f, d, y0.f, y1.f, fftblock, cfftz, y0.f, dims.f, y1.f, x, y0.f, _imopVarPre267, exit, y1.f, _imopVarPre266, printf, logd, logd.f, u1.f, fftblockpad]
        WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u1.f]*/
            /*READ_S: []
            WRITE_S: []*/
            /*READ_S: [dims.f, d, fftblock]
            WRITE_S: []*/
            /*READ_S: [fftblock]
            WRITE_S: []*/
            /*READ_S: [fftz2, is, xout, u, u.f, d, y0.f, y1.f, fftblock, cfftz, y0.f, dims.f, y1.f, x, y0.f, _imopVarPre267, exit, y1.f, _imopVarPre266, printf, logd, logd.f, u1.f, fftblockpad]
            ...
            WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u1.f]*/
                ...
                /*READ_S: []
                WRITE_S: []*/
                /*READ_S: [dims.f, x, d, fftblock, u1.f]
                WRITE_S: []*/
                for (j = 0; j < d[1]; j++) {
                ...
                /*READ_S: []
                WRITE_S: []*/
                /*READ_S: [dims.f, xout, d, fftblock, u1.f]
                WRITE_S: [u1.f]*/
                for (j = 0; j < d[1]; j++) {
                /*READ_S: [xout, fftblock, u1.f]
                WRITE_S: [u1.f]*/
                    /*READ_S: []
                    WRITE_S: []*/
                    /*READ_S: [fftblock]
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [u.f, logd, y1.f, fftblock, y1.f, is, y0.f, _imopVarPre267, exit, ilog2, d, u1.f, fftblockpad, fftz2, u, logd.f, j, y0.f, x, cfftz, y0.f, dims.f, y1.f, _imopVarPre266, xout, printf, u2.f, u0.f]
WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u2.f, u1.f, u0.f]*/
static void cffts3(int is, int d[3] , dcomplex x[64][64][64] , dcomplex xout[64][64][64] , dcomplex y0[64][18] , dcomplex y1[64][18]) {
/*READ_S: [u.f, logd, y1.f, fftblock, y1.f, is, y0.f, _imopVarPre267, exit, ilog2, d, u1.f, fftblockpad, fftz2, u, logd.f, j, y0.f, x, cfftz, y0.f, dims.f, y1.f, _imopVarPre266, xout, printf, u2.f, u0.f]
WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u2.f, u1.f, u0.f]*/
    ...
    /*READ_S: [u.f, logd, y1.f, fftblock, y1.f, is, y0.f, _imopVarPre267, exit, d, u1.f, fftblockpad, fftz2, u, logd.f, j, y0.f, x, cfftz, y0.f, dims.f, y1.f, _imopVarPre266, xout, printf, u2.f, u0.f]
    WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u2.f, u1.f, u0.f]*/
#pragma omp parallel default(shared) private(i, j, k, ii) shared(is)
    {
    /*READ_S: [u.f, logd, y1.f, fftblock, y1.f, is, y0.f, _imopVarPre267, exit, d, u1.f, fftblockpad, fftz2, u, logd.f, j, y0.f, x, cfftz, y0.f, dims.f, y1.f, _imopVarPre266, xout, printf, u2.f, u0.f]
...
#pragma omp for nowait
        ...
        WRITE_S: []*/
        for (j = 0; j < d[1]; j++) {
        /*READ_S: [u.f, logd, y1.f, fftblock, y1.f, is, y0.f, _imopVarPre267, exit, d, u1.f, fftblockpad, fftz2, u, logd.f, y0.f, x, cfftz, y0.f, dims.f, y1.f, _imopVarPre266, xout, printf, u2.f, u0.f]
        WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u2.f, u1.f, u0.f]*/
            /*READ_S: []
            WRITE_S: []*/
            /*READ_S: [dims.f, fftblock, d]
            ...
            WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, u2.f, u1.f, u0.f]*/
                ...
                /*READ_S: []
                WRITE_S: []*/
                /*READ_S: [dims.f, fftblock, x, u1.f, d]
                WRITE_S: []*/
                for (k = 0; k < d[2]; k++) {
                ...
                /*READ_S: []
                WRITE_S: []*/
                /*READ_S: [dims.f, xout, fftblock, u2.f, u1.f, d, u0.f]
                WRITE_S: [u2.f, u1.f, u0.f]*/
                for (k = 0; k < d[2]; k++) {
                /*READ_S: [xout, fftblock, u2.f, u1.f, u0.f]
                WRITE_S: [u2.f, u1.f, u0.f]*/
                    /*READ_S: []
                    WRITE_S: []*/
                    /*READ_S: [fftblock]
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [fftz2, u, u.f, y0.f, y1.f, fftblock, y0.f, y1.f, y0.f, exit, _imopVarPre267, y1.f, _imopVarPre266, printf, fftblockpad]
...
WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f]*/
    ...
    WRITE_S: []*/
    /*READ_S: [exit, _imopVarPre267, printf]
    WRITE_S: []*/
    if (_imopVarPre267) {
    /*READ_S: [exit, printf]
    WRITE_S: []*/
    ...
    /*READ_S: []
    WRITE_S: []*/
    /*READ_S: [y0.f, y1.f, fftz2, u, y0.f, u.f, y1.f, y0.f, y1.f, fftblock, fftblockpad]
    WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f]*/
    for (l = 1; l <= m; l += 2) {
    /*READ_S: [y0.f, y1.f, fftz2, u, y0.f, u.f, y1.f, y0.f, y1.f, fftblock, fftblockpad]
    WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f]*/
        /*READ_S: [fftz2, u, fftblock, fftblockpad]
        WRITE_S: []*/
    ...
    /*READ_S: []
    WRITE_S: []*/
    /*READ_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f, fftblock]
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [y0.f, y1.f, u.f, y0.f, y1.f, y0.f, y1.f]
WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f]*/
static void fftz2(int is, int l , int m , int n , int ny , int ny1 , dcomplex u[64] , dcomplex x[64][18] , dcomplex y[64][18]) {
/*READ_S: [y0.f, y1.f, u.f, y0.f, y1.f, y0.f, y1.f]
WRITE_S: [y0.f, y1.f, y0.f, y1.f, y0.f, y1.f]*/
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [xend.f, zstart, zstart.f, xend, _imopVarPre272, _imopVarPre276, ystart, j, ystart.f, xstart, xstart.f, u1, yend.f, yend, zend, i, zend.f, printf, sums, u2.f, sums.f, _imopVarPre274]
WRITE_S: [sums.f]*/
static void checksum(int i, dcomplex u1[64][64][64] , int d[3]) {
/*READ_S: [xend.f, zstart, zstart.f, xend, _imopVarPre272, _imopVarPre276, ystart, j, ystart.f, xstart, xstart.f, u1, yend.f, yend, zend, i, zend.f, printf, sums, u2.f, sums.f, _imopVarPre274]
WRITE_S: [sums.f]*/
...
#pragma omp parallel default(shared)
    ...
    WRITE_S: [sums.f]*/
        ...
        WRITE_S: []*/
        chk.imag = 0.0;
        /*READ_S: [xend.f, zstart, zstart.f, xend, _imopVarPre272, _imopVarPre276, ystart, j, ystart.f, xstart, xstart.f, u1, yend.f, yend, zend, zend.f, u2.f, _imopVarPre274]
        WRITE_S: []*/
#pragma omp for nowait
        /*READ_S: [j]
        WRITE_S: []*/
        ...
        WRITE_S: []*/
        for (j = 1; j <= 1024; j++) {
        /*READ_S: [xend.f, zstart, zstart.f, xend, _imopVarPre272, _imopVarPre276, ystart, ystart.f, xstart, xstart.f, u1, yend.f, yend, zend, zend.f, u2.f, _imopVarPre274]
        WRITE_S: []*/
            /*READ_S: []
            WRITE_S: []*/
            q = j % 64 + 1;
            ...
            WRITE_S: []*/
            /*READ_S: [xend.f, xend, _imopVarPre272]
            WRITE_S: []*/
            if (_imopVarPre272) {
            /*READ_S: [xend.f, xend]
            WRITE_S: []*/
            ...
            /*READ_S: [_imopVarPre272]
            WRITE_S: []*/
            /*READ_S: [zstart, zstart.f, _imopVarPre272, _imopVarPre276, ystart, ystart.f, xstart, xstart.f, u1, yend.f, yend, zend, zend.f, u2.f, _imopVarPre274]
            WRITE_S: []*/
            if (_imopVarPre272) {
            /*READ_S: [zstart, zstart.f, _imopVarPre276, ystart, ystart.f, xstart, xstart.f, u1, yend.f, yend, zend, zend.f, u2.f, _imopVarPre274]
            WRITE_S: []*/
                /*READ_S: []
                WRITE_S: []*/
                r = (3 * j) % 64 + 1;
                ...
                WRITE_S: []*/
                /*READ_S: [yend.f, yend, _imopVarPre274]
                WRITE_S: []*/
                if (_imopVarPre274) {
                /*READ_S: [yend.f, yend]
                WRITE_S: []*/
                ...
                /*READ_S: [_imopVarPre274]
                WRITE_S: []*/
                /*READ_S: [zstart, zstart.f, u1, _imopVarPre276, zend, ystart, ystart.f, zend.f, xstart, u2.f, xstart.f, _imopVarPre274]
                WRITE_S: []*/
                if (_imopVarPre274) {
                /*READ_S: [zstart, zstart.f, u1, _imopVarPre276, zend, ystart, ystart.f, zend.f, xstart, u2.f, xstart.f]
                WRITE_S: []*/
                    /*READ_S: []
                    WRITE_S: []*/
                    s = (5 * j) % 64 + 1;
                    ...
                    WRITE_S: []*/
                    /*READ_S: [_imopVarPre276, zend, zend.f]
                    WRITE_S: []*/
                    if (_imopVarPre276) {
                    /*READ_S: [zend, zend.f]
                    WRITE_S: []*/
                    ...
                    /*READ_S: [_imopVarPre276]
                    WRITE_S: []*/
                    /*READ_S: [zstart, zstart.f, u1, _imopVarPre276, ystart, ystart.f, xstart, u2.f, xstart.f]
                    WRITE_S: []*/
                    if (_imopVarPre276) {
                    /*READ_S: [zstart, zstart.f, u1, ystart, ystart.f, xstart, u2.f, xstart.f]
                    WRITE_S: []*/
                        /*READ_S: [zstart, zstart.f, u1, ystart, ystart.f, xstart, u2.f, xstart.f]
                        WRITE_S: []*/
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [_imopVarPre305, _imopVarPre304, _imopVarPre315, _imopVarPre316, _imopVarPre314, _imopVarPre324, _imopVarPre325, _imopVarPre326, _imopVarPre286, _imopVarPre296, fabs, _imopVarPre295, _imopVarPre285, _imopVarPre294, printf, _imopVarPre284, sums, sums.f, _imopVarPre306]
WRITE_S: []*/
static void verify(int d1, int d2 , int d3 , int nt , boolean *verified , char *class) {
/*READ_S: [_imopVarPre305, _imopVarPre304, _imopVarPre315, _imopVarPre316, _imopVarPre314, _imopVarPre324, _imopVarPre325, _imopVarPre326, _imopVarPre286, _imopVarPre296, fabs, _imopVarPre295, _imopVarPre285, _imopVarPre294, printf, _imopVarPre284, sums, sums.f, _imopVarPre306]
WRITE_S: []*/
    ...
    *class = 'U';
    ...
    WRITE_S: []*/
    /*READ_S: [_imopVarPre286, _imopVarPre285, _imopVarPre284]
    WRITE_S: []*/
    if (_imopVarPre284) {
    /*READ_S: [_imopVarPre286, _imopVarPre285]
    WRITE_S: []*/
        /*READ_S: []
        WRITE_S: []*/
    ...
    /*READ_S: [_imopVarPre284]
    WRITE_S: []*/
    /*READ_S: [_imopVarPre305, _imopVarPre304, _imopVarPre315, _imopVarPre316, _imopVarPre314, _imopVarPre324, _imopVarPre325, _imopVarPre326, _imopVarPre296, fabs, _imopVarPre295, _imopVarPre294, _imopVarPre284, sums, sums.f, _imopVarPre306]
    WRITE_S: []*/
    if (_imopVarPre284) {
    /*READ_S: [fabs, sums, sums.f]
    WRITE_S: []*/
        /*READ_S: []
        WRITE_S: []*/
        *class = 'S';
    ...
    /*READ_S: [_imopVarPre305, _imopVarPre304, _imopVarPre315, _imopVarPre316, _imopVarPre314, _imopVarPre324, _imopVarPre325, _imopVarPre326, _imopVarPre296, fabs, _imopVarPre295, _imopVarPre294, sums, sums.f, _imopVarPre306]
    WRITE_S: []*/
        /*READ_S: []
        WRITE_S: []*/
        int _imopVarPre294;
        ...
        /*READ_S: [_imopVarPre294]
        WRITE_S: []*/
        /*READ_S: [_imopVarPre305, _imopVarPre304, _imopVarPre315, _imopVarPre316, _imopVarPre314, _imopVarPre324, _imopVarPre325, _imopVarPre326, fabs, _imopVarPre294, sums, sums.f, _imopVarPre306]
        WRITE_S: []*/
        if (_imopVarPre294) {
        /*READ_S: [fabs, sums, sums.f]
        WRITE_S: []*/
        ...
        /*READ_S: [_imopVarPre305, _imopVarPre304, _imopVarPre315, _imopVarPre316, _imopVarPre314, fabs, _imopVarPre324, _imopVarPre325, _imopVarPre326, sums, sums.f, _imopVarPre306]
        WRITE_S: []*/
            /*READ_S: []
            WRITE_S: []*/
            int _imopVarPre304;
            ...
            WRITE_S: []*/
            /*READ_S: [_imopVarPre305, _imopVarPre304, _imopVarPre306]
            WRITE_S: []*/
            if (_imopVarPre304) {
            /*READ_S: [_imopVarPre305, _imopVarPre306]
            WRITE_S: []*/
                /*READ_S: []
                WRITE_S: []*/
            ...
            /*READ_S: [_imopVarPre304]
            WRITE_S: []*/
            /*READ_S: [_imopVarPre304, _imopVarPre315, _imopVarPre316, _imopVarPre314, fabs, _imopVarPre324, _imopVarPre325, _imopVarPre326, sums, sums.f]
            WRITE_S: []*/
            if (_imopVarPre304) {
            /*READ_S: [fabs, sums, sums.f]
            WRITE_S: []*/
            ...
            /*READ_S: [_imopVarPre315, _imopVarPre316, _imopVarPre314, fabs, _imopVarPre324, _imopVarPre325, _imopVarPre326, sums, sums.f]
            WRITE_S: []*/
                /*READ_S: []
                WRITE_S: []*/
                int _imopVarPre314;
                ...
                WRITE_S: []*/
                /*READ_S: [_imopVarPre315, _imopVarPre316, _imopVarPre314]
                WRITE_S: []*/
                if (_imopVarPre314) {
                /*READ_S: [_imopVarPre315, _imopVarPre316]
                WRITE_S: []*/
                    /*READ_S: []
                    WRITE_S: []*/
                ...
                /*READ_S: [_imopVarPre314]
                WRITE_S: []*/
                /*READ_S: [_imopVarPre314, fabs, _imopVarPre324, _imopVarPre325, _imopVarPre326, sums, sums.f]
                WRITE_S: []*/
                if (_imopVarPre314) {
                /*READ_S: [fabs, sums, sums.f]
                WRITE_S: []*/
                ...
                /*READ_S: [_imopVarPre324, fabs, _imopVarPre325, _imopVarPre326, sums, sums.f]
                WRITE_S: []*/
                    /*READ_S: []
                    WRITE_S: []*/
                    int _imopVarPre324;
                    ...
                    /*READ_S: [_imopVarPre324]
                    WRITE_S: []*/
                    /*READ_S: [fabs, _imopVarPre324, sums, sums.f]
                    WRITE_S: []*/
                    if (_imopVarPre324) {
                    /*READ_S: [fabs, sums, sums.f]
                    WRITE_S: []*/
