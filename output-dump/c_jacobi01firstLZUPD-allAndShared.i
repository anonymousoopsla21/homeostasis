...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [n, relax, OSCR_init, ax, OSCR_timer_start, b, error, f, OSCR_getarg_double, OSCR_timer_read, j, omp_get_max_threads, mits, heapCell#0, OSCR_report, _imopVarPre160, m, tol, initialize, m, ay, OSCR_getarg_int, printf, free, uold, alpha, omega, jacobi, n, sqrt, error_check, OSCR_timer_stop, u]
WRITE_S: [mits, heapCell#0, relax, n, m, tol, error, alpha]*/
...
WRITE_S: [mits, heapCell#0, relax, n, m, tol, error, alpha]*/
    ...
    /*READ_S: []
    WRITE_S: [mits]*/
    /*READ_S: [mits, n, relax, m, printf, tol, alpha]
    WRITE_S: []*/
    ...
    /*READ_S: []
    WRITE_S: []*/
    /*READ_S: [jacobi, mits, n, relax, m, tol, alpha]
    WRITE_S: []*/
    ...
    /*READ_S: [mits, n, m, printf]
    WRITE_S: []*/
    printf(" MFlops       : %12.6g (%d, %d, %d, %g)\n", mflops, mits, m, n, dt);
    /*READ_S: []
    WRITE_S: []*/
    /*READ_S: [error_check, n, m, alpha]
    WRITE_S: []*/
...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [m, n, ay, ax, printf, free, b, error, f, uold, omega, j, sqrt, _imopVarPre160, u]
WRITE_S: [error]*/
...
WRITE_S: [error]*/
    ...
    /*READ_S: [_imopVarPre160]
    WRITE_S: []*/
    /*READ_S: [m, n, ay, ax, b, error, f, uold, j, omega, sqrt, _imopVarPre160, u]
    WRITE_S: [error]*/
...
#pragma omp barrier
        ...
        /*READ_S: [m, n, ay, ax, error, b, u, f, uold, omega, j]
        WRITE_S: [error]*/
#pragma omp parallel private(i, resid)
        {
        /*READ_S: [m, n, ay, ax, error, b, u, f, uold, omega, j]
        WRITE_S: [error]*/
            /*READ_S: [m, n, ay, ax, b, error, u, f, uold, omega, j]
            WRITE_S: [error]*/
#pragma omp for reduction(+:error) nowait
            ...
            WRITE_S: []*/
            for (j = 1; j < m - 1; j++) {
            /*READ_S: [m, n, ay, ax, b, error, u, f, uold, omega]
            WRITE_S: [error]*/
                /*READ_S: []
                WRITE_S: []*/
                /*READ_S: [n]
