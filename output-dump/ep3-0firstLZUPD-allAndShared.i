...
/*READ_S: []
WRITE_S: []*/
/*READ_S: [randlc, timer_stop, __sprintf_chk, timer_read, sqrt, fabs, log, printf, q, sy, _imopVarPre153, _imopVarPre343, _imopVarPre252, c_print_results, k_offset, np, _imopVarPre325, timer_clear, timer_start, __builtin_object_size, _imopVarPre307, an, q.f, vranlc, _imopVarPre289, _imopVarPre271, _imopVarPre201, pow, sx, k, i]
WRITE_S: [q.f, sy, sx]*/
...
#pragma omp barrier
    ...
    WRITE_S: []*/
    k_offset = -1;
    /*READ_S: [randlc, timer_stop, np, timer_start, sqrt, fabs, log, an, q.f, vranlc, q, sy, sx, k, _imopVarPre252, k_offset]
    WRITE_S: [q.f, sy, sx]*/
#pragma omp parallel copyin(x)
    ...
    WRITE_S: [q.f, sy, sx]*/
        ...
        /*READ_S: [randlc, timer_stop, np, timer_start, sqrt, fabs, log, an, vranlc, sy, sx, k, _imopVarPre252, k_offset]
        WRITE_S: [sy, sx]*/
#pragma omp for reduction(+:sx, sy) schedule(static) nowait
        ...
        WRITE_S: []*/
        for (k = 1; k <= np; k++) {
        /*READ_S: [randlc, fabs, log, timer_stop, an, vranlc, sy, timer_start, sx, sqrt, _imopVarPre252, k_offset]
        WRITE_S: [sy, sx]*/
            /*READ_S: [k_offset]
            WRITE_S: []*/
            kk = k_offset + k;
            ...
            /*READ_S: []
            WRITE_S: []*/
            /*READ_S: [fabs, log, sy, sx, sqrt, _imopVarPre252]
            WRITE_S: [sy, sx]*/
            for (i = 0; i < (1 << 16); i++) {
            /*READ_S: [fabs, log, sy, sx, sqrt, _imopVarPre252]
            WRITE_S: [sy, sx]*/
...
#pragma omp critical
    ...
    /*READ_S: []
    WRITE_S: []*/
    /*READ_S: [fabs, _imopVarPre307, _imopVarPre289, _imopVarPre271, _imopVarPre325, _imopVarPre343]
    WRITE_S: []*/
    if (24 == 24) {
    /*READ_S: [fabs, _imopVarPre271]
    WRITE_S: []*/
        /*READ_S: []
        WRITE_S: []*/
    ...
    /*READ_S: [fabs, _imopVarPre307, _imopVarPre289, _imopVarPre325, _imopVarPre343]
    WRITE_S: []*/
        /*READ_S: []
        WRITE_S: []*/
        /*READ_S: [fabs, _imopVarPre307, _imopVarPre289, _imopVarPre325, _imopVarPre343]
        ...
        /*READ_S: [fabs, _imopVarPre307, _imopVarPre325, _imopVarPre343]
        WRITE_S: []*/
            /*READ_S: []
            WRITE_S: []*/
            /*READ_S: [fabs, _imopVarPre307, _imopVarPre325, _imopVarPre343]
            ...
            /*READ_S: [fabs, _imopVarPre325, _imopVarPre343]
            WRITE_S: []*/
                /*READ_S: []
                WRITE_S: []*/
                /*READ_S: [fabs, _imopVarPre325, _imopVarPre343]
