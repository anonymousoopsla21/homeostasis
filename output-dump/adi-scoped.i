...
extern __inline int __sputc(int _c, FILE *_p) {
    int _imopVarPre11;
    int _imopVarPre15;
    _imopVarPre11 = --_p->_w >= 0;
    if (!_imopVarPre11) {
        _imopVarPre15 = _p->_w >= _p->_lbfsize;
        if (_imopVarPre15) {
            _imopVarPre15 = (char) _c != '\n';
        }
        _imopVarPre11 = _imopVarPre15;
    }
    if (_imopVarPre11) {
        return (*_p->_p++ = _c);
    } else {
        int _imopVarPre17;
        _imopVarPre17 = __swbuf(_c, _p);
        return _imopVarPre17;
    }
}
void flockfile(FILE *);
...
extern __inline int __inline_isfinitef(float __x) {
    ...
    float _imopVarPre97;
    float _imopVarPre98;
    _imopVarPre96 = __x == __x;
    if (_imopVarPre96) {
        _imopVarPre97 = __builtin_fabsf(__x);
        _imopVarPre98 = __builtin_inff();
        _imopVarPre96 = _imopVarPre97 != _imopVarPre98;
    }
    return _imopVarPre96;
}
extern __inline int __inline_isfinited(double __x) {
    int _imopVarPre102;
    double _imopVarPre103;
    double _imopVarPre104;
    _imopVarPre102 = __x == __x;
    if (_imopVarPre102) {
        _imopVarPre103 = __builtin_fabs(__x);
        _imopVarPre104 = __builtin_inf();
...
extern __inline int __inline_isnormalf(float __x) {
    int _imopVarPre125;
    float _imopVarPre126;
    _imopVarPre125 = __inline_isfinitef(__x);
    if (_imopVarPre125) {
        _imopVarPre126 = __builtin_fabsf(__x);
        _imopVarPre125 = _imopVarPre126 >= 1.17549435082228750797e-38F;
    }
    return _imopVarPre125;
}
extern __inline int __inline_isnormald(double __x) {
    int _imopVarPre129;
    double _imopVarPre130;
    _imopVarPre129 = __inline_isfinited(__x);
    if (_imopVarPre129) {
        _imopVarPre130 = __builtin_fabs(__x);
        _imopVarPre129 = _imopVarPre130 >= ((double) 2.22507385850720138309e-308L);
    }
    return _imopVarPre129;
}
extern __inline int __inline_isnormall(long double __x) {
    int _imopVarPre133;
    long double _imopVarPre134;
    _imopVarPre133 = __inline_isfinitel(__x);
    if (_imopVarPre133) {
        _imopVarPre134 = __builtin_fabsl(__x);
        _imopVarPre133 = _imopVarPre134 >= 3.36210314311209350626e-4932L;
    }
    return _imopVarPre133;
}
...
extern __inline void __sincosf(float __x, float *__sinp , float *__cosp) {
    struct __float2 _imopVarPre135;
    _imopVarPre135 = __sincosf_stret(__x);
    const struct __float2 __stret = _imopVarPre135;
    *__sinp = __stret.__sinval;
    *__cosp = __stret.__cosval;
}
extern __inline void __sincos(double __x, double *__sinp , double *__cosp) {
    struct __double2 _imopVarPre136;
    _imopVarPre136 = __sincos_stret(__x);
    const struct __double2 __stret = _imopVarPre136;
    *__sinp = __stret.__sinval;
    *__cosp = __stret.__cosval;
}
extern __inline void __sincospif(float __x, float *__sinp , float *__cosp) {
    struct __float2 _imopVarPre137;
    _imopVarPre137 = __sincospif_stret(__x);
...
extern __inline void __sincospi(double __x, double *__sinp , double *__cosp) {
    ...
    _imopVarPre138 = __sincospi_stret(__x);
