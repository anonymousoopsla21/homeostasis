...
/*[]*/
    ...
    /*[]*/
    /*[]*/
    for (i_imopVarPre0 = 0; i_imopVarPre0 < numthreads; i_imopVarPre0++) {
    /*[]*/
        /*[]*/
        ...
        /*[]*/
        /*[]*/
        w1[i_imopVarPre0] = (smallarray_t *) _imopVarPre545;
        /*[]*/
        /*[]*/
        if (w1[i_imopVarPre0] == (smallarray_t *) ((void *) 0)) {
        /*[]*/
            /*[]*/
    ...
    /*[]*/
    /*[]*/
    for (j_imopVarPre1 = 0; j_imopVarPre1 < numthreads; j_imopVarPre1++) {
    /*[]*/
        /*[1]*/
#pragma omp parallel private(i_imopVarPre0)
        {
        /*[1]*/
            /*[1]*/
#pragma omp for nowait
            ...
            /*[1]*/
            /*[1]*/
            for (i_imopVarPre0 = 0; i_imopVarPre0 < ARCHnodes; i_imopVarPre0++) {
            /*[1]*/
                /*[1]*/
                w1[j_imopVarPre1][i_imopVarPre0].first = 0.0;
                /*[1]*/
                w1[j_imopVarPre1][i_imopVarPre0].second = 0.0;
                /*[1]*/
                w1[j_imopVarPre1][i_imopVarPre0].third = 0.0;
            }
        }
    }
    /*[]*/
    ...
    /*[]*/
        ...
        /*[]*/
        /*[]*/
        w2[i_imopVarPre0] = (int *) _imopVarPre553;
        /*[]*/
        /*[]*/
        if (w2[i_imopVarPre0] == (int *) ((void *) 0)) {
        /*[]*/
            /*[]*/
...
#pragma omp for nowait
            ...
            /*[2]*/
                /*[2]*/
                w2[j_imopVarPre1][i_imopVarPre0] = 0;
            }
        }
    }
    /*[]*/
    ...
    /*[]*/
    /*[]*/
    for (i_imopVarPre0 = 0; i_imopVarPre0 < 3; i_imopVarPre0++) {
    /*[]*/
        /*[]*/
        ...
        /*[]*/
        /*[]*/
        disp[i_imopVarPre0] = (double (*)[3]) _imopVarPre561;
        /*[]*/
        /*[]*/
        if (disp[i_imopVarPre0] == (double (*)[3]) ((void *) 0)) {
        /*[]*/
            /*[]*/
    ...
    /*[3]*/
#pragma omp parallel private(j_imopVarPre1)
    {
    /*[3]*/
        /*[3]*/
#pragma omp for nowait
        ...
        /*[3]*/
            /*[3]*/
            nodekind[i_imopVarPre0] = 0;
            /*[3]*/
            /*[3]*/
            /*[3]*/
            /*[3]*/
            for (j_imopVarPre1 = 0; j_imopVarPre1 < 3; j_imopVarPre1++) {
            /*[3]*/
                /*[3]*/
                M[i_imopVarPre0][j_imopVarPre1] = 0.0;
                /*[3]*/
                C[i_imopVarPre0][j_imopVarPre1] = 0.0;
                /*[3]*/
                M23[i_imopVarPre0][j_imopVarPre1] = 0.0;
                /*[3]*/
                C23[i_imopVarPre0][j_imopVarPre1] = 0.0;
                /*[3]*/
                V23[i_imopVarPre0][j_imopVarPre1] = 0.0;
                /*[3]*/
                disp[0][i_imopVarPre0][j_imopVarPre1] = 0.0;
                /*[3]*/
                disp[1][i_imopVarPre0][j_imopVarPre1] = 0.0;
                /*[3]*/
                disp[2][i_imopVarPre0][j_imopVarPre1] = 0.0;
            }
        }
    }
    /*[3]*/
    ...
    /*[3]*/
    /*[3]*/
    for (i_imopVarPre0 = 0; i_imopVarPre0 < ARCHelems; i_imopVarPre0++) {
    /*[3]*/
        /*[3]*/
        source_elms[i_imopVarPre0] = 1;
    }
    /*[3, 4]*/
#pragma omp parallel private(j_imopVarPre1, k_imopVarPre2)
    {
    /*[3, 4]*/
        /*[3, 4]*/
#pragma omp for nowait
        ...
        /*[3, 4]*/
        /*[3, 4]*/
        for (i_imopVarPre0 = 0; i_imopVarPre0 < ARCHmatrixlen; i_imopVarPre0++) {
        /*[3, 4]*/
            /*[3, 4]*/
            /*[3, 4]*/
            /*[3, 4]*/
            ...
            /*[3, 4]*/
                ...
                /*[3, 4]*/
                /*[3, 4]*/
                for (k_imopVarPre2 = 0; k_imopVarPre2 < 3; k_imopVarPre2++) {
                /*[3, 4]*/
                    /*[3, 4]*/
                    K[i_imopVarPre0][j_imopVarPre1][k_imopVarPre2] = 0.0;
                }
            }
        }
    }
...
#pragma omp master
            ...
            /*[8]*/
                ...
                Acol = ARCHmatrixcol;
                /*[8]*/
                Aindex = ARCHmatrixindex;
                /*[8]*/
                v_imopVarPre3 = _imopVarPre230;
                /*[8]*/
                w = _imopVarPre229;
            }
        }
        ...
        /*[8]*/
        /*[8]*/
        for (j_imopVarPre5 = 0; j_imopVarPre5 < numthreads; j_imopVarPre5++) {
        /*[8]*/
            /*[8, 9]*/
#pragma omp parallel private(i_imopVarPre4)
            {
            /*[8, 9]*/
                /*[8, 9]*/
#pragma omp for nowait
                ...
                /*[8, 9]*/
                /*[8, 9]*/
                for (i_imopVarPre4 = 0; i_imopVarPre4 < nodes; i_imopVarPre4++) {
                /*[8, 9]*/
                    /*[8, 9]*/
                    w2[j_imopVarPre5][i_imopVarPre4] = 0;
                }
            }
        }
        /*[8, 10]*/
#pragma omp parallel private(my_cpu_id, i_imopVarPre4, Anext, Alast, col, sum0, sum1, sum2, j_imopVarPre5, j)
        {
        /*[8, 10]*/
            /*[8, 10]*/
            my_cpu_id = 0;
...
#pragma omp for nowait
            ...
            /*[8, 10]*/
                /*[8, 10]*/
                Anext = Aindex[i_imopVarPre4];
                /*[8, 10]*/
                Alast = Aindex[i_imopVarPre4 + 1];
                /*[8, 10]*/
                sum0 = A[Anext][0][0] * v_imopVarPre3[i_imopVarPre4][0] + A[Anext][0][1] * v_imopVarPre3[i_imopVarPre4][1] + A[Anext][0][2] * v_imopVarPre3[i_imopVarPre4][2];
                /*[8, 10]*/
                sum1 = A[Anext][1][0] * v_imopVarPre3[i_imopVarPre4][0] + A[Anext][1][1] * v_imopVarPre3[i_imopVarPre4][1] + A[Anext][1][2] * v_imopVarPre3[i_imopVarPre4][2];
                /*[8, 10]*/
                sum2 = A[Anext][2][0] * v_imopVarPre3[i_imopVarPre4][0] + A[Anext][2][1] * v_imopVarPre3[i_imopVarPre4][1] + A[Anext][2][2] * v_imopVarPre3[i_imopVarPre4][2];
                /*[8, 10]*/
                Anext++;
                /*[8, 10]*/
                /*[8, 10]*/
                ...
                /*[8, 10]*/
                    ...
                    col = Acol[Anext];
                    /*[8, 10]*/
                    sum0 += A[Anext][0][0] * v_imopVarPre3[col][0] + A[Anext][0][1] * v_imopVarPre3[col][1] + A[Anext][0][2] * v_imopVarPre3[col][2];
                    /*[8, 10]*/
                    sum1 += A[Anext][1][0] * v_imopVarPre3[col][0] + A[Anext][1][1] * v_imopVarPre3[col][1] + A[Anext][1][2] * v_imopVarPre3[col][2];
                    /*[8, 10]*/
                    sum2 += A[Anext][2][0] * v_imopVarPre3[col][0] + A[Anext][2][1] * v_imopVarPre3[col][1] + A[Anext][2][2] * v_imopVarPre3[col][2];
                    /*[8, 10]*/
                    /*[8, 10]*/
                    ...
                    /*[8, 10]*/
                    w1[my_cpu_id][col].first += A[Anext][0][0] * v_imopVarPre3[i_imopVarPre4][0] + A[Anext][1][0] * v_imopVarPre3[i_imopVarPre4][1] + A[Anext][2][0] * v_imopVarPre3[i_imopVarPre4][2];
                    /*[8, 10]*/
                    w1[my_cpu_id][col].second += A[Anext][0][1] * v_imopVarPre3[i_imopVarPre4][0] + A[Anext][1][1] * v_imopVarPre3[i_imopVarPre4][1] + A[Anext][2][1] * v_imopVarPre3[i_imopVarPre4][2];
                    /*[8, 10]*/
                    w1[my_cpu_id][col].third += A[Anext][0][2] * v_imopVarPre3[i_imopVarPre4][0] + A[Anext][1][2] * v_imopVarPre3[i_imopVarPre4][1] + A[Anext][2][2] * v_imopVarPre3[i_imopVarPre4][2];
                    /*[8, 10]*/
                    Anext++;
                }
                /*[8, 10]*/
                /*[8, 10]*/
                if (w2[my_cpu_id][i_imopVarPre4] == 0) {
                /*[8, 10]*/
                    /*[8, 10]*/
                    w2[my_cpu_id][i_imopVarPre4] = 1;
                    /*[8, 10]*/
                    w1[my_cpu_id][i_imopVarPre4].first = 0.0;
                    /*[8, 10]*/
                    w1[my_cpu_id][i_imopVarPre4].second = 0.0;
                    /*[8, 10]*/
                    w1[my_cpu_id][i_imopVarPre4].third = 0.0;
                }
                /*[8, 10]*/
                w1[my_cpu_id][i_imopVarPre4].first += sum0;
                /*[8, 10]*/
                w1[my_cpu_id][i_imopVarPre4].second += sum1;
                /*[8, 10]*/
                w1[my_cpu_id][i_imopVarPre4].third += sum2;
            }
            /*[8, 10]*/
            // #pragma omp dummyFlush BARRIER_START
            /*[8, 10]*/
...
#pragma omp for nowait
            ...
            /*[8, 11]*/
                ...
                /*[8, 11]*/
                    /*[8, 11]*/
                    /*[8, 11]*/
                    if (w2[j_imopVarPre5][i_imopVarPre4]) {
                    /*[8, 11]*/
                        /*[8, 11]*/
                        w[i_imopVarPre4][0] += w1[j_imopVarPre5][i_imopVarPre4].first;
                        /*[8, 11]*/
                        w[i_imopVarPre4][1] += w1[j_imopVarPre5][i_imopVarPre4].second;
                        /*[8, 11]*/
                        w[i_imopVarPre4][2] += w1[j_imopVarPre5][i_imopVarPre4].third;
                    }
                }
            }
            /*[11]*/
...
#pragma omp for nowait
    ...
    /*[15]*/
#pragma omp parallel private(my_cpu_id, i, Anext, Alast, col, sum0, sum1, sum2, j)
    {
    /*[15]*/
        /*[15]*/
        my_cpu_id = 0;
