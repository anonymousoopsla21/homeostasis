...
static double deposit_imopVar77;
static double deposit_imopVar79;
...
#pragma omp master
        {
            deposit_imopVar91 = calc_deposit();
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for schedule(static) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre241;
            _imopVarPre241 = partArray[pidx];
            update_part(_imopVarPre241, deposit_imopVar91);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(static) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre243;
            _imopVarPre243 = partArray[pidx];
            update_part(_imopVarPre243, deposit_imopVar91);
        }
    }
    double deposit_imopVar92;
#pragma omp parallel
    {
        long pidx;
#pragma omp master
        {
            deposit_imopVar92 = calc_deposit();
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for schedule(static) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre245;
            _imopVarPre245 = partArray[pidx];
            update_part(_imopVarPre245, deposit_imopVar92);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(static) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre247;
            _imopVarPre247 = partArray[pidx];
            update_part(_imopVarPre247, deposit_imopVar92);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(static) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre249;
            _imopVarPre249 = partArray[pidx];
            update_part(_imopVarPre249, deposit_imopVar92);
        }
    }
    double deposit_imopVar84;
#pragma omp parallel
    {
        long pidx;
#pragma omp master
        {
            deposit_imopVar84 = calc_deposit();
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for schedule(static) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre251;
            _imopVarPre251 = partArray[pidx];
            update_part(_imopVarPre251, deposit_imopVar84);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(static) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre253;
            _imopVarPre253 = partArray[pidx];
            update_part(_imopVarPre253, deposit_imopVar84);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(static) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre255;
            _imopVarPre255 = partArray[pidx];
            update_part(_imopVarPre255, deposit_imopVar84);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(static) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre257;
            _imopVarPre257 = partArray[pidx];
            update_part(_imopVarPre257, deposit_imopVar84);
        }
    }
}
...
void dynamic_omp_cycle() {
    double deposit_imopVar86;
#pragma omp parallel
    {
        long pidx;
#pragma omp master
        {
            deposit_imopVar86 = calc_deposit();
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for schedule(dynamic) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre259;
            _imopVarPre259 = partArray[pidx];
            update_part(_imopVarPre259, deposit_imopVar86);
        }
    }
    double deposit_imopVar88;
#pragma omp parallel
    {
        long pidx;
#pragma omp master
        {
            deposit_imopVar88 = calc_deposit();
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for schedule(dynamic) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre261;
            _imopVarPre261 = partArray[pidx];
            update_part(_imopVarPre261, deposit_imopVar88);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(dynamic) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre263;
            _imopVarPre263 = partArray[pidx];
            update_part(_imopVarPre263, deposit_imopVar88);
        }
    }
...
#pragma omp for schedule(dynamic) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre265;
            _imopVarPre265 = partArray[pidx];
            update_part(_imopVarPre265, deposit_imopVar87);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(dynamic) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre267;
            _imopVarPre267 = partArray[pidx];
            update_part(_imopVarPre267, deposit_imopVar87);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(dynamic) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre269;
            _imopVarPre269 = partArray[pidx];
            update_part(_imopVarPre269, deposit_imopVar87);
        }
    }
    double deposit;
#pragma omp parallel
...
#pragma omp single nowait
    ...
    for (pidx = startPidx; pidx <= endPidx; pidx++) {
        ...
        update_part(_imopVarPre285, deposit_imopVar79);
    }
#pragma omp single nowait
    {
        deposit_imopVar79 = calc_deposit();
    ...
    for (pidx = startPidx; pidx <= endPidx; pidx++) {
        ...
        update_part(_imopVarPre287, deposit_imopVar79);
    }
#pragma omp single nowait
    {
        deposit_imopVar79 = calc_deposit();
    ...
    for (pidx = startPidx; pidx <= endPidx; pidx++) {
        ...
        update_part(_imopVarPre289, deposit_imopVar79);
    }
}
...
#pragma omp single nowait
    ...
    for (pidx = startPidx; pidx <= endPidx; pidx++) {
        ...
        update_part(_imopVarPre291, deposit_imopVar77);
    }
#pragma omp single nowait
    {
        deposit_imopVar77 = calc_deposit();
    ...
    for (pidx = startPidx; pidx <= endPidx; pidx++) {
        ...
        update_part(_imopVarPre293, deposit_imopVar77);
    }
#pragma omp single nowait
    {
        deposit_imopVar77 = calc_deposit();
    ...
    for (pidx = startPidx; pidx <= endPidx; pidx++) {
        ...
        update_part(_imopVarPre295, deposit_imopVar77);
    }
#pragma omp single nowait
    {
        deposit_imopVar77 = calc_deposit();
    ...
    for (pidx = startPidx; pidx <= endPidx; pidx++) {
        ...
        update_part(_imopVarPre297, deposit_imopVar77);
    }
}
...
#pragma omp single nowait
    ...
    for (pidx_imopVar80 = startPidx; pidx_imopVar80 <= endPidx; pidx_imopVar80++) {
        struct _Part *_imopVarPre285;
        _imopVarPre285 = partArray[pidx_imopVar80];
        update_part(_imopVarPre285, deposit_imopVar79);
    }
#pragma omp single nowait
    {
    ...
    for (pidx_imopVar80 = startPidx; pidx_imopVar80 <= endPidx; pidx_imopVar80++) {
        struct _Part *_imopVarPre287;
        _imopVarPre287 = partArray[pidx_imopVar80];
        update_part(_imopVarPre287, deposit_imopVar79);
    }
#pragma omp single nowait
    {
    ...
    for (pidx_imopVar80 = startPidx; pidx_imopVar80 <= endPidx; pidx_imopVar80++) {
        struct _Part *_imopVarPre289;
        _imopVarPre289 = partArray[pidx_imopVar80];
        update_part(_imopVarPre289, deposit_imopVar79);
    }
    long pidx_imopVar78;
#pragma omp single nowait
    ...
    for (pidx_imopVar78 = startPidx; pidx_imopVar78 <= endPidx; pidx_imopVar78++) {
        struct _Part *_imopVarPre291;
        _imopVarPre291 = partArray[pidx_imopVar78];
        update_part(_imopVarPre291, deposit_imopVar77);
    }
#pragma omp single nowait
    {
    ...
    for (pidx_imopVar78 = startPidx; pidx_imopVar78 <= endPidx; pidx_imopVar78++) {
        struct _Part *_imopVarPre293;
        _imopVarPre293 = partArray[pidx_imopVar78];
        update_part(_imopVarPre293, deposit_imopVar77);
    }
#pragma omp single nowait
    {
    ...
    for (pidx_imopVar78 = startPidx; pidx_imopVar78 <= endPidx; pidx_imopVar78++) {
        struct _Part *_imopVarPre295;
        _imopVarPre295 = partArray[pidx_imopVar78];
        update_part(_imopVarPre295, deposit_imopVar77);
    }
#pragma omp single nowait
    {
    ...
    for (pidx_imopVar78 = startPidx; pidx_imopVar78 <= endPidx; pidx_imopVar78++) {
        struct _Part *_imopVarPre297;
        _imopVarPre297 = partArray[pidx_imopVar78];
        update_part(_imopVarPre297, deposit_imopVar77);
    }
}
...
#pragma omp for schedule(static) nowait
    ...
    signed long int num_iterations_imopVar85;
    num_iterations_imopVar85 = 1;
#pragma omp parallel
    {
        long iteration;
        long subcycle;
        for (iteration = 0; iteration < num_iterations_imopVar85; iteration++) {
            for (subcycle = 0; subcycle < 10; subcycle++) {
            }
        }
    }
    ...
    signed long int num_iterations_imopVar76;
    num_iterations_imopVar76 = CLOMP_num_iterations;
#pragma omp parallel
    {
        long iteration;
        long subcycle;
        for (iteration = 0; iteration < num_iterations_imopVar76; iteration++) {
            for (subcycle = 0; subcycle < 10; subcycle++) {
            }
        }
    }
    ...
    deposit_imopVar75 = (1.0 + CLOMP_max_residue) / CLOMP_numParts;
#pragma omp parallel
    {
        long iteration;
        int startPidx;
        ...
        for (iteration = 0; iteration < num_iterations; iteration++) {
            bestcase_omp_cycle(startPidx, endPidx, deposit_imopVar75);
        }
    }
    for (iter = 0; iter < num_iterations; iter++) {
        for (subcycle = 0; subcycle < 10; subcycle++) {
    ...
    signed long int num_iterations_imopVar93;
    num_iterations_imopVar93 = CLOMP_num_iterations;
    long iter_imopVar94;
    long subcycle_imopVar95;
    double deposit_imopVar96;
    deposit_imopVar96 = (1.0 + CLOMP_max_residue) / CLOMP_numParts;
#pragma omp parallel
    {
        long iteration;
        int startPidx;
        ...
        for (iteration = 0; iteration < num_iterations_imopVar93; iteration++) {
            bestcase_omp_cycle(startPidx, endPidx, deposit_imopVar96);
        }
    }
    for (iter_imopVar94 = 0; iter_imopVar94 < num_iterations_imopVar93; iter_imopVar94++) {
        for (subcycle_imopVar95 = 0; subcycle_imopVar95 < 10; subcycle_imopVar95++) {
            partArray[0]->update_count = 1;
            double _imopVarPre338;
            _imopVarPre338 = calc_deposit();
            partArray[0]->firstZone->value = _imopVarPre338;
    ...
    reinitialize_parts();
    double deposit_imopVar98;
#pragma omp parallel
    {
        long pidx;
#pragma omp master
        {
            deposit_imopVar98 = calc_deposit();
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for schedule(static) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre239;
            _imopVarPre239 = partArray[pidx];
            update_part(_imopVarPre239, deposit_imopVar98);
        }
    }
    double deposit_imopVar91;
#pragma omp parallel
...
#pragma omp for schedule(dynamic) nowait
    ...
    double deposit_imopVar89;
#pragma omp parallel
    {
        long pidx;
#pragma omp master
        {
            deposit_imopVar89 = calc_deposit();
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for schedule(dynamic) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre271;
            _imopVarPre271 = partArray[pidx];
            update_part(_imopVarPre271, deposit_imopVar89);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(dynamic) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre273;
            _imopVarPre273 = partArray[pidx];
            update_part(_imopVarPre273, deposit_imopVar89);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(dynamic) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre275;
            _imopVarPre275 = partArray[pidx];
            update_part(_imopVarPre275, deposit_imopVar89);
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp master
...
#pragma omp for schedule(dynamic) nowait
        for (pidx = 0; pidx < CLOMP_numParts; pidx++) {
            struct _Part *_imopVarPre277;
            _imopVarPre277 = partArray[pidx];
            update_part(_imopVarPre277, deposit_imopVar89);
        }
    }
    reinitialize_parts();
    ...
    long iteration_imopVar97;
    for (iteration_imopVar97 = 0; iteration_imopVar97 < CLOMP_num_iterations; iteration_imopVar97++) {
        /*There was a namespace collision due to removal of this declaration.
        There was a namespace collision due to addition of this declaration.
        There was a namespace collision due to removal of this declaration.
        There was a namespace collision due to addition of this declaration.
...
#pragma omp for schedule(dynamic) nowait
    ...
    reinitialize_parts();
    signed long int num_iterations_imopVar83;
    num_iterations_imopVar83 = 1;
#pragma omp parallel
    {
        long iteration;
        int startPidx;
        ...
        for (iteration = 0; iteration < num_iterations_imopVar83; iteration++) {
            long pidx;
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp single nowait
...
#pragma omp barrier
    ...
    num_iterations_imopVar90 = CLOMP_num_iterations;
#pragma omp parallel
    {
        long iteration;
        int startPidx;
