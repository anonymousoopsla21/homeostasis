...
#pragma omp parallel
    {
        ...
        double wm1;
#pragma omp for nowait
        for (i_imopVar95 = 0; i_imopVar95 < grid_points[0]; i_imopVar95++) {
            for (j_imopVar96 = 0; j_imopVar96 < grid_points[1]; j_imopVar96++) {
                for (k_imopVar97 = 0; k_imopVar97 < grid_points[2]; k_imopVar97++) {
                    rho_inv = 1.0 / u[i_imopVar95][j_imopVar96][k_imopVar97][0];
                    rho_i[i_imopVar95][j_imopVar96][k_imopVar97] = rho_inv;
                    us[i_imopVar95][j_imopVar96][k_imopVar97] = u[i_imopVar95][j_imopVar96][k_imopVar97][1] * rho_inv;
                    vs[i_imopVar95][j_imopVar96][k_imopVar97] = u[i_imopVar95][j_imopVar96][k_imopVar97][2] * rho_inv;
                    ws[i_imopVar95][j_imopVar96][k_imopVar97] = u[i_imopVar95][j_imopVar96][k_imopVar97][3] * rho_inv;
                    square[i_imopVar95][j_imopVar96][k_imopVar97] = 0.5 * (u[i_imopVar95][j_imopVar96][k_imopVar97][1] * u[i_imopVar95][j_imopVar96][k_imopVar97][1] + u[i_imopVar95][j_imopVar96][k_imopVar97][2] * u[i_imopVar95][j_imopVar96][k_imopVar97][2] + u[i_imopVar95][j_imopVar96][k_imopVar97][3] * u[i_imopVar95][j_imopVar96][k_imopVar97][3]) * rho_inv;
                    qs[i_imopVar95][j_imopVar96][k_imopVar97] = square[i_imopVar95][j_imopVar96][k_imopVar97] * rho_inv;
                }
            }
        }
#pragma omp for nowait
        for (i_imopVar95 = 0; i_imopVar95 < grid_points[0]; i_imopVar95++) {
            for (j_imopVar96 = 0; j_imopVar96 < grid_points[1]; j_imopVar96++) {
                for (k_imopVar97 = 0; k_imopVar97 < grid_points[2]; k_imopVar97++) {
                    for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                        rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = forcing[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98];
                    }
                }
            }
        }
...
#pragma omp barrier
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
                for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                    uijk = us[i_imopVar95][j_imopVar96][k_imopVar97];
                    up1 = us[i_imopVar95 + 1][j_imopVar96][k_imopVar97];
                    um1 = us[i_imopVar95 - 1][j_imopVar96][k_imopVar97];
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][0] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][0] + dx1tx1 * (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][0] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][0] + u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][0]) - tx2 * (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][1] - u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][1]);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][1] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][1] + dx2tx1 * (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][1] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][1] + u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][1]) + xxcon2 * con43 * (up1 - 2.0 * uijk + um1) - tx2 * (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][1] * up1 - u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][1] * um1 + (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][4] - square[i_imopVar95 + 1][j_imopVar96][k_imopVar97] - u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][4] + square[i_imopVar95 - 1][j_imopVar96][k_imopVar97]) * c2);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][2] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][2] + dx3tx1 * (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][2] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][2] + u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][2]) + xxcon2 * (vs[i_imopVar95 + 1][j_imopVar96][k_imopVar97] - 2.0 * vs[i_imopVar95][j_imopVar96][k_imopVar97] + vs[i_imopVar95 - 1][j_imopVar96][k_imopVar97]) - tx2 * (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][2] * up1 - u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][2] * um1);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][3] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][3] + dx4tx1 * (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][3] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][3] + u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][3]) + xxcon2 * (ws[i_imopVar95 + 1][j_imopVar96][k_imopVar97] - 2.0 * ws[i_imopVar95][j_imopVar96][k_imopVar97] + ws[i_imopVar95 - 1][j_imopVar96][k_imopVar97]) - tx2 * (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][3] * up1 - u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][3] * um1);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][4] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][4] + dx5tx1 * (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][4] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][4] + u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][4]) + xxcon3 * (qs[i_imopVar95 + 1][j_imopVar96][k_imopVar97] - 2.0 * qs[i_imopVar95][j_imopVar96][k_imopVar97] + qs[i_imopVar95 - 1][j_imopVar96][k_imopVar97]) + xxcon4 * (up1 * up1 - 2.0 * uijk * uijk + um1 * um1) + xxcon5 * (u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][4] * rho_i[i_imopVar95 + 1][j_imopVar96][k_imopVar97] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][4] * rho_i[i_imopVar95][j_imopVar96][k_imopVar97] + u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][4] * rho_i[i_imopVar95 - 1][j_imopVar96][k_imopVar97]) - tx2 * ((c1 * u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][4] - c2 * square[i_imopVar95 + 1][j_imopVar96][k_imopVar97]) * up1 - (c1 * u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][4] - c2 * square[i_imopVar95 - 1][j_imopVar96][k_imopVar97]) * um1);
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
            for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (5.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][m_imopVar98] + u[i_imopVar95 + 2][j_imopVar96][k_imopVar97][m_imopVar98]);
                }
            }
        }
        i_imopVar95 = 2;
#pragma omp for nowait
        for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
            for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (-4.0 * u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][m_imopVar98] + 6.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][m_imopVar98] + u[i_imopVar95 + 2][j_imopVar96][k_imopVar97][m_imopVar98]);
                }
            }
        }
#pragma omp for nowait
        for (i_imopVar95 = 3; i_imopVar95 < grid_points[0] - 3; i_imopVar95++) {
            for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
                for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                    for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                        rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (u[i_imopVar95 - 2][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][m_imopVar98] + 6.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][m_imopVar98] + u[i_imopVar95 + 2][j_imopVar96][k_imopVar97][m_imopVar98]);
                    }
                }
            }
        }
        i_imopVar95 = grid_points[0] - 3;
#pragma omp for nowait
        for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
            for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (u[i_imopVar95 - 2][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][m_imopVar98] + 6.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95 + 1][j_imopVar96][k_imopVar97][m_imopVar98]);
                }
            }
        }
        i_imopVar95 = grid_points[0] - 2;
#pragma omp for nowait
        for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
            for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (u[i_imopVar95 - 2][j_imopVar96][k_imopVar97][m_imopVar98] - 4. * u[i_imopVar95 - 1][j_imopVar96][k_imopVar97][m_imopVar98] + 5.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98]);
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
                for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                    vijk = vs[i_imopVar95][j_imopVar96][k_imopVar97];
                    vp1 = vs[i_imopVar95][j_imopVar96 + 1][k_imopVar97];
                    vm1 = vs[i_imopVar95][j_imopVar96 - 1][k_imopVar97];
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][0] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][0] + dy1ty1 * (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][0] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][0] + u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][0]) - ty2 * (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][2] - u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][2]);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][1] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][1] + dy2ty1 * (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][1] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][1] + u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][1]) + yycon2 * (us[i_imopVar95][j_imopVar96 + 1][k_imopVar97] - 2.0 * us[i_imopVar95][j_imopVar96][k_imopVar97] + us[i_imopVar95][j_imopVar96 - 1][k_imopVar97]) - ty2 * (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][1] * vp1 - u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][1] * vm1);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][2] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][2] + dy3ty1 * (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][2] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][2] + u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][2]) + yycon2 * con43 * (vp1 - 2.0 * vijk + vm1) - ty2 * (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][2] * vp1 - u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][2] * vm1 + (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][4] - square[i_imopVar95][j_imopVar96 + 1][k_imopVar97] - u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][4] + square[i_imopVar95][j_imopVar96 - 1][k_imopVar97]) * c2);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][3] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][3] + dy4ty1 * (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][3] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][3] + u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][3]) + yycon2 * (ws[i_imopVar95][j_imopVar96 + 1][k_imopVar97] - 2.0 * ws[i_imopVar95][j_imopVar96][k_imopVar97] + ws[i_imopVar95][j_imopVar96 - 1][k_imopVar97]) - ty2 * (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][3] * vp1 - u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][3] * vm1);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][4] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][4] + dy5ty1 * (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][4] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][4] + u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][4]) + yycon3 * (qs[i_imopVar95][j_imopVar96 + 1][k_imopVar97] - 2.0 * qs[i_imopVar95][j_imopVar96][k_imopVar97] + qs[i_imopVar95][j_imopVar96 - 1][k_imopVar97]) + yycon4 * (vp1 * vp1 - 2.0 * vijk * vijk + vm1 * vm1) + yycon5 * (u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][4] * rho_i[i_imopVar95][j_imopVar96 + 1][k_imopVar97] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][4] * rho_i[i_imopVar95][j_imopVar96][k_imopVar97] + u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][4] * rho_i[i_imopVar95][j_imopVar96 - 1][k_imopVar97]) - ty2 * ((c1 * u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][4] - c2 * square[i_imopVar95][j_imopVar96 + 1][k_imopVar97]) * vp1 - (c1 * u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][4] - c2 * square[i_imopVar95][j_imopVar96 - 1][k_imopVar97]) * vm1);
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (5.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][m_imopVar98] + u[i_imopVar95][j_imopVar96 + 2][k_imopVar97][m_imopVar98]);
                }
            }
        }
        j_imopVar96 = 2;
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (-4.0 * u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][m_imopVar98] + 6.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][m_imopVar98] + u[i_imopVar95][j_imopVar96 + 2][k_imopVar97][m_imopVar98]);
                }
            }
        }
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (j_imopVar96 = 3; j_imopVar96 < grid_points[1] - 3; j_imopVar96++) {
                for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                    for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                        rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (u[i_imopVar95][j_imopVar96 - 2][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][m_imopVar98] + 6.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][m_imopVar98] + u[i_imopVar95][j_imopVar96 + 2][k_imopVar97][m_imopVar98]);
                    }
                }
            }
        }
        j_imopVar96 = grid_points[1] - 3;
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (u[i_imopVar95][j_imopVar96 - 2][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][m_imopVar98] + 6.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96 + 1][k_imopVar97][m_imopVar98]);
                }
            }
        }
        j_imopVar96 = grid_points[1] - 2;
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (u[i_imopVar95][j_imopVar96 - 2][k_imopVar97][m_imopVar98] - 4. * u[i_imopVar95][j_imopVar96 - 1][k_imopVar97][m_imopVar98] + 5. * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98]);
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
                for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                    wijk = ws[i_imopVar95][j_imopVar96][k_imopVar97];
                    wp1 = ws[i_imopVar95][j_imopVar96][k_imopVar97 + 1];
                    wm1 = ws[i_imopVar95][j_imopVar96][k_imopVar97 - 1];
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][0] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][0] + dz1tz1 * (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][0] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][0] + u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][0]) - tz2 * (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][3] - u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][3]);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][1] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][1] + dz2tz1 * (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][1] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][1] + u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][1]) + zzcon2 * (us[i_imopVar95][j_imopVar96][k_imopVar97 + 1] - 2.0 * us[i_imopVar95][j_imopVar96][k_imopVar97] + us[i_imopVar95][j_imopVar96][k_imopVar97 - 1]) - tz2 * (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][1] * wp1 - u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][1] * wm1);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][2] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][2] + dz3tz1 * (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][2] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][2] + u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][2]) + zzcon2 * (vs[i_imopVar95][j_imopVar96][k_imopVar97 + 1] - 2.0 * vs[i_imopVar95][j_imopVar96][k_imopVar97] + vs[i_imopVar95][j_imopVar96][k_imopVar97 - 1]) - tz2 * (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][2] * wp1 - u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][2] * wm1);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][3] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][3] + dz4tz1 * (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][3] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][3] + u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][3]) + zzcon2 * con43 * (wp1 - 2.0 * wijk + wm1) - tz2 * (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][3] * wp1 - u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][3] * wm1 + (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][4] - square[i_imopVar95][j_imopVar96][k_imopVar97 + 1] - u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][4] + square[i_imopVar95][j_imopVar96][k_imopVar97 - 1]) * c2);
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][4] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][4] + dz5tz1 * (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][4] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][4] + u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][4]) + zzcon3 * (qs[i_imopVar95][j_imopVar96][k_imopVar97 + 1] - 2.0 * qs[i_imopVar95][j_imopVar96][k_imopVar97] + qs[i_imopVar95][j_imopVar96][k_imopVar97 - 1]) + zzcon4 * (wp1 * wp1 - 2.0 * wijk * wijk + wm1 * wm1) + zzcon5 * (u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][4] * rho_i[i_imopVar95][j_imopVar96][k_imopVar97 + 1] - 2.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][4] * rho_i[i_imopVar95][j_imopVar96][k_imopVar97] + u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][4] * rho_i[i_imopVar95][j_imopVar96][k_imopVar97 - 1]) - tz2 * ((c1 * u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][4] - c2 * square[i_imopVar95][j_imopVar96][k_imopVar97 + 1]) * wp1 - (c1 * u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][4] - c2 * square[i_imopVar95][j_imopVar96][k_imopVar97 - 1]) * wm1);
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (5.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][m_imopVar98] + u[i_imopVar95][j_imopVar96][k_imopVar97 + 2][m_imopVar98]);
                }
            }
        }
        k_imopVar97 = 2;
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (-4.0 * u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][m_imopVar98] + 6.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][m_imopVar98] + u[i_imopVar95][j_imopVar96][k_imopVar97 + 2][m_imopVar98]);
                }
            }
        }
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
                for (k_imopVar97 = 3; k_imopVar97 < grid_points[2] - 3; k_imopVar97++) {
                    for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                        rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (u[i_imopVar95][j_imopVar96][k_imopVar97 - 2][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][m_imopVar98] + 6.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][m_imopVar98] + u[i_imopVar95][j_imopVar96][k_imopVar97 + 2][m_imopVar98]);
                    }
                }
            }
        }
        k_imopVar97 = grid_points[2] - 3;
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (u[i_imopVar95][j_imopVar96][k_imopVar97 - 2][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][m_imopVar98] + 6.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96][k_imopVar97 + 1][m_imopVar98]);
                }
            }
        }
        k_imopVar97 = grid_points[2] - 2;
#pragma omp for nowait
        for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
            for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] - dssp * (u[i_imopVar95][j_imopVar96][k_imopVar97 - 2][m_imopVar98] - 4.0 * u[i_imopVar95][j_imopVar96][k_imopVar97 - 1][m_imopVar98] + 5.0 * u[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98]);
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (j_imopVar96 = 1; j_imopVar96 < grid_points[1] - 1; j_imopVar96++) {
            for (k_imopVar97 = 1; k_imopVar97 < grid_points[2] - 1; k_imopVar97++) {
                for (m_imopVar98 = 0; m_imopVar98 < 5; m_imopVar98++) {
                    for (i_imopVar95 = 1; i_imopVar95 < grid_points[0] - 1; i_imopVar95++) {
                        rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] = rhs[i_imopVar95][j_imopVar96][k_imopVar97][m_imopVar98] * dt;
                    }
                }
            }
        }
...
#pragma omp barrier
        ...
        int m;
        int n;
        for (i_imopVar78 = grid_points[0] - 2; i_imopVar78 >= 0; i_imopVar78--) {
#pragma omp for nowait
            for (j_imopVar79 = 1; j_imopVar79 < grid_points[1] - 1; j_imopVar79++) {
                for (k_imopVar80 = 1; k_imopVar80 < grid_points[2] - 1; k_imopVar80++) {
                    for (m = 0; m < 5; m++) {
                        for (n = 0; n < 5; n++) {
                            rhs[i_imopVar78][j_imopVar79][k_imopVar80][m] = rhs[i_imopVar78][j_imopVar79][k_imopVar80][m] - lhs[i_imopVar78][j_imopVar79][k_imopVar80][2][m][n] * rhs[i_imopVar78 + 1][j_imopVar79][k_imopVar80][n];
                        }
                    }
                }
            }
...
#pragma omp for nowait
        for (i_imopVar99 = 1; i_imopVar99 < grid_points[0] - 1; i_imopVar99++) {
            for (j_imopVar100 = 0; j_imopVar100 < grid_points[1]; j_imopVar100++) {
                for (k_imopVar101 = 1; k_imopVar101 < grid_points[2] - 1; k_imopVar101++) {
                    ...
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][0][2] = 1.0;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][0][3] = 0.0;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][0][4] = 0.0;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][1][0] = -(u[i_imopVar99][j_imopVar100][k_imopVar101][1] * u[i_imopVar99][j_imopVar100][k_imopVar101][2]) * tmp2;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][1][1] = u[i_imopVar99][j_imopVar100][k_imopVar101][2] * tmp1;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][1][2] = u[i_imopVar99][j_imopVar100][k_imopVar101][1] * tmp1;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][1][3] = 0.0;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][1][4] = 0.0;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][2][0] = -(u[i_imopVar99][j_imopVar100][k_imopVar101][2] * u[i_imopVar99][j_imopVar100][k_imopVar101][2] * tmp2) + 0.50 * c2 * ((u[i_imopVar99][j_imopVar100][k_imopVar101][1] * u[i_imopVar99][j_imopVar100][k_imopVar101][1] + u[i_imopVar99][j_imopVar100][k_imopVar101][2] * u[i_imopVar99][j_imopVar100][k_imopVar101][2] + u[i_imopVar99][j_imopVar100][k_imopVar101][3] * u[i_imopVar99][j_imopVar100][k_imopVar101][3]) * tmp2);
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][2][1] = -c2 * u[i_imopVar99][j_imopVar100][k_imopVar101][1] * tmp1;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][2][2] = (2.0 - c2) * u[i_imopVar99][j_imopVar100][k_imopVar101][2] * tmp1;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][2][3] = -c2 * u[i_imopVar99][j_imopVar100][k_imopVar101][3] * tmp1;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][2][4] = c2;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][3][0] = -(u[i_imopVar99][j_imopVar100][k_imopVar101][2] * u[i_imopVar99][j_imopVar100][k_imopVar101][3]) * tmp2;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][3][1] = 0.0;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][3][2] = u[i_imopVar99][j_imopVar100][k_imopVar101][3] * tmp1;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][3][3] = u[i_imopVar99][j_imopVar100][k_imopVar101][2] * tmp1;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][3][4] = 0.0;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][4][0] = (c2 * (u[i_imopVar99][j_imopVar100][k_imopVar101][1] * u[i_imopVar99][j_imopVar100][k_imopVar101][1] + u[i_imopVar99][j_imopVar100][k_imopVar101][2] * u[i_imopVar99][j_imopVar100][k_imopVar101][2] + u[i_imopVar99][j_imopVar100][k_imopVar101][3] * u[i_imopVar99][j_imopVar100][k_imopVar101][3]) * tmp2 - c1 * u[i_imopVar99][j_imopVar100][k_imopVar101][4] * tmp1) * u[i_imopVar99][j_imopVar100][k_imopVar101][2] * tmp1;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][4][1] = -c2 * u[i_imopVar99][j_imopVar100][k_imopVar101][1] * u[i_imopVar99][j_imopVar100][k_imopVar101][2] * tmp2;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][4][2] = c1 * u[i_imopVar99][j_imopVar100][k_imopVar101][4] * tmp1 - 0.50 * c2 * ((u[i_imopVar99][j_imopVar100][k_imopVar101][1] * u[i_imopVar99][j_imopVar100][k_imopVar101][1] + 3.0 * u[i_imopVar99][j_imopVar100][k_imopVar101][2] * u[i_imopVar99][j_imopVar100][k_imopVar101][2] + u[i_imopVar99][j_imopVar100][k_imopVar101][3] * u[i_imopVar99][j_imopVar100][k_imopVar101][3]) * tmp2);
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][4][3] = -c2 * (u[i_imopVar99][j_imopVar100][k_imopVar101][2] * u[i_imopVar99][j_imopVar100][k_imopVar101][3]) * tmp2;
                    fjac[i_imopVar99][j_imopVar100][k_imopVar101][4][4] = c1 * u[i_imopVar99][j_imopVar100][k_imopVar101][2] * tmp1;
                    ...
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][2][0] = -con43 * c3c4 * tmp2 * u[i_imopVar99][j_imopVar100][k_imopVar101][2];
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][2][1] = 0.0;
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][2][2] = con43 * c3c4 * tmp1;
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][2][3] = 0.0;
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][2][4] = 0.0;
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][3][0] = -c3c4 * tmp2 * u[i_imopVar99][j_imopVar100][k_imopVar101][3];
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][3][1] = 0.0;
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][3][2] = 0.0;
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][3][3] = c3c4 * tmp1;
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][3][4] = 0.0;
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][4][0] = -(c3c4 - c1345) * tmp3 * (((u[i_imopVar99][j_imopVar100][k_imopVar101][1]) * (u[i_imopVar99][j_imopVar100][k_imopVar101][1]))) - (con43 * c3c4 - c1345) * tmp3 * (((u[i_imopVar99][j_imopVar100][k_imopVar101][2]) * (u[i_imopVar99][j_imopVar100][k_imopVar101][2]))) - (c3c4 - c1345) * tmp3 * (((u[i_imopVar99][j_imopVar100][k_imopVar101][3]) * (u[i_imopVar99][j_imopVar100][k_imopVar101][3]))) - c1345 * tmp2 * u[i_imopVar99][j_imopVar100][k_imopVar101][4];
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][4][1] = (c3c4 - c1345) * tmp2 * u[i_imopVar99][j_imopVar100][k_imopVar101][1];
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][4][2] = (con43 * c3c4 - c1345) * tmp2 * u[i_imopVar99][j_imopVar100][k_imopVar101][2];
                    njac[i_imopVar99][j_imopVar100][k_imopVar101][4][3] = (c3c4 - c1345) * tmp2 * u[i_imopVar99][j_imopVar100][k_imopVar101][3];
        ...
        for (i_imopVar99 = 1; i_imopVar99 < grid_points[0] - 1; i_imopVar99++) {
            for (j_imopVar100 = 1; j_imopVar100 < grid_points[1] - 1; j_imopVar100++) {
                for (k_imopVar101 = 1; k_imopVar101 < grid_points[2] - 1; k_imopVar101++) {
                    tmp1 = dt * ty1;
                    tmp2 = dt * ty2;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][0][0] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][0][0] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][0][0] - tmp1 * dy1;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][0][1] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][0][1] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][0][1];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][0][2] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][0][2] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][0][2];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][0][3] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][0][3] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][0][3];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][0][4] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][0][4] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][0][4];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][1][0] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][1][0] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][1][0];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][1][1] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][1][1] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][1][1] - tmp1 * dy2;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][1][2] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][1][2] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][1][2];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][1][3] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][1][3] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][1][3];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][1][4] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][1][4] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][1][4];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][2][0] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][2][0] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][2][0];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][2][1] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][2][1] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][2][1];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][2][2] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][2][2] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][2][2] - tmp1 * dy3;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][2][3] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][2][3] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][2][3];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][2][4] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][2][4] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][2][4];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][3][0] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][3][0] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][3][0];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][3][1] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][3][1] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][3][1];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][3][2] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][3][2] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][3][2];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][3][3] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][3][3] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][3][3] - tmp1 * dy4;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][3][4] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][3][4] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][3][4];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][4][0] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][4][0] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][4][0];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][4][1] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][4][1] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][4][1];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][4][2] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][4][2] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][4][2];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][4][3] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][4][3] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][4][3];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][0][4][4] = -tmp2 * fjac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][4][4] - tmp1 * njac[i_imopVar99][j_imopVar100 - 1][k_imopVar101][4][4] - tmp1 * dy5;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][1][0][0] = 1.0 + tmp1 * 2.0 * njac[i_imopVar99][j_imopVar100][k_imopVar101][0][0] + tmp1 * 2.0 * dy1;
                    ...
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][1][1][1] = 1.0 + tmp1 * 2.0 * njac[i_imopVar99][j_imopVar100][k_imopVar101][1][1] + tmp1 * 2.0 * dy2;
                    ...
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][1][2][2] = 1.0 + tmp1 * 2.0 * njac[i_imopVar99][j_imopVar100][k_imopVar101][2][2] + tmp1 * 2.0 * dy3;
                    ...
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][1][3][3] = 1.0 + tmp1 * 2.0 * njac[i_imopVar99][j_imopVar100][k_imopVar101][3][3] + tmp1 * 2.0 * dy4;
                    ...
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][1][4][4] = 1.0 + tmp1 * 2.0 * njac[i_imopVar99][j_imopVar100][k_imopVar101][4][4] + tmp1 * 2.0 * dy5;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][0][0] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][0][0] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][0][0] - tmp1 * dy1;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][0][1] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][0][1] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][0][1];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][0][2] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][0][2] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][0][2];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][0][3] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][0][3] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][0][3];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][0][4] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][0][4] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][0][4];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][1][0] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][1][0] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][1][0];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][1][1] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][1][1] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][1][1] - tmp1 * dy2;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][1][2] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][1][2] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][1][2];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][1][3] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][1][3] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][1][3];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][1][4] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][1][4] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][1][4];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][2][0] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][2][0] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][2][0];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][2][1] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][2][1] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][2][1];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][2][2] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][2][2] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][2][2] - tmp1 * dy3;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][2][3] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][2][3] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][2][3];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][2][4] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][2][4] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][2][4];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][3][0] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][3][0] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][3][0];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][3][1] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][3][1] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][3][1];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][3][2] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][3][2] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][3][2];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][3][3] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][3][3] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][3][3] - tmp1 * dy4;
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][3][4] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][3][4] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][3][4];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][4][0] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][4][0] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][4][0];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][4][1] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][4][1] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][4][1];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][4][2] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][4][2] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][4][2];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][4][3] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][4][3] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][4][3];
                    lhs[i_imopVar99][j_imopVar100][k_imopVar101][2][4][4] = tmp2 * fjac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][4][4] - tmp1 * njac[i_imopVar99][j_imopVar100 + 1][k_imopVar101][4][4] - tmp1 * dy5;
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp barrier
        ...
        int m_imopVar109;
        int n_imopVar110;
        for (j_imopVar107 = grid_points[1] - 2; j_imopVar107 >= 0; j_imopVar107--) {
#pragma omp for nowait
            for (i_imopVar106 = 1; i_imopVar106 < grid_points[0] - 1; i_imopVar106++) {
                for (k_imopVar108 = 1; k_imopVar108 < grid_points[2] - 1; k_imopVar108++) {
                    for (m_imopVar109 = 0; m_imopVar109 < 5; m_imopVar109++) {
                        for (n_imopVar110 = 0; n_imopVar110 < 5; n_imopVar110++) {
                            rhs[i_imopVar106][j_imopVar107][k_imopVar108][m_imopVar109] = rhs[i_imopVar106][j_imopVar107][k_imopVar108][m_imopVar109] - lhs[i_imopVar106][j_imopVar107][k_imopVar108][2][m_imopVar109][n_imopVar110] * rhs[i_imopVar106][j_imopVar107 + 1][k_imopVar108][n_imopVar110];
                        }
                    }
                }
            }
...
#pragma omp for nowait
        for (i_imopVar87 = 1; i_imopVar87 < grid_points[0] - 1; i_imopVar87++) {
            for (j_imopVar88 = 1; j_imopVar88 < grid_points[1] - 1; j_imopVar88++) {
                for (k_imopVar89 = 0; k_imopVar89 < grid_points[2]; k_imopVar89++) {
                    ...
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][0][2] = 0.0;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][0][3] = 1.0;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][0][4] = 0.0;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][1][0] = -(u[i_imopVar87][j_imopVar88][k_imopVar89][1] * u[i_imopVar87][j_imopVar88][k_imopVar89][3]) * tmp2;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][1][1] = u[i_imopVar87][j_imopVar88][k_imopVar89][3] * tmp1;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][1][2] = 0.0;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][1][3] = u[i_imopVar87][j_imopVar88][k_imopVar89][1] * tmp1;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][1][4] = 0.0;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][2][0] = -(u[i_imopVar87][j_imopVar88][k_imopVar89][2] * u[i_imopVar87][j_imopVar88][k_imopVar89][3]) * tmp2;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][2][1] = 0.0;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][2][2] = u[i_imopVar87][j_imopVar88][k_imopVar89][3] * tmp1;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][2][3] = u[i_imopVar87][j_imopVar88][k_imopVar89][2] * tmp1;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][2][4] = 0.0;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][3][0] = -(u[i_imopVar87][j_imopVar88][k_imopVar89][3] * u[i_imopVar87][j_imopVar88][k_imopVar89][3] * tmp2) + 0.50 * c2 * ((u[i_imopVar87][j_imopVar88][k_imopVar89][1] * u[i_imopVar87][j_imopVar88][k_imopVar89][1] + u[i_imopVar87][j_imopVar88][k_imopVar89][2] * u[i_imopVar87][j_imopVar88][k_imopVar89][2] + u[i_imopVar87][j_imopVar88][k_imopVar89][3] * u[i_imopVar87][j_imopVar88][k_imopVar89][3]) * tmp2);
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][3][1] = -c2 * u[i_imopVar87][j_imopVar88][k_imopVar89][1] * tmp1;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][3][2] = -c2 * u[i_imopVar87][j_imopVar88][k_imopVar89][2] * tmp1;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][3][3] = (2.0 - c2) * u[i_imopVar87][j_imopVar88][k_imopVar89][3] * tmp1;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][3][4] = c2;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][4][0] = (c2 * (u[i_imopVar87][j_imopVar88][k_imopVar89][1] * u[i_imopVar87][j_imopVar88][k_imopVar89][1] + u[i_imopVar87][j_imopVar88][k_imopVar89][2] * u[i_imopVar87][j_imopVar88][k_imopVar89][2] + u[i_imopVar87][j_imopVar88][k_imopVar89][3] * u[i_imopVar87][j_imopVar88][k_imopVar89][3]) * tmp2 - c1 * (u[i_imopVar87][j_imopVar88][k_imopVar89][4] * tmp1)) * (u[i_imopVar87][j_imopVar88][k_imopVar89][3] * tmp1);
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][4][1] = -c2 * (u[i_imopVar87][j_imopVar88][k_imopVar89][1] * u[i_imopVar87][j_imopVar88][k_imopVar89][3]) * tmp2;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][4][2] = -c2 * (u[i_imopVar87][j_imopVar88][k_imopVar89][2] * u[i_imopVar87][j_imopVar88][k_imopVar89][3]) * tmp2;
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][4][3] = c1 * (u[i_imopVar87][j_imopVar88][k_imopVar89][4] * tmp1) - 0.50 * c2 * ((u[i_imopVar87][j_imopVar88][k_imopVar89][1] * u[i_imopVar87][j_imopVar88][k_imopVar89][1] + u[i_imopVar87][j_imopVar88][k_imopVar89][2] * u[i_imopVar87][j_imopVar88][k_imopVar89][2] + 3.0 * u[i_imopVar87][j_imopVar88][k_imopVar89][3] * u[i_imopVar87][j_imopVar88][k_imopVar89][3]) * tmp2);
                    fjac[i_imopVar87][j_imopVar88][k_imopVar89][4][4] = c1 * u[i_imopVar87][j_imopVar88][k_imopVar89][3] * tmp1;
                    ...
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][2][0] = -c3c4 * tmp2 * u[i_imopVar87][j_imopVar88][k_imopVar89][2];
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][2][1] = 0.0;
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][2][2] = c3c4 * tmp1;
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][2][3] = 0.0;
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][2][4] = 0.0;
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][3][0] = -con43 * c3c4 * tmp2 * u[i_imopVar87][j_imopVar88][k_imopVar89][3];
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][3][1] = 0.0;
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][3][2] = 0.0;
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][3][3] = con43 * c3 * c4 * tmp1;
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][3][4] = 0.0;
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][4][0] = -(c3c4 - c1345) * tmp3 * (((u[i_imopVar87][j_imopVar88][k_imopVar89][1]) * (u[i_imopVar87][j_imopVar88][k_imopVar89][1]))) - (c3c4 - c1345) * tmp3 * (((u[i_imopVar87][j_imopVar88][k_imopVar89][2]) * (u[i_imopVar87][j_imopVar88][k_imopVar89][2]))) - (con43 * c3c4 - c1345) * tmp3 * (((u[i_imopVar87][j_imopVar88][k_imopVar89][3]) * (u[i_imopVar87][j_imopVar88][k_imopVar89][3]))) - c1345 * tmp2 * u[i_imopVar87][j_imopVar88][k_imopVar89][4];
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][4][1] = (c3c4 - c1345) * tmp2 * u[i_imopVar87][j_imopVar88][k_imopVar89][1];
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][4][2] = (c3c4 - c1345) * tmp2 * u[i_imopVar87][j_imopVar88][k_imopVar89][2];
                    njac[i_imopVar87][j_imopVar88][k_imopVar89][4][3] = (con43 * c3c4 - c1345) * tmp2 * u[i_imopVar87][j_imopVar88][k_imopVar89][3];
        ...
        for (i_imopVar87 = 1; i_imopVar87 < grid_points[0] - 1; i_imopVar87++) {
            for (j_imopVar88 = 1; j_imopVar88 < grid_points[1] - 1; j_imopVar88++) {
                for (k_imopVar89 = 1; k_imopVar89 < grid_points[2] - 1; k_imopVar89++) {
                    tmp1 = dt * tz1;
                    tmp2 = dt * tz2;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][0][0] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][0][0] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][0][0] - tmp1 * dz1;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][0][1] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][0][1] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][0][1];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][0][2] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][0][2] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][0][2];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][0][3] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][0][3] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][0][3];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][0][4] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][0][4] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][0][4];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][1][0] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][1][0] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][1][0];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][1][1] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][1][1] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][1][1] - tmp1 * dz2;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][1][2] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][1][2] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][1][2];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][1][3] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][1][3] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][1][3];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][1][4] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][1][4] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][1][4];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][2][0] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][2][0] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][2][0];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][2][1] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][2][1] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][2][1];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][2][2] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][2][2] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][2][2] - tmp1 * dz3;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][2][3] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][2][3] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][2][3];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][2][4] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][2][4] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][2][4];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][3][0] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][3][0] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][3][0];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][3][1] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][3][1] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][3][1];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][3][2] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][3][2] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][3][2];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][3][3] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][3][3] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][3][3] - tmp1 * dz4;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][3][4] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][3][4] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][3][4];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][4][0] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][4][0] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][4][0];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][4][1] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][4][1] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][4][1];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][4][2] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][4][2] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][4][2];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][4][3] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][4][3] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][4][3];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][0][4][4] = -tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][4][4] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 - 1][4][4] - tmp1 * dz5;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][1][0][0] = 1.0 + tmp1 * 2.0 * njac[i_imopVar87][j_imopVar88][k_imopVar89][0][0] + tmp1 * 2.0 * dz1;
                    ...
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][1][1][1] = 1.0 + tmp1 * 2.0 * njac[i_imopVar87][j_imopVar88][k_imopVar89][1][1] + tmp1 * 2.0 * dz2;
                    ...
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][1][2][2] = 1.0 + tmp1 * 2.0 * njac[i_imopVar87][j_imopVar88][k_imopVar89][2][2] + tmp1 * 2.0 * dz3;
                    ...
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][1][3][3] = 1.0 + tmp1 * 2.0 * njac[i_imopVar87][j_imopVar88][k_imopVar89][3][3] + tmp1 * 2.0 * dz4;
                    ...
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][1][4][4] = 1.0 + tmp1 * 2.0 * njac[i_imopVar87][j_imopVar88][k_imopVar89][4][4] + tmp1 * 2.0 * dz5;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][0][0] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][0][0] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][0][0] - tmp1 * dz1;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][0][1] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][0][1] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][0][1];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][0][2] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][0][2] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][0][2];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][0][3] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][0][3] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][0][3];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][0][4] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][0][4] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][0][4];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][1][0] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][1][0] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][1][0];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][1][1] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][1][1] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][1][1] - tmp1 * dz2;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][1][2] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][1][2] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][1][2];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][1][3] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][1][3] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][1][3];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][1][4] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][1][4] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][1][4];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][2][0] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][2][0] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][2][0];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][2][1] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][2][1] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][2][1];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][2][2] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][2][2] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][2][2] - tmp1 * dz3;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][2][3] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][2][3] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][2][3];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][2][4] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][2][4] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][2][4];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][3][0] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][3][0] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][3][0];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][3][1] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][3][1] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][3][1];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][3][2] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][3][2] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][3][2];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][3][3] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][3][3] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][3][3] - tmp1 * dz4;
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][3][4] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][3][4] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][3][4];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][4][0] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][4][0] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][4][0];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][4][1] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][4][1] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][4][1];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][4][2] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][4][2] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][4][2];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][4][3] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][4][3] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][4][3];
                    lhs[i_imopVar87][j_imopVar88][k_imopVar89][2][4][4] = tmp2 * fjac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][4][4] - tmp1 * njac[i_imopVar87][j_imopVar88][k_imopVar89 + 1][4][4] - tmp1 * dz5;
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (i_imopVar90 = 1; i_imopVar90 < grid_points[0] - 1; i_imopVar90++) {
            for (j_imopVar91 = 1; j_imopVar91 < grid_points[1] - 1; j_imopVar91++) {
                double *_imopVarPre414;
                double ( *_imopVarPre415 )[5];
                double ( *_imopVarPre416 )[5];
                _imopVarPre414 = rhs[i_imopVar90][j_imopVar91][0];
                _imopVarPre415 = lhs[i_imopVar90][j_imopVar91][0][2];
                _imopVarPre416 = lhs[i_imopVar90][j_imopVar91][0][1];
                binvcrhs(_imopVarPre416, _imopVarPre415, _imopVarPre414);
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        for (k_imopVar92 = 1; k_imopVar92 < ksize; k_imopVar92++) {
#pragma omp for nowait
            for (i_imopVar90 = 1; i_imopVar90 < grid_points[0] - 1; i_imopVar90++) {
                for (j_imopVar91 = 1; j_imopVar91 < grid_points[1] - 1; j_imopVar91++) {
                    ...
                    _imopVarPre420 = rhs[i_imopVar90][j_imopVar91][k_imopVar92];
                    _imopVarPre421 = rhs[i_imopVar90][j_imopVar91][k_imopVar92 - 1];
                    _imopVarPre422 = lhs[i_imopVar90][j_imopVar91][k_imopVar92][0];
                    ...
                    _imopVarPre426 = lhs[i_imopVar90][j_imopVar91][k_imopVar92][1];
                    _imopVarPre427 = lhs[i_imopVar90][j_imopVar91][k_imopVar92 - 1][2];
                    _imopVarPre428 = lhs[i_imopVar90][j_imopVar91][k_imopVar92][0];
                    ...
                    _imopVarPre432 = rhs[i_imopVar90][j_imopVar91][k_imopVar92];
                    _imopVarPre433 = lhs[i_imopVar90][j_imopVar91][k_imopVar92][2];
                    _imopVarPre434 = lhs[i_imopVar90][j_imopVar91][k_imopVar92][1];
...
#pragma omp for nowait
        for (i_imopVar90 = 1; i_imopVar90 < grid_points[0] - 1; i_imopVar90++) {
            for (j_imopVar91 = 1; j_imopVar91 < grid_points[1] - 1; j_imopVar91++) {
                ...
                _imopVarPre438 = rhs[i_imopVar90][j_imopVar91][ksize];
                _imopVarPre439 = rhs[i_imopVar90][j_imopVar91][ksize - 1];
                _imopVarPre440 = lhs[i_imopVar90][j_imopVar91][ksize][0];
                ...
                _imopVarPre444 = lhs[i_imopVar90][j_imopVar91][ksize][1];
                _imopVarPre445 = lhs[i_imopVar90][j_imopVar91][ksize - 1][2];
                _imopVarPre446 = lhs[i_imopVar90][j_imopVar91][ksize][0];
                matmul_sub(_imopVarPre446, _imopVarPre445, _imopVarPre444);
                double *_imopVarPre449;
                double ( *_imopVarPre450 )[5];
                _imopVarPre449 = rhs[i_imopVar90][j_imopVar91][ksize];
                _imopVarPre450 = lhs[i_imopVar90][j_imopVar91][ksize][1];
...
#pragma omp for nowait
        for (i_imopVar84 = 1; i_imopVar84 < grid_points[0] - 1; i_imopVar84++) {
            for (j_imopVar85 = 1; j_imopVar85 < grid_points[1] - 1; j_imopVar85++) {
                for (k_imopVar86 = grid_points[2] - 2; k_imopVar86 >= 0; k_imopVar86--) {
                    for (m_imopVar93 = 0; m_imopVar93 < 5; m_imopVar93++) {
                        for (n_imopVar94 = 0; n_imopVar94 < 5; n_imopVar94++) {
                            rhs[i_imopVar84][j_imopVar85][k_imopVar86][m_imopVar93] = rhs[i_imopVar84][j_imopVar85][k_imopVar86][m_imopVar93] - lhs[i_imopVar84][j_imopVar85][k_imopVar86][2][m_imopVar93][n_imopVar94] * rhs[i_imopVar84][j_imopVar85][k_imopVar86 + 1][n_imopVar94];
                        }
                    }
                }
            }
...
#pragma omp for nowait
        for (i_imopVar102 = 1; i_imopVar102 < grid_points[0] - 1; i_imopVar102++) {
            for (j_imopVar103 = 1; j_imopVar103 < grid_points[1] - 1; j_imopVar103++) {
                for (k_imopVar104 = 1; k_imopVar104 < grid_points[2] - 1; k_imopVar104++) {
                    for (m_imopVar105 = 0; m_imopVar105 < 5; m_imopVar105++) {
                        u[i_imopVar102][j_imopVar103][k_imopVar104][m_imopVar105] = u[i_imopVar102][j_imopVar103][k_imopVar104][m_imopVar105] + rhs[i_imopVar102][j_imopVar103][k_imopVar104][m_imopVar105];
                    }
                }
            }
        }
...
#pragma omp parallel
    ...
    int no_time_steps;
    char *class_imopVar112;
    int *verified_imopVar113;
    no_time_steps = niter;
    class_imopVar112 = _imopVarPre172;
    verified_imopVar113 = _imopVarPre171;
    double xcrref[5];
    double xceref[5];
    double xcrdif[5];
    double xcedif[5];
...
#pragma omp for nowait
    for (i = 0; i < grid_points[0]; i++) {
        for (j = 0; j < grid_points[1]; j++) {
            for (k = 0; k < grid_points[2]; k++) {
                for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                    rhs[i][j][k][m_imopVar111] = forcing[i][j][k][m_imopVar111];
                }
            }
        }
    }
...
#pragma omp for nowait
    for (j = 1; j < grid_points[1] - 1; j++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (5.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i + 1][j][k][m_imopVar111] + u[i + 2][j][k][m_imopVar111]);
            }
        }
    }
    i = 2;
#pragma omp for nowait
    for (j = 1; j < grid_points[1] - 1; j++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (-4.0 * u[i - 1][j][k][m_imopVar111] + 6.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i + 1][j][k][m_imopVar111] + u[i + 2][j][k][m_imopVar111]);
            }
        }
    }
#pragma omp for nowait
    for (i = 3; i < grid_points[0] - 3; i++) {
        for (j = 1; j < grid_points[1] - 1; j++) {
            for (k = 1; k < grid_points[2] - 1; k++) {
                for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                    rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (u[i - 2][j][k][m_imopVar111] - 4.0 * u[i - 1][j][k][m_imopVar111] + 6.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i + 1][j][k][m_imopVar111] + u[i + 2][j][k][m_imopVar111]);
                }
            }
        }
    }
...
#pragma omp for nowait
    for (j = 1; j < grid_points[1] - 1; j++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (u[i - 2][j][k][m_imopVar111] - 4.0 * u[i - 1][j][k][m_imopVar111] + 6.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i + 1][j][k][m_imopVar111]);
            }
        }
    }
    i = grid_points[0] - 2;
#pragma omp for nowait
    for (j = 1; j < grid_points[1] - 1; j++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (u[i - 2][j][k][m_imopVar111] - 4. * u[i - 1][j][k][m_imopVar111] + 5.0 * u[i][j][k][m_imopVar111]);
            }
        }
    }
#pragma omp for nowait
...
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (5.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i][j + 1][k][m_imopVar111] + u[i][j + 2][k][m_imopVar111]);
            }
        }
    }
    j = 2;
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (-4.0 * u[i][j - 1][k][m_imopVar111] + 6.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i][j + 1][k][m_imopVar111] + u[i][j + 2][k][m_imopVar111]);
            }
        }
    }
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (j = 3; j < grid_points[1] - 3; j++) {
            for (k = 1; k < grid_points[2] - 1; k++) {
                for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                    rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (u[i][j - 2][k][m_imopVar111] - 4.0 * u[i][j - 1][k][m_imopVar111] + 6.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i][j + 1][k][m_imopVar111] + u[i][j + 2][k][m_imopVar111]);
                }
            }
        }
    }
...
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (u[i][j - 2][k][m_imopVar111] - 4.0 * u[i][j - 1][k][m_imopVar111] + 6.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i][j + 1][k][m_imopVar111]);
            }
        }
    }
    j = grid_points[1] - 2;
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (u[i][j - 2][k][m_imopVar111] - 4. * u[i][j - 1][k][m_imopVar111] + 5. * u[i][j][k][m_imopVar111]);
            }
        }
    }
#pragma omp for nowait
...
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (j = 1; j < grid_points[1] - 1; j++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (5.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i][j][k + 1][m_imopVar111] + u[i][j][k + 2][m_imopVar111]);
            }
        }
    }
    k = 2;
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (j = 1; j < grid_points[1] - 1; j++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (-4.0 * u[i][j][k - 1][m_imopVar111] + 6.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i][j][k + 1][m_imopVar111] + u[i][j][k + 2][m_imopVar111]);
            }
        }
    }
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (j = 1; j < grid_points[1] - 1; j++) {
            for (k = 3; k < grid_points[2] - 3; k++) {
                for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                    rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (u[i][j][k - 2][m_imopVar111] - 4.0 * u[i][j][k - 1][m_imopVar111] + 6.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i][j][k + 1][m_imopVar111] + u[i][j][k + 2][m_imopVar111]);
                }
            }
        }
    }
...
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (j = 1; j < grid_points[1] - 1; j++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (u[i][j][k - 2][m_imopVar111] - 4.0 * u[i][j][k - 1][m_imopVar111] + 6.0 * u[i][j][k][m_imopVar111] - 4.0 * u[i][j][k + 1][m_imopVar111]);
            }
        }
    }
    k = grid_points[2] - 2;
#pragma omp for nowait
    for (i = 1; i < grid_points[0] - 1; i++) {
        for (j = 1; j < grid_points[1] - 1; j++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] - dssp * (u[i][j][k - 2][m_imopVar111] - 4.0 * u[i][j][k - 1][m_imopVar111] + 5.0 * u[i][j][k][m_imopVar111]);
            }
        }
    }
#pragma omp for nowait
    for (j = 1; j < grid_points[1] - 1; j++) {
        for (k = 1; k < grid_points[2] - 1; k++) {
            for (m_imopVar111 = 0; m_imopVar111 < 5; m_imopVar111++) {
                for (i = 1; i < grid_points[0] - 1; i++) {
                    rhs[i][j][k][m_imopVar111] = rhs[i][j][k][m_imopVar111] * dt;
                }
            }
        }
    }
    ...
    *verified_imopVar113 = 1;
    ...
    if (*class_imopVar112 != 'U') {
        char _imopVarPre298;
        _imopVarPre298 = *class_imopVar112;
    ...
    for (i_imopVar84 = 1; i_imopVar84 < grid_points[0] - 1; i_imopVar84++) {
        for (j_imopVar85 = 1; j_imopVar85 < grid_points[1] - 1; j_imopVar85++) {
            for (k_imopVar86 = grid_points[2] - 2; k_imopVar86 >= 0; k_imopVar86--) {
                for (m = 0; m < 5; m++) {
                    for (n = 0; n < 5; n++) {
                        rhs[i_imopVar84][j_imopVar85][k_imopVar86][m] = rhs[i_imopVar84][j_imopVar85][k_imopVar86][m] - lhs[i_imopVar84][j_imopVar85][k_imopVar86][2][m][n] * rhs[i_imopVar84][j_imopVar85][k_imopVar86 + 1][n];
                    }
                }
            }
        }
