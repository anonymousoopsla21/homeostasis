...
#pragma omp parallel
    {
        ...
        int j_imopVar85;
        int k_imopVar86;
        for (j_imopVar85 = 1; j_imopVar85 <= grid_points[1] - 2; j_imopVar85++) {
            for (k_imopVar86 = 1; k_imopVar86 <= grid_points[2] - 2; k_imopVar86++) {
#pragma omp for nowait
                for (i_imopVar84 = 0; i_imopVar84 <= grid_points[0] - 1; i_imopVar84++) {
                    ru1 = c3c4 * rho_i[i_imopVar84][j_imopVar85][k_imopVar86];
                    cv[i_imopVar84] = us[i_imopVar84][j_imopVar85][k_imopVar86];
                    int _imopVarPre715;
                    ...
                    rhon[i_imopVar84] = _imopVarPre728;
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for nowait
                for (i_imopVar84 = 1; i_imopVar84 <= grid_points[0] - 2; i_imopVar84++) {
                    lhs[0][i_imopVar84][j_imopVar85][k_imopVar86] = 0.0;
                    lhs[1][i_imopVar84][j_imopVar85][k_imopVar86] = -dttx2 * cv[i_imopVar84 - 1] - dttx1 * rhon[i_imopVar84 - 1];
                    lhs[2][i_imopVar84][j_imopVar85][k_imopVar86] = 1.0 + c2dttx1 * rhon[i_imopVar84];
                    lhs[3][i_imopVar84][j_imopVar85][k_imopVar86] = dttx2 * cv[i_imopVar84 + 1] - dttx1 * rhon[i_imopVar84 + 1];
                    lhs[4][i_imopVar84][j_imopVar85][k_imopVar86] = 0.0;
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
            }
...
#pragma omp for nowait
        for (j_imopVar85 = 1; j_imopVar85 <= grid_points[1] - 2; j_imopVar85++) {
            for (k_imopVar86 = 1; k_imopVar86 <= grid_points[2] - 2; k_imopVar86++) {
                lhs[2][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[2][i_imopVar84][j_imopVar85][k_imopVar86] + comz5;
                lhs[3][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[3][i_imopVar84][j_imopVar85][k_imopVar86] - comz4;
                lhs[4][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[4][i_imopVar84][j_imopVar85][k_imopVar86] + comz1;
                lhs[1][i_imopVar84 + 1][j_imopVar85][k_imopVar86] = lhs[1][i_imopVar84 + 1][j_imopVar85][k_imopVar86] - comz4;
                lhs[2][i_imopVar84 + 1][j_imopVar85][k_imopVar86] = lhs[2][i_imopVar84 + 1][j_imopVar85][k_imopVar86] + comz6;
                lhs[3][i_imopVar84 + 1][j_imopVar85][k_imopVar86] = lhs[3][i_imopVar84 + 1][j_imopVar85][k_imopVar86] - comz4;
                lhs[4][i_imopVar84 + 1][j_imopVar85][k_imopVar86] = lhs[4][i_imopVar84 + 1][j_imopVar85][k_imopVar86] + comz1;
            }
        }
#pragma omp for nowait
        for (i_imopVar84 = 3; i_imopVar84 <= grid_points[0] - 4; i_imopVar84++) {
            for (j_imopVar85 = 1; j_imopVar85 <= grid_points[1] - 2; j_imopVar85++) {
                for (k_imopVar86 = 1; k_imopVar86 <= grid_points[2] - 2; k_imopVar86++) {
                    lhs[0][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[0][i_imopVar84][j_imopVar85][k_imopVar86] + comz1;
                    lhs[1][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[1][i_imopVar84][j_imopVar85][k_imopVar86] - comz4;
                    lhs[2][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[2][i_imopVar84][j_imopVar85][k_imopVar86] + comz6;
                    lhs[3][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[3][i_imopVar84][j_imopVar85][k_imopVar86] - comz4;
                    lhs[4][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[4][i_imopVar84][j_imopVar85][k_imopVar86] + comz1;
                }
            }
        }
        i_imopVar84 = grid_points[0] - 3;
#pragma omp for nowait
        for (j_imopVar85 = 1; j_imopVar85 <= grid_points[1] - 2; j_imopVar85++) {
            for (k_imopVar86 = 1; k_imopVar86 <= grid_points[2] - 2; k_imopVar86++) {
                lhs[0][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[0][i_imopVar84][j_imopVar85][k_imopVar86] + comz1;
                ...
                lhs[2][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[2][i_imopVar84][j_imopVar85][k_imopVar86] + comz6;
                lhs[3][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[3][i_imopVar84][j_imopVar85][k_imopVar86] - comz4;
                lhs[0][i_imopVar84 + 1][j_imopVar85][k_imopVar86] = lhs[0][i_imopVar84 + 1][j_imopVar85][k_imopVar86] + comz1;
                lhs[1][i_imopVar84 + 1][j_imopVar85][k_imopVar86] = lhs[1][i_imopVar84 + 1][j_imopVar85][k_imopVar86] - comz4;
                lhs[2][i_imopVar84 + 1][j_imopVar85][k_imopVar86] = lhs[2][i_imopVar84 + 1][j_imopVar85][k_imopVar86] + comz5;
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for nowait
        for (i_imopVar84 = 1; i_imopVar84 <= grid_points[0] - 2; i_imopVar84++) {
            for (j_imopVar85 = 1; j_imopVar85 <= grid_points[1] - 2; j_imopVar85++) {
                for (k_imopVar86 = 1; k_imopVar86 <= grid_points[2] - 2; k_imopVar86++) {
                    lhs[0 + 5][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[0][i_imopVar84][j_imopVar85][k_imopVar86];
                    lhs[1 + 5][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[1][i_imopVar84][j_imopVar85][k_imopVar86] - dttx2 * speed[i_imopVar84 - 1][j_imopVar85][k_imopVar86];
                    lhs[2 + 5][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[2][i_imopVar84][j_imopVar85][k_imopVar86];
                    lhs[3 + 5][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[3][i_imopVar84][j_imopVar85][k_imopVar86] + dttx2 * speed[i_imopVar84 + 1][j_imopVar85][k_imopVar86];
                    lhs[4 + 5][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[4][i_imopVar84][j_imopVar85][k_imopVar86];
                    lhs[0 + 10][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[0][i_imopVar84][j_imopVar85][k_imopVar86];
                    lhs[1 + 10][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[1][i_imopVar84][j_imopVar85][k_imopVar86] + dttx2 * speed[i_imopVar84 - 1][j_imopVar85][k_imopVar86];
                    lhs[2 + 10][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[2][i_imopVar84][j_imopVar85][k_imopVar86];
                    lhs[3 + 10][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[3][i_imopVar84][j_imopVar85][k_imopVar86] - dttx2 * speed[i_imopVar84 + 1][j_imopVar85][k_imopVar86];
                    lhs[4 + 10][i_imopVar84][j_imopVar85][k_imopVar86] = lhs[4][i_imopVar84][j_imopVar85][k_imopVar86];
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp barrier
        ...
        double t2;
#pragma omp for nowait
        for (i_imopVar87 = 1; i_imopVar87 <= grid_points[0] - 2; i_imopVar87++) {
            for (j_imopVar88 = 1; j_imopVar88 <= grid_points[1] - 2; j_imopVar88++) {
                for (k_imopVar89 = 1; k_imopVar89 <= grid_points[2] - 2; k_imopVar89++) {
                    r1 = rhs[0][i_imopVar87][j_imopVar88][k_imopVar89];
                    r2 = rhs[1][i_imopVar87][j_imopVar88][k_imopVar89];
                    r3 = rhs[2][i_imopVar87][j_imopVar88][k_imopVar89];
                    r4 = rhs[3][i_imopVar87][j_imopVar88][k_imopVar89];
                    r5 = rhs[4][i_imopVar87][j_imopVar88][k_imopVar89];
                    t1 = bt * r3;
                    t2 = 0.5 * (r4 + r5);
                    rhs[0][i_imopVar87][j_imopVar88][k_imopVar89] = -r2;
                    rhs[1][i_imopVar87][j_imopVar88][k_imopVar89] = r1;
                    rhs[2][i_imopVar87][j_imopVar88][k_imopVar89] = bt * (r4 - r5);
                    rhs[3][i_imopVar87][j_imopVar88][k_imopVar89] = -t1 + t2;
                    rhs[4][i_imopVar87][j_imopVar88][k_imopVar89] = t1 + t2;
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp barrier
        ...
        int j2;
        int m_imopVar94;
        double fac1_imopVar95;
        double fac2_imopVar96;
        double ru1_imopVar97;
        int i_imopVar81;
        int j_imopVar82;
        int k_imopVar83;
        for (i_imopVar81 = 1; i_imopVar81 <= grid_points[0] - 2; i_imopVar81++) {
            for (k_imopVar83 = 1; k_imopVar83 <= grid_points[2] - 2; k_imopVar83++) {
#pragma omp for nowait
                for (j_imopVar82 = 0; j_imopVar82 <= grid_points[1] - 1; j_imopVar82++) {
                    ru1_imopVar97 = c3c4 * rho_i[i_imopVar81][j_imopVar82][k_imopVar83];
                    cv[j_imopVar82] = vs[i_imopVar81][j_imopVar82][k_imopVar83];
                    int _imopVarPre1343;
                    ...
                    _imopVarPre1343 = ((dymax + ru1_imopVar97) > dy1);
                    if (_imopVarPre1343) {
                        _imopVarPre1344 = (dymax + ru1_imopVar97);
                    } else {
                        _imopVarPre1344 = dy1;
                    }
                    _imopVarPre1345 = ((dy5 + c1c5 * ru1_imopVar97) > _imopVarPre1344);
                    if (_imopVarPre1345) {
                        _imopVarPre1346 = (dy5 + c1c5 * ru1_imopVar97);
                    } else {
                        _imopVarPre1353 = ((dymax + ru1_imopVar97) > dy1);
                        if (_imopVarPre1353) {
                            _imopVarPre1354 = (dymax + ru1_imopVar97);
                        } else {
                            _imopVarPre1354 = dy1;
                        }
                        _imopVarPre1346 = _imopVarPre1354;
                    }
                    _imopVarPre1355 = ((dy3 + con43 * ru1_imopVar97) > _imopVarPre1346);
                    if (_imopVarPre1355) {
                        _imopVarPre1356 = (dy3 + con43 * ru1_imopVar97);
                    } else {
                        _imopVarPre1449 = ((dymax + ru1_imopVar97) > dy1);
                        if (_imopVarPre1449) {
                            _imopVarPre1450 = (dymax + ru1_imopVar97);
                        } else {
                            _imopVarPre1450 = dy1;
                        }
                        _imopVarPre1451 = ((dy5 + c1c5 * ru1_imopVar97) > _imopVarPre1450);
                        if (_imopVarPre1451) {
                            _imopVarPre1452 = (dy5 + c1c5 * ru1_imopVar97);
                        } else {
                            _imopVarPre1459 = ((dymax + ru1_imopVar97) > dy1);
                            if (_imopVarPre1459) {
                                _imopVarPre1460 = (dymax + ru1_imopVar97);
                            } else {
                                _imopVarPre1460 = dy1;
                            }
                    ...
                    rhoq[j_imopVar82] = _imopVarPre1356;
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for nowait
                for (j_imopVar82 = 1; j_imopVar82 <= grid_points[1] - 2; j_imopVar82++) {
                    lhs[0][i_imopVar81][j_imopVar82][k_imopVar83] = 0.0;
                    lhs[1][i_imopVar81][j_imopVar82][k_imopVar83] = -dtty2 * cv[j_imopVar82 - 1] - dtty1 * rhoq[j_imopVar82 - 1];
                    lhs[2][i_imopVar81][j_imopVar82][k_imopVar83] = 1.0 + c2dtty1 * rhoq[j_imopVar82];
                    lhs[3][i_imopVar81][j_imopVar82][k_imopVar83] = dtty2 * cv[j_imopVar82 + 1] - dtty1 * rhoq[j_imopVar82 + 1];
                    lhs[4][i_imopVar81][j_imopVar82][k_imopVar83] = 0.0;
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
            }
...
#pragma omp for nowait
        for (i_imopVar81 = 1; i_imopVar81 <= grid_points[0] - 2; i_imopVar81++) {
            for (k_imopVar83 = 1; k_imopVar83 <= grid_points[2] - 2; k_imopVar83++) {
                lhs[2][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[2][i_imopVar81][j_imopVar82][k_imopVar83] + comz5;
                lhs[3][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[3][i_imopVar81][j_imopVar82][k_imopVar83] - comz4;
                lhs[4][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[4][i_imopVar81][j_imopVar82][k_imopVar83] + comz1;
                lhs[1][i_imopVar81][j_imopVar82 + 1][k_imopVar83] = lhs[1][i_imopVar81][j_imopVar82 + 1][k_imopVar83] - comz4;
                lhs[2][i_imopVar81][j_imopVar82 + 1][k_imopVar83] = lhs[2][i_imopVar81][j_imopVar82 + 1][k_imopVar83] + comz6;
                lhs[3][i_imopVar81][j_imopVar82 + 1][k_imopVar83] = lhs[3][i_imopVar81][j_imopVar82 + 1][k_imopVar83] - comz4;
                lhs[4][i_imopVar81][j_imopVar82 + 1][k_imopVar83] = lhs[4][i_imopVar81][j_imopVar82 + 1][k_imopVar83] + comz1;
            }
        }
#pragma omp for nowait
        for (i_imopVar81 = 1; i_imopVar81 <= grid_points[0] - 2; i_imopVar81++) {
            for (j_imopVar82 = 3; j_imopVar82 <= grid_points[1] - 4; j_imopVar82++) {
                for (k_imopVar83 = 1; k_imopVar83 <= grid_points[2] - 2; k_imopVar83++) {
                    lhs[0][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[0][i_imopVar81][j_imopVar82][k_imopVar83] + comz1;
                    lhs[1][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[1][i_imopVar81][j_imopVar82][k_imopVar83] - comz4;
                    lhs[2][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[2][i_imopVar81][j_imopVar82][k_imopVar83] + comz6;
                    lhs[3][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[3][i_imopVar81][j_imopVar82][k_imopVar83] - comz4;
                    lhs[4][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[4][i_imopVar81][j_imopVar82][k_imopVar83] + comz1;
                }
            }
        }
        j_imopVar82 = grid_points[1] - 3;
#pragma omp for nowait
        for (i_imopVar81 = 1; i_imopVar81 <= grid_points[0] - 2; i_imopVar81++) {
            for (k_imopVar83 = 1; k_imopVar83 <= grid_points[2] - 2; k_imopVar83++) {
                lhs[0][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[0][i_imopVar81][j_imopVar82][k_imopVar83] + comz1;
                ...
                lhs[2][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[2][i_imopVar81][j_imopVar82][k_imopVar83] + comz6;
                lhs[3][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[3][i_imopVar81][j_imopVar82][k_imopVar83] - comz4;
                lhs[0][i_imopVar81][j_imopVar82 + 1][k_imopVar83] = lhs[0][i_imopVar81][j_imopVar82 + 1][k_imopVar83] + comz1;
                lhs[1][i_imopVar81][j_imopVar82 + 1][k_imopVar83] = lhs[1][i_imopVar81][j_imopVar82 + 1][k_imopVar83] - comz4;
                lhs[2][i_imopVar81][j_imopVar82 + 1][k_imopVar83] = lhs[2][i_imopVar81][j_imopVar82 + 1][k_imopVar83] + comz5;
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for nowait
        for (i_imopVar81 = 1; i_imopVar81 <= grid_points[0] - 2; i_imopVar81++) {
            for (j_imopVar82 = 1; j_imopVar82 <= grid_points[1] - 2; j_imopVar82++) {
                for (k_imopVar83 = 1; k_imopVar83 <= grid_points[2] - 2; k_imopVar83++) {
                    lhs[0 + 5][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[0][i_imopVar81][j_imopVar82][k_imopVar83];
                    lhs[1 + 5][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[1][i_imopVar81][j_imopVar82][k_imopVar83] - dtty2 * speed[i_imopVar81][j_imopVar82 - 1][k_imopVar83];
                    lhs[2 + 5][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[2][i_imopVar81][j_imopVar82][k_imopVar83];
                    lhs[3 + 5][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[3][i_imopVar81][j_imopVar82][k_imopVar83] + dtty2 * speed[i_imopVar81][j_imopVar82 + 1][k_imopVar83];
                    lhs[4 + 5][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[4][i_imopVar81][j_imopVar82][k_imopVar83];
                    lhs[0 + 10][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[0][i_imopVar81][j_imopVar82][k_imopVar83];
                    lhs[1 + 10][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[1][i_imopVar81][j_imopVar82][k_imopVar83] + dtty2 * speed[i_imopVar81][j_imopVar82 - 1][k_imopVar83];
                    lhs[2 + 10][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[2][i_imopVar81][j_imopVar82][k_imopVar83];
                    lhs[3 + 10][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[3][i_imopVar81][j_imopVar82][k_imopVar83] - dtty2 * speed[i_imopVar81][j_imopVar82 + 1][k_imopVar83];
                    lhs[4 + 10][i_imopVar81][j_imopVar82][k_imopVar83] = lhs[4][i_imopVar81][j_imopVar82][k_imopVar83];
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        n_imopVar93 = 0;
        for (j_imopVar91 = 0; j_imopVar91 <= grid_points[1] - 3; j_imopVar91++) {
            j1 = j_imopVar91 + 1;
            j2 = j_imopVar91 + 2;
#pragma omp for nowait
            for (i_imopVar90 = 1; i_imopVar90 <= grid_points[0] - 2; i_imopVar90++) {
                for (k_imopVar92 = 1; k_imopVar92 <= grid_points[2] - 2; k_imopVar92++) {
                    fac1_imopVar95 = 1. / lhs[n_imopVar93 + 2][i_imopVar90][j_imopVar91][k_imopVar92];
                    lhs[n_imopVar93 + 3][i_imopVar90][j_imopVar91][k_imopVar92] = fac1_imopVar95 * lhs[n_imopVar93 + 3][i_imopVar90][j_imopVar91][k_imopVar92];
                    lhs[n_imopVar93 + 4][i_imopVar90][j_imopVar91][k_imopVar92] = fac1_imopVar95 * lhs[n_imopVar93 + 4][i_imopVar90][j_imopVar91][k_imopVar92];
                    for (m_imopVar94 = 0; m_imopVar94 < 3; m_imopVar94++) {
                        rhs[m_imopVar94][i_imopVar90][j_imopVar91][k_imopVar92] = fac1_imopVar95 * rhs[m_imopVar94][i_imopVar90][j_imopVar91][k_imopVar92];
                    }
                    lhs[n_imopVar93 + 2][i_imopVar90][j1][k_imopVar92] = lhs[n_imopVar93 + 2][i_imopVar90][j1][k_imopVar92] - lhs[n_imopVar93 + 1][i_imopVar90][j1][k_imopVar92] * lhs[n_imopVar93 + 3][i_imopVar90][j_imopVar91][k_imopVar92];
                    lhs[n_imopVar93 + 3][i_imopVar90][j1][k_imopVar92] = lhs[n_imopVar93 + 3][i_imopVar90][j1][k_imopVar92] - lhs[n_imopVar93 + 1][i_imopVar90][j1][k_imopVar92] * lhs[n_imopVar93 + 4][i_imopVar90][j_imopVar91][k_imopVar92];
                    for (m_imopVar94 = 0; m_imopVar94 < 3; m_imopVar94++) {
                        rhs[m_imopVar94][i_imopVar90][j1][k_imopVar92] = rhs[m_imopVar94][i_imopVar90][j1][k_imopVar92] - lhs[n_imopVar93 + 1][i_imopVar90][j1][k_imopVar92] * rhs[m_imopVar94][i_imopVar90][j_imopVar91][k_imopVar92];
                    }
                    lhs[n_imopVar93 + 1][i_imopVar90][j2][k_imopVar92] = lhs[n_imopVar93 + 1][i_imopVar90][j2][k_imopVar92] - lhs[n_imopVar93 + 0][i_imopVar90][j2][k_imopVar92] * lhs[n_imopVar93 + 3][i_imopVar90][j_imopVar91][k_imopVar92];
                    lhs[n_imopVar93 + 2][i_imopVar90][j2][k_imopVar92] = lhs[n_imopVar93 + 2][i_imopVar90][j2][k_imopVar92] - lhs[n_imopVar93 + 0][i_imopVar90][j2][k_imopVar92] * lhs[n_imopVar93 + 4][i_imopVar90][j_imopVar91][k_imopVar92];
                    for (m_imopVar94 = 0; m_imopVar94 < 3; m_imopVar94++) {
                        rhs[m_imopVar94][i_imopVar90][j2][k_imopVar92] = rhs[m_imopVar94][i_imopVar90][j2][k_imopVar92] - lhs[n_imopVar93 + 0][i_imopVar90][j2][k_imopVar92] * rhs[m_imopVar94][i_imopVar90][j_imopVar91][k_imopVar92];
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (i_imopVar90 = 1; i_imopVar90 <= grid_points[0] - 2; i_imopVar90++) {
            for (k_imopVar92 = 1; k_imopVar92 <= grid_points[2] - 2; k_imopVar92++) {
                ...
                fac2_imopVar96 = 1. / lhs[n_imopVar93 + 2][i_imopVar90][j1][k_imopVar92];
                for (m_imopVar94 = 0; m_imopVar94 < 3; m_imopVar94++) {
                    rhs[m_imopVar94][i_imopVar90][j1][k_imopVar92] = fac2_imopVar96 * rhs[m_imopVar94][i_imopVar90][j1][k_imopVar92];
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        for (m_imopVar94 = 3; m_imopVar94 < 5; m_imopVar94++) {
            n_imopVar93 = (m_imopVar94 - 3 + 1) * 5;
            for (j_imopVar91 = 0; j_imopVar91 <= grid_points[1] - 3; j_imopVar91++) {
                j1 = j_imopVar91 + 1;
                j2 = j_imopVar91 + 2;
#pragma omp for nowait
...
#pragma omp for nowait
            for (i_imopVar90 = 1; i_imopVar90 <= grid_points[0] - 2; i_imopVar90++) {
                for (k_imopVar92 = 1; k_imopVar92 <= grid_points[2] - 2; k_imopVar92++) {
                    rhs[m_imopVar94][i_imopVar90][j_imopVar91][k_imopVar92] = rhs[m_imopVar94][i_imopVar90][j_imopVar91][k_imopVar92] - lhs[n_imopVar93 + 3][i_imopVar90][j_imopVar91][k_imopVar92] * rhs[m_imopVar94][i_imopVar90][j1][k_imopVar92];
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp barrier
        ...
        n_imopVar93 = 0;
        for (m_imopVar94 = 0; m_imopVar94 < 3; m_imopVar94++) {
            for (j_imopVar91 = grid_points[1] - 3; j_imopVar91 >= 0; j_imopVar91--) {
                j1 = j_imopVar91 + 1;
                j2 = j_imopVar91 + 2;
#pragma omp for nowait
                for (i_imopVar90 = 1; i_imopVar90 <= grid_points[0] - 2; i_imopVar90++) {
                    for (k_imopVar92 = 1; k_imopVar92 <= grid_points[2] - 2; k_imopVar92++) {
                        rhs[m_imopVar94][i_imopVar90][j_imopVar91][k_imopVar92] = rhs[m_imopVar94][i_imopVar90][j_imopVar91][k_imopVar92] - lhs[n_imopVar93 + 3][i_imopVar90][j_imopVar91][k_imopVar92] * rhs[m_imopVar94][i_imopVar90][j1][k_imopVar92] - lhs[n_imopVar93 + 4][i_imopVar90][j_imopVar91][k_imopVar92] * rhs[m_imopVar94][i_imopVar90][j2][k_imopVar92];
                    }
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp barrier
        ...
        double r1_imopVar98;
        double r2_imopVar99;
        double r3_imopVar100;
        double r4_imopVar101;
        double r5_imopVar102;
        double t1_imopVar103;
        double t2_imopVar104;
#pragma omp for nowait
        for (i_imopVar78 = 1; i_imopVar78 <= grid_points[0] - 2; i_imopVar78++) {
            for (j_imopVar79 = 1; j_imopVar79 <= grid_points[1] - 2; j_imopVar79++) {
                for (k_imopVar80 = 1; k_imopVar80 <= grid_points[2] - 2; k_imopVar80++) {
                    r1_imopVar98 = rhs[0][i_imopVar78][j_imopVar79][k_imopVar80];
                    r2_imopVar99 = rhs[1][i_imopVar78][j_imopVar79][k_imopVar80];
                    r3_imopVar100 = rhs[2][i_imopVar78][j_imopVar79][k_imopVar80];
                    r4_imopVar101 = rhs[3][i_imopVar78][j_imopVar79][k_imopVar80];
                    r5_imopVar102 = rhs[4][i_imopVar78][j_imopVar79][k_imopVar80];
                    t1_imopVar103 = bt * r1_imopVar98;
                    t2_imopVar104 = 0.5 * (r4_imopVar101 + r5_imopVar102);
                    rhs[0][i_imopVar78][j_imopVar79][k_imopVar80] = bt * (r4_imopVar101 - r5_imopVar102);
                    rhs[1][i_imopVar78][j_imopVar79][k_imopVar80] = -r3_imopVar100;
                    rhs[2][i_imopVar78][j_imopVar79][k_imopVar80] = r2_imopVar99;
                    rhs[3][i_imopVar78][j_imopVar79][k_imopVar80] = -t1_imopVar103 + t2_imopVar104;
                    rhs[4][i_imopVar78][j_imopVar79][k_imopVar80] = t1_imopVar103 + t2_imopVar104;
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp parallel
    {
        ...
        int j_imopVar1;
        int k_imopVar2;
        for (i_imopVar0 = 1; i_imopVar0 <= grid_points[0] - 2; i_imopVar0++) {
            for (j_imopVar1 = 1; j_imopVar1 <= grid_points[1] - 2; j_imopVar1++) {
#pragma omp for nowait
                for (k_imopVar2 = 0; k_imopVar2 <= grid_points[2] - 1; k_imopVar2++) {
                    ru1 = c3c4 * rho_i[i_imopVar0][j_imopVar1][k_imopVar2];
                    cv[k_imopVar2] = ws[i_imopVar0][j_imopVar1][k_imopVar2];
                    int _imopVarPre1971;
                    ...
                    rhos[k_imopVar2] = _imopVarPre1984;
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for nowait
                for (k_imopVar2 = 1; k_imopVar2 <= grid_points[2] - 2; k_imopVar2++) {
                    lhs[0][i_imopVar0][j_imopVar1][k_imopVar2] = 0.0;
                    lhs[1][i_imopVar0][j_imopVar1][k_imopVar2] = -dttz2 * cv[k_imopVar2 - 1] - dttz1 * rhos[k_imopVar2 - 1];
                    lhs[2][i_imopVar0][j_imopVar1][k_imopVar2] = 1.0 + c2dttz1 * rhos[k_imopVar2];
                    lhs[3][i_imopVar0][j_imopVar1][k_imopVar2] = dttz2 * cv[k_imopVar2 + 1] - dttz1 * rhos[k_imopVar2 + 1];
                    lhs[4][i_imopVar0][j_imopVar1][k_imopVar2] = 0.0;
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
            }
...
#pragma omp for nowait
        for (i_imopVar0 = 1; i_imopVar0 <= grid_points[0] - 2; i_imopVar0++) {
            for (j_imopVar1 = 1; j_imopVar1 <= grid_points[1] - 2; j_imopVar1++) {
                lhs[2][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[2][i_imopVar0][j_imopVar1][k_imopVar2] + comz5;
                lhs[3][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[3][i_imopVar0][j_imopVar1][k_imopVar2] - comz4;
                lhs[4][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[4][i_imopVar0][j_imopVar1][k_imopVar2] + comz1;
                lhs[1][i_imopVar0][j_imopVar1][k_imopVar2 + 1] = lhs[1][i_imopVar0][j_imopVar1][k_imopVar2 + 1] - comz4;
                lhs[2][i_imopVar0][j_imopVar1][k_imopVar2 + 1] = lhs[2][i_imopVar0][j_imopVar1][k_imopVar2 + 1] + comz6;
                lhs[3][i_imopVar0][j_imopVar1][k_imopVar2 + 1] = lhs[3][i_imopVar0][j_imopVar1][k_imopVar2 + 1] - comz4;
                lhs[4][i_imopVar0][j_imopVar1][k_imopVar2 + 1] = lhs[4][i_imopVar0][j_imopVar1][k_imopVar2 + 1] + comz1;
            }
        }
#pragma omp for nowait
        for (i_imopVar0 = 1; i_imopVar0 <= grid_points[0] - 2; i_imopVar0++) {
            for (j_imopVar1 = 1; j_imopVar1 <= grid_points[1] - 2; j_imopVar1++) {
                for (k_imopVar2 = 3; k_imopVar2 <= grid_points[2] - 4; k_imopVar2++) {
                    lhs[0][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[0][i_imopVar0][j_imopVar1][k_imopVar2] + comz1;
                    lhs[1][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[1][i_imopVar0][j_imopVar1][k_imopVar2] - comz4;
                    lhs[2][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[2][i_imopVar0][j_imopVar1][k_imopVar2] + comz6;
                    lhs[3][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[3][i_imopVar0][j_imopVar1][k_imopVar2] - comz4;
                    lhs[4][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[4][i_imopVar0][j_imopVar1][k_imopVar2] + comz1;
                }
            }
        }
        k_imopVar2 = grid_points[2] - 3;
#pragma omp for nowait
        for (i_imopVar0 = 1; i_imopVar0 <= grid_points[0] - 2; i_imopVar0++) {
            for (j_imopVar1 = 1; j_imopVar1 <= grid_points[1] - 2; j_imopVar1++) {
                lhs[0][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[0][i_imopVar0][j_imopVar1][k_imopVar2] + comz1;
                ...
                lhs[2][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[2][i_imopVar0][j_imopVar1][k_imopVar2] + comz6;
                lhs[3][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[3][i_imopVar0][j_imopVar1][k_imopVar2] - comz4;
                lhs[0][i_imopVar0][j_imopVar1][k_imopVar2 + 1] = lhs[0][i_imopVar0][j_imopVar1][k_imopVar2 + 1] + comz1;
                lhs[1][i_imopVar0][j_imopVar1][k_imopVar2 + 1] = lhs[1][i_imopVar0][j_imopVar1][k_imopVar2 + 1] - comz4;
                lhs[2][i_imopVar0][j_imopVar1][k_imopVar2 + 1] = lhs[2][i_imopVar0][j_imopVar1][k_imopVar2 + 1] + comz5;
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
#pragma omp for nowait
        for (i_imopVar0 = 1; i_imopVar0 <= grid_points[0] - 2; i_imopVar0++) {
            for (j_imopVar1 = 1; j_imopVar1 <= grid_points[1] - 2; j_imopVar1++) {
                for (k_imopVar2 = 1; k_imopVar2 <= grid_points[2] - 2; k_imopVar2++) {
                    lhs[0 + 5][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[0][i_imopVar0][j_imopVar1][k_imopVar2];
                    lhs[1 + 5][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[1][i_imopVar0][j_imopVar1][k_imopVar2] - dttz2 * speed[i_imopVar0][j_imopVar1][k_imopVar2 - 1];
                    lhs[2 + 5][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[2][i_imopVar0][j_imopVar1][k_imopVar2];
                    lhs[3 + 5][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[3][i_imopVar0][j_imopVar1][k_imopVar2] + dttz2 * speed[i_imopVar0][j_imopVar1][k_imopVar2 + 1];
                    lhs[4 + 5][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[4][i_imopVar0][j_imopVar1][k_imopVar2];
                    lhs[0 + 10][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[0][i_imopVar0][j_imopVar1][k_imopVar2];
                    lhs[1 + 10][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[1][i_imopVar0][j_imopVar1][k_imopVar2] + dttz2 * speed[i_imopVar0][j_imopVar1][k_imopVar2 - 1];
                    lhs[2 + 10][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[2][i_imopVar0][j_imopVar1][k_imopVar2];
                    lhs[3 + 10][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[3][i_imopVar0][j_imopVar1][k_imopVar2] - dttz2 * speed[i_imopVar0][j_imopVar1][k_imopVar2 + 1];
                    lhs[4 + 10][i_imopVar0][j_imopVar1][k_imopVar2] = lhs[4][i_imopVar0][j_imopVar1][k_imopVar2];
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp parallel
    ...
    int no_time_steps;
    char *class_imopVar106;
    int *verified_imopVar107;
    no_time_steps = niter;
    class_imopVar106 = _imopVarPre172;
    verified_imopVar107 = _imopVarPre171;
    double xcrref[5];
    double xceref[5];
    double xcrdif[5];
    double xcedif[5];
...
#pragma omp for nowait
            for (i = 0; i <= grid_points[0] - 1; i++) {
                for (j = 0; j <= grid_points[1] - 1; j++) {
                    for (k = 0; k <= grid_points[2] - 1; k++) {
                        rhs[m_imopVar105][i][j][k] = forcing[m_imopVar105][i][j][k];
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
            for (j = 1; j <= grid_points[1] - 2; j++) {
                for (k = 1; k <= grid_points[2] - 2; k++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (5.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i + 1][j][k] + u[m_imopVar105][i + 2][j][k]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (j = 1; j <= grid_points[1] - 2; j++) {
                for (k = 1; k <= grid_points[2] - 2; k++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (-4.0 * u[m_imopVar105][i - 1][j][k] + 6.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i + 1][j][k] + u[m_imopVar105][i + 2][j][k]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (i = 3 * 1; i <= grid_points[0] - 3 * 1 - 1; i++) {
                for (j = 1; j <= grid_points[1] - 2; j++) {
                    for (k = 1; k <= grid_points[2] - 2; k++) {
                        rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (u[m_imopVar105][i - 2][j][k] - 4.0 * u[m_imopVar105][i - 1][j][k] + 6.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i + 1][j][k] + u[m_imopVar105][i + 2][j][k]);
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
            for (j = 1; j <= grid_points[1] - 2; j++) {
                for (k = 1; k <= grid_points[2] - 2; k++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (u[m_imopVar105][i - 2][j][k] - 4.0 * u[m_imopVar105][i - 1][j][k] + 6.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i + 1][j][k]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (j = 1; j <= grid_points[1] - 2; j++) {
                for (k = 1; k <= grid_points[2] - 2; k++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (u[m_imopVar105][i - 2][j][k] - 4.0 * u[m_imopVar105][i - 1][j][k] + 5.0 * u[m_imopVar105][i][j][k]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (k = 1; k <= grid_points[2] - 2; k++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (5.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i][j + 1][k] + u[m_imopVar105][i][j + 2][k]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (k = 1; k <= grid_points[2] - 2; k++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (-4.0 * u[m_imopVar105][i][j - 1][k] + 6.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i][j + 1][k] + u[m_imopVar105][i][j + 2][k]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (j = 3 * 1; j <= grid_points[1] - 3 * 1 - 1; j++) {
                    for (k = 1; k <= grid_points[2] - 2; k++) {
                        rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (u[m_imopVar105][i][j - 2][k] - 4.0 * u[m_imopVar105][i][j - 1][k] + 6.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i][j + 1][k] + u[m_imopVar105][i][j + 2][k]);
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (k = 1; k <= grid_points[2] - 2; k++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (u[m_imopVar105][i][j - 2][k] - 4.0 * u[m_imopVar105][i][j - 1][k] + 6.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i][j + 1][k]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (k = 1; k <= grid_points[2] - 2; k++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (u[m_imopVar105][i][j - 2][k] - 4.0 * u[m_imopVar105][i][j - 1][k] + 5.0 * u[m_imopVar105][i][j][k]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (j = 1; j <= grid_points[1] - 2; j++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (5.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i][j][k + 1] + u[m_imopVar105][i][j][k + 2]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (j = 1; j <= grid_points[1] - 2; j++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (-4.0 * u[m_imopVar105][i][j][k - 1] + 6.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i][j][k + 1] + u[m_imopVar105][i][j][k + 2]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (j = 1; j <= grid_points[1] - 2; j++) {
                    for (k = 3 * 1; k <= grid_points[2] - 3 * 1 - 1; k++) {
                        rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (u[m_imopVar105][i][j][k - 2] - 4.0 * u[m_imopVar105][i][j][k - 1] + 6.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i][j][k + 1] + u[m_imopVar105][i][j][k + 2]);
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (j = 1; j <= grid_points[1] - 2; j++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (u[m_imopVar105][i][j][k - 2] - 4.0 * u[m_imopVar105][i][j][k - 1] + 6.0 * u[m_imopVar105][i][j][k] - 4.0 * u[m_imopVar105][i][j][k + 1]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (j = 1; j <= grid_points[1] - 2; j++) {
                    rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] - dssp * (u[m_imopVar105][i][j][k - 2] - 4.0 * u[m_imopVar105][i][j][k - 1] + 5.0 * u[m_imopVar105][i][j][k]);
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp for nowait
            for (i = 1; i <= grid_points[0] - 2; i++) {
                for (j = 1; j <= grid_points[1] - 2; j++) {
                    for (k = 1; k <= grid_points[2] - 2; k++) {
                        rhs[m_imopVar105][i][j][k] = rhs[m_imopVar105][i][j][k] * dt;
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
    ...
    *verified_imopVar107 = 1;
    ...
    if (*class_imopVar106 != 'U') {
        char _imopVarPre2190;
        _imopVarPre2190 = *class_imopVar106;
...
#pragma omp for nowait
            for (j_imopVar82 = 0; j_imopVar82 <= grid_points[1] - 1; j_imopVar82++) {
                ru1 = c3c4 * rho_i[i_imopVar81][j_imopVar82][k_imopVar83];
                cv[j_imopVar82] = vs[i_imopVar81][j_imopVar82][k_imopVar83];
                int _imopVarPre1343;
                double _imopVarPre1344;
                int _imopVarPre1345;
...
#pragma omp for nowait
    for (i_imopVar78 = 1; i_imopVar78 <= grid_points[0] - 2; i_imopVar78++) {
        for (j_imopVar79 = 1; j_imopVar79 <= grid_points[1] - 2; j_imopVar79++) {
            for (k_imopVar80 = 1; k_imopVar80 <= grid_points[2] - 2; k_imopVar80++) {
                r1 = rhs[0][i_imopVar78][j_imopVar79][k_imopVar80];
                r2 = rhs[1][i_imopVar78][j_imopVar79][k_imopVar80];
                r3 = rhs[2][i_imopVar78][j_imopVar79][k_imopVar80];
                r4 = rhs[3][i_imopVar78][j_imopVar79][k_imopVar80];
                r5 = rhs[4][i_imopVar78][j_imopVar79][k_imopVar80];
                t1 = bt * r1;
                t2 = 0.5 * (r4 + r5);
                rhs[0][i_imopVar78][j_imopVar79][k_imopVar80] = bt * (r4 - r5);
                rhs[1][i_imopVar78][j_imopVar79][k_imopVar80] = -r3;
                rhs[2][i_imopVar78][j_imopVar79][k_imopVar80] = r2;
                rhs[3][i_imopVar78][j_imopVar79][k_imopVar80] = -t1 + t2;
                rhs[4][i_imopVar78][j_imopVar79][k_imopVar80] = t1 + t2;
            }
        }
    }
}
