...
#pragma omp parallel
    {
        ...
        double u51km1;
#pragma omp for nowait
        for (i_imopVar92 = 0; i_imopVar92 <= nx - 1; i_imopVar92++) {
            for (j_imopVar93 = 0; j_imopVar93 <= ny - 1; j_imopVar93++) {
                for (k_imopVar94 = 0; k_imopVar94 <= nz - 1; k_imopVar94++) {
                    for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                        rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] = -frct[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95];
                    }
                }
            }
        }
...
#pragma omp barrier
        ...
        L2 = nx - 1;
#pragma omp for nowait
        for (i_imopVar92 = L1; i_imopVar92 <= L2; i_imopVar92++) {
            for (j_imopVar93 = jst; j_imopVar93 <= jend; j_imopVar93++) {
                for (k_imopVar94 = 1; k_imopVar94 <= nz - 2; k_imopVar94++) {
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][0] = u[i_imopVar92][j_imopVar93][k_imopVar94][1];
                    u21 = u[i_imopVar92][j_imopVar93][k_imopVar94][1] / u[i_imopVar92][j_imopVar93][k_imopVar94][0];
                    q = 0.50 * (u[i_imopVar92][j_imopVar93][k_imopVar94][1] * u[i_imopVar92][j_imopVar93][k_imopVar94][1] + u[i_imopVar92][j_imopVar93][k_imopVar94][2] * u[i_imopVar92][j_imopVar93][k_imopVar94][2] + u[i_imopVar92][j_imopVar93][k_imopVar94][3] * u[i_imopVar92][j_imopVar93][k_imopVar94][3]) / u[i_imopVar92][j_imopVar93][k_imopVar94][0];
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][1] = u[i_imopVar92][j_imopVar93][k_imopVar94][1] * u21 + 0.40e+00 * (u[i_imopVar92][j_imopVar93][k_imopVar94][4] - q);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][2] = u[i_imopVar92][j_imopVar93][k_imopVar94][2] * u21;
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][3] = u[i_imopVar92][j_imopVar93][k_imopVar94][3] * u21;
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][4] = (1.40e+00 * u[i_imopVar92][j_imopVar93][k_imopVar94][4] - 0.40e+00 * q) * u21;
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (j_imopVar93 = jst; j_imopVar93 <= jend; j_imopVar93++) {
            for (k_imopVar94 = 1; k_imopVar94 <= nz - 2; k_imopVar94++) {
                for (i_imopVar92 = ist; i_imopVar92 <= iend; i_imopVar92++) {
                    for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                        rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] - tx2 * (flux[i_imopVar92 + 1][j_imopVar93][k_imopVar94][m_imopVar95] - flux[i_imopVar92 - 1][j_imopVar93][k_imopVar94][m_imopVar95]);
                    }
                }
                L2 = nx - 1;
                for (i_imopVar92 = ist; i_imopVar92 <= L2; i_imopVar92++) {
                    tmp_imopVar96 = 1.0 / u[i_imopVar92][j_imopVar93][k_imopVar94][0];
                    u21i = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][1];
                    u31i = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][2];
                    u41i = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][3];
                    u51i = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][4];
                    tmp_imopVar96 = 1.0 / u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][0];
                    u21im1 = tmp_imopVar96 * u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][1];
                    u31im1 = tmp_imopVar96 * u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][2];
                    u41im1 = tmp_imopVar96 * u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][3];
                    u51im1 = tmp_imopVar96 * u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][4];
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][1] = (4.0 / 3.0) * tx3 * (u21i - u21im1);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][2] = tx3 * (u31i - u31im1);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][3] = tx3 * (u41i - u41im1);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][4] = 0.50 * (1.0 - 1.40e+00 * 1.40e+00) * tx3 * (((u21i * u21i) + (u31i * u31i) + (u41i * u41i)) - ((u21im1 * u21im1) + (u31im1 * u31im1) + (u41im1 * u41im1))) + (1.0 / 6.0) * tx3 * ((u21i * u21i) - (u21im1 * u21im1)) + 1.40e+00 * 1.40e+00 * tx3 * (u51i - u51im1);
                }
                for (i_imopVar92 = ist; i_imopVar92 <= iend; i_imopVar92++) {
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][0] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][0] + dx1 * tx1 * (u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][0] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][0] + u[i_imopVar92 + 1][j_imopVar93][k_imopVar94][0]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][1] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][1] + tx3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92 + 1][j_imopVar93][k_imopVar94][1] - flux[i_imopVar92][j_imopVar93][k_imopVar94][1]) + dx2 * tx1 * (u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][1] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][1] + u[i_imopVar92 + 1][j_imopVar93][k_imopVar94][1]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][2] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][2] + tx3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92 + 1][j_imopVar93][k_imopVar94][2] - flux[i_imopVar92][j_imopVar93][k_imopVar94][2]) + dx3 * tx1 * (u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][2] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][2] + u[i_imopVar92 + 1][j_imopVar93][k_imopVar94][2]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][3] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][3] + tx3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92 + 1][j_imopVar93][k_imopVar94][3] - flux[i_imopVar92][j_imopVar93][k_imopVar94][3]) + dx4 * tx1 * (u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][3] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][3] + u[i_imopVar92 + 1][j_imopVar93][k_imopVar94][3]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][4] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][4] + tx3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92 + 1][j_imopVar93][k_imopVar94][4] - flux[i_imopVar92][j_imopVar93][k_imopVar94][4]) + dx5 * tx1 * (u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][4] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][4] + u[i_imopVar92 + 1][j_imopVar93][k_imopVar94][4]);
                }
                for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                    rsd[1][j_imopVar93][k_imopVar94][m_imopVar95] = rsd[1][j_imopVar93][k_imopVar94][m_imopVar95] - dssp * (+5.0 * u[1][j_imopVar93][k_imopVar94][m_imopVar95] - 4.0 * u[2][j_imopVar93][k_imopVar94][m_imopVar95] + u[3][j_imopVar93][k_imopVar94][m_imopVar95]);
                    rsd[2][j_imopVar93][k_imopVar94][m_imopVar95] = rsd[2][j_imopVar93][k_imopVar94][m_imopVar95] - dssp * (-4.0 * u[1][j_imopVar93][k_imopVar94][m_imopVar95] + 6.0 * u[2][j_imopVar93][k_imopVar94][m_imopVar95] - 4.0 * u[3][j_imopVar93][k_imopVar94][m_imopVar95] + u[4][j_imopVar93][k_imopVar94][m_imopVar95]);
                }
                ist1 = 3;
                iend1 = nx - 4;
                for (i_imopVar92 = ist1; i_imopVar92 <= iend1; i_imopVar92++) {
                    for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                        rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] - dssp * (u[i_imopVar92 - 2][j_imopVar93][k_imopVar94][m_imopVar95] - 4.0 * u[i_imopVar92 - 1][j_imopVar93][k_imopVar94][m_imopVar95] + 6.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] - 4.0 * u[i_imopVar92 + 1][j_imopVar93][k_imopVar94][m_imopVar95] + u[i_imopVar92 + 2][j_imopVar93][k_imopVar94][m_imopVar95]);
                    }
                }
                for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                    rsd[nx - 3][j_imopVar93][k_imopVar94][m_imopVar95] = rsd[nx - 3][j_imopVar93][k_imopVar94][m_imopVar95] - dssp * (u[nx - 5][j_imopVar93][k_imopVar94][m_imopVar95] - 4.0 * u[nx - 4][j_imopVar93][k_imopVar94][m_imopVar95] + 6.0 * u[nx - 3][j_imopVar93][k_imopVar94][m_imopVar95] - 4.0 * u[nx - 2][j_imopVar93][k_imopVar94][m_imopVar95]);
                    rsd[nx - 2][j_imopVar93][k_imopVar94][m_imopVar95] = rsd[nx - 2][j_imopVar93][k_imopVar94][m_imopVar95] - dssp * (u[nx - 4][j_imopVar93][k_imopVar94][m_imopVar95] - 4.0 * u[nx - 3][j_imopVar93][k_imopVar94][m_imopVar95] + 5.0 * u[nx - 2][j_imopVar93][k_imopVar94][m_imopVar95]);
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (i_imopVar92 = ist; i_imopVar92 <= iend; i_imopVar92++) {
            for (j_imopVar93 = L1; j_imopVar93 <= L2; j_imopVar93++) {
                for (k_imopVar94 = 1; k_imopVar94 <= nz - 2; k_imopVar94++) {
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][0] = u[i_imopVar92][j_imopVar93][k_imopVar94][2];
                    u31 = u[i_imopVar92][j_imopVar93][k_imopVar94][2] / u[i_imopVar92][j_imopVar93][k_imopVar94][0];
                    q = 0.50 * (u[i_imopVar92][j_imopVar93][k_imopVar94][1] * u[i_imopVar92][j_imopVar93][k_imopVar94][1] + u[i_imopVar92][j_imopVar93][k_imopVar94][2] * u[i_imopVar92][j_imopVar93][k_imopVar94][2] + u[i_imopVar92][j_imopVar93][k_imopVar94][3] * u[i_imopVar92][j_imopVar93][k_imopVar94][3]) / u[i_imopVar92][j_imopVar93][k_imopVar94][0];
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][1] = u[i_imopVar92][j_imopVar93][k_imopVar94][1] * u31;
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][2] = u[i_imopVar92][j_imopVar93][k_imopVar94][2] * u31 + 0.40e+00 * (u[i_imopVar92][j_imopVar93][k_imopVar94][4] - q);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][3] = u[i_imopVar92][j_imopVar93][k_imopVar94][3] * u31;
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][4] = (1.40e+00 * u[i_imopVar92][j_imopVar93][k_imopVar94][4] - 0.40e+00 * q) * u31;
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (i_imopVar92 = ist; i_imopVar92 <= iend; i_imopVar92++) {
            for (k_imopVar94 = 1; k_imopVar94 <= nz - 2; k_imopVar94++) {
                for (j_imopVar93 = jst; j_imopVar93 <= jend; j_imopVar93++) {
                    for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                        rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] - ty2 * (flux[i_imopVar92][j_imopVar93 + 1][k_imopVar94][m_imopVar95] - flux[i_imopVar92][j_imopVar93 - 1][k_imopVar94][m_imopVar95]);
                    }
                }
                L2 = ny - 1;
                for (j_imopVar93 = jst; j_imopVar93 <= L2; j_imopVar93++) {
                    tmp_imopVar96 = 1.0 / u[i_imopVar92][j_imopVar93][k_imopVar94][0];
                    u21j = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][1];
                    u31j = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][2];
                    u41j = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][3];
                    u51j = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][4];
                    tmp_imopVar96 = 1.0 / u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][0];
                    u21jm1 = tmp_imopVar96 * u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][1];
                    u31jm1 = tmp_imopVar96 * u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][2];
                    u41jm1 = tmp_imopVar96 * u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][3];
                    u51jm1 = tmp_imopVar96 * u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][4];
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][1] = ty3 * (u21j - u21jm1);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][2] = (4.0 / 3.0) * ty3 * (u31j - u31jm1);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][3] = ty3 * (u41j - u41jm1);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][4] = 0.50 * (1.0 - 1.40e+00 * 1.40e+00) * ty3 * (((u21j * u21j) + (u31j * u31j) + (u41j * u41j)) - ((u21jm1 * u21jm1) + (u31jm1 * u31jm1) + (u41jm1 * u41jm1))) + (1.0 / 6.0) * ty3 * ((u31j * u31j) - (u31jm1 * u31jm1)) + 1.40e+00 * 1.40e+00 * ty3 * (u51j - u51jm1);
                }
                for (j_imopVar93 = jst; j_imopVar93 <= jend; j_imopVar93++) {
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][0] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][0] + dy1 * ty1 * (u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][0] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][0] + u[i_imopVar92][j_imopVar93 + 1][k_imopVar94][0]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][1] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][1] + ty3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92][j_imopVar93 + 1][k_imopVar94][1] - flux[i_imopVar92][j_imopVar93][k_imopVar94][1]) + dy2 * ty1 * (u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][1] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][1] + u[i_imopVar92][j_imopVar93 + 1][k_imopVar94][1]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][2] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][2] + ty3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92][j_imopVar93 + 1][k_imopVar94][2] - flux[i_imopVar92][j_imopVar93][k_imopVar94][2]) + dy3 * ty1 * (u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][2] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][2] + u[i_imopVar92][j_imopVar93 + 1][k_imopVar94][2]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][3] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][3] + ty3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92][j_imopVar93 + 1][k_imopVar94][3] - flux[i_imopVar92][j_imopVar93][k_imopVar94][3]) + dy4 * ty1 * (u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][3] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][3] + u[i_imopVar92][j_imopVar93 + 1][k_imopVar94][3]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][4] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][4] + ty3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92][j_imopVar93 + 1][k_imopVar94][4] - flux[i_imopVar92][j_imopVar93][k_imopVar94][4]) + dy5 * ty1 * (u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][4] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][4] + u[i_imopVar92][j_imopVar93 + 1][k_imopVar94][4]);
                }
                for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                    rsd[i_imopVar92][1][k_imopVar94][m_imopVar95] = rsd[i_imopVar92][1][k_imopVar94][m_imopVar95] - dssp * (+5.0 * u[i_imopVar92][1][k_imopVar94][m_imopVar95] - 4.0 * u[i_imopVar92][2][k_imopVar94][m_imopVar95] + u[i_imopVar92][3][k_imopVar94][m_imopVar95]);
                    rsd[i_imopVar92][2][k_imopVar94][m_imopVar95] = rsd[i_imopVar92][2][k_imopVar94][m_imopVar95] - dssp * (-4.0 * u[i_imopVar92][1][k_imopVar94][m_imopVar95] + 6.0 * u[i_imopVar92][2][k_imopVar94][m_imopVar95] - 4.0 * u[i_imopVar92][3][k_imopVar94][m_imopVar95] + u[i_imopVar92][4][k_imopVar94][m_imopVar95]);
                }
                jst1 = 3;
                jend1 = ny - 4;
                for (j_imopVar93 = jst1; j_imopVar93 <= jend1; j_imopVar93++) {
                    for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                        rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] - dssp * (u[i_imopVar92][j_imopVar93 - 2][k_imopVar94][m_imopVar95] - 4.0 * u[i_imopVar92][j_imopVar93 - 1][k_imopVar94][m_imopVar95] + 6.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] - 4.0 * u[i_imopVar92][j_imopVar93 + 1][k_imopVar94][m_imopVar95] + u[i_imopVar92][j_imopVar93 + 2][k_imopVar94][m_imopVar95]);
                    }
                }
                for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                    rsd[i_imopVar92][ny - 3][k_imopVar94][m_imopVar95] = rsd[i_imopVar92][ny - 3][k_imopVar94][m_imopVar95] - dssp * (u[i_imopVar92][ny - 5][k_imopVar94][m_imopVar95] - 4.0 * u[i_imopVar92][ny - 4][k_imopVar94][m_imopVar95] + 6.0 * u[i_imopVar92][ny - 3][k_imopVar94][m_imopVar95] - 4.0 * u[i_imopVar92][ny - 2][k_imopVar94][m_imopVar95]);
                    rsd[i_imopVar92][ny - 2][k_imopVar94][m_imopVar95] = rsd[i_imopVar92][ny - 2][k_imopVar94][m_imopVar95] - dssp * (u[i_imopVar92][ny - 4][k_imopVar94][m_imopVar95] - 4.0 * u[i_imopVar92][ny - 3][k_imopVar94][m_imopVar95] + 5.0 * u[i_imopVar92][ny - 2][k_imopVar94][m_imopVar95]);
                }
            }
        }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
        for (i_imopVar92 = ist; i_imopVar92 <= iend; i_imopVar92++) {
            for (j_imopVar93 = jst; j_imopVar93 <= jend; j_imopVar93++) {
                for (k_imopVar94 = 0; k_imopVar94 <= nz - 1; k_imopVar94++) {
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][0] = u[i_imopVar92][j_imopVar93][k_imopVar94][3];
                    u41 = u[i_imopVar92][j_imopVar93][k_imopVar94][3] / u[i_imopVar92][j_imopVar93][k_imopVar94][0];
                    q = 0.50 * (u[i_imopVar92][j_imopVar93][k_imopVar94][1] * u[i_imopVar92][j_imopVar93][k_imopVar94][1] + u[i_imopVar92][j_imopVar93][k_imopVar94][2] * u[i_imopVar92][j_imopVar93][k_imopVar94][2] + u[i_imopVar92][j_imopVar93][k_imopVar94][3] * u[i_imopVar92][j_imopVar93][k_imopVar94][3]) / u[i_imopVar92][j_imopVar93][k_imopVar94][0];
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][1] = u[i_imopVar92][j_imopVar93][k_imopVar94][1] * u41;
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][2] = u[i_imopVar92][j_imopVar93][k_imopVar94][2] * u41;
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][3] = u[i_imopVar92][j_imopVar93][k_imopVar94][3] * u41 + 0.40e+00 * (u[i_imopVar92][j_imopVar93][k_imopVar94][4] - q);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][4] = (1.40e+00 * u[i_imopVar92][j_imopVar93][k_imopVar94][4] - 0.40e+00 * q) * u41;
                }
                for (k_imopVar94 = 1; k_imopVar94 <= nz - 2; k_imopVar94++) {
                    for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                        rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] - tz2 * (flux[i_imopVar92][j_imopVar93][k_imopVar94 + 1][m_imopVar95] - flux[i_imopVar92][j_imopVar93][k_imopVar94 - 1][m_imopVar95]);
                    }
                }
                for (k_imopVar94 = 1; k_imopVar94 <= nz - 1; k_imopVar94++) {
                    tmp_imopVar96 = 1.0 / u[i_imopVar92][j_imopVar93][k_imopVar94][0];
                    u21k = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][1];
                    u31k = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][2];
                    u41k = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][3];
                    u51k = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94][4];
                    tmp_imopVar96 = 1.0 / u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][0];
                    u21km1 = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][1];
                    u31km1 = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][2];
                    u41km1 = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][3];
                    u51km1 = tmp_imopVar96 * u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][4];
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][1] = tz3 * (u21k - u21km1);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][2] = tz3 * (u31k - u31km1);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][3] = (4.0 / 3.0) * tz3 * (u41k - u41km1);
                    flux[i_imopVar92][j_imopVar93][k_imopVar94][4] = 0.50 * (1.0 - 1.40e+00 * 1.40e+00) * tz3 * (((u21k * u21k) + (u31k * u31k) + (u41k * u41k)) - ((u21km1 * u21km1) + (u31km1 * u31km1) + (u41km1 * u41km1))) + (1.0 / 6.0) * tz3 * ((u41k * u41k) - (u41km1 * u41km1)) + 1.40e+00 * 1.40e+00 * tz3 * (u51k - u51km1);
                }
                for (k_imopVar94 = 1; k_imopVar94 <= nz - 2; k_imopVar94++) {
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][0] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][0] + dz1 * tz1 * (u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][0] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][0] + u[i_imopVar92][j_imopVar93][k_imopVar94 + 1][0]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][1] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][1] + tz3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92][j_imopVar93][k_imopVar94 + 1][1] - flux[i_imopVar92][j_imopVar93][k_imopVar94][1]) + dz2 * tz1 * (u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][1] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][1] + u[i_imopVar92][j_imopVar93][k_imopVar94 + 1][1]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][2] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][2] + tz3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92][j_imopVar93][k_imopVar94 + 1][2] - flux[i_imopVar92][j_imopVar93][k_imopVar94][2]) + dz3 * tz1 * (u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][2] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][2] + u[i_imopVar92][j_imopVar93][k_imopVar94 + 1][2]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][3] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][3] + tz3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92][j_imopVar93][k_imopVar94 + 1][3] - flux[i_imopVar92][j_imopVar93][k_imopVar94][3]) + dz4 * tz1 * (u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][3] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][3] + u[i_imopVar92][j_imopVar93][k_imopVar94 + 1][3]);
                    rsd[i_imopVar92][j_imopVar93][k_imopVar94][4] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][4] + tz3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar92][j_imopVar93][k_imopVar94 + 1][4] - flux[i_imopVar92][j_imopVar93][k_imopVar94][4]) + dz5 * tz1 * (u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][4] - 2.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][4] + u[i_imopVar92][j_imopVar93][k_imopVar94 + 1][4]);
                }
                for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                    rsd[i_imopVar92][j_imopVar93][1][m_imopVar95] = rsd[i_imopVar92][j_imopVar93][1][m_imopVar95] - dssp * (+5.0 * u[i_imopVar92][j_imopVar93][1][m_imopVar95] - 4.0 * u[i_imopVar92][j_imopVar93][2][m_imopVar95] + u[i_imopVar92][j_imopVar93][3][m_imopVar95]);
                    rsd[i_imopVar92][j_imopVar93][2][m_imopVar95] = rsd[i_imopVar92][j_imopVar93][2][m_imopVar95] - dssp * (-4.0 * u[i_imopVar92][j_imopVar93][1][m_imopVar95] + 6.0 * u[i_imopVar92][j_imopVar93][2][m_imopVar95] - 4.0 * u[i_imopVar92][j_imopVar93][3][m_imopVar95] + u[i_imopVar92][j_imopVar93][4][m_imopVar95]);
                }
                for (k_imopVar94 = 3; k_imopVar94 <= nz - 4; k_imopVar94++) {
                    for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                        rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] = rsd[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] - dssp * (u[i_imopVar92][j_imopVar93][k_imopVar94 - 2][m_imopVar95] - 4.0 * u[i_imopVar92][j_imopVar93][k_imopVar94 - 1][m_imopVar95] + 6.0 * u[i_imopVar92][j_imopVar93][k_imopVar94][m_imopVar95] - 4.0 * u[i_imopVar92][j_imopVar93][k_imopVar94 + 1][m_imopVar95] + u[i_imopVar92][j_imopVar93][k_imopVar94 + 2][m_imopVar95]);
                    }
                }
                for (m_imopVar95 = 0; m_imopVar95 < 5; m_imopVar95++) {
                    rsd[i_imopVar92][j_imopVar93][nz - 3][m_imopVar95] = rsd[i_imopVar92][j_imopVar93][nz - 3][m_imopVar95] - dssp * (u[i_imopVar92][j_imopVar93][nz - 5][m_imopVar95] - 4.0 * u[i_imopVar92][j_imopVar93][nz - 4][m_imopVar95] + 6.0 * u[i_imopVar92][j_imopVar93][nz - 3][m_imopVar95] - 4.0 * u[i_imopVar92][j_imopVar93][nz - 2][m_imopVar95]);
                    rsd[i_imopVar92][j_imopVar93][nz - 2][m_imopVar95] = rsd[i_imopVar92][j_imopVar93][nz - 2][m_imopVar95] - dssp * (u[i_imopVar92][j_imopVar93][nz - 4][m_imopVar95] - 4.0 * u[i_imopVar92][j_imopVar93][nz - 3][m_imopVar95] + 5.0 * u[i_imopVar92][j_imopVar93][nz - 2][m_imopVar95]);
                }
            }
        }
    }
...
#pragma omp for nowait
                for (i_imopVar79 = ist; i_imopVar79 <= iend; i_imopVar79++) {
                    for (j_imopVar80 = jst; j_imopVar80 <= jend; j_imopVar80++) {
                        for (k_imopVar81 = 1; k_imopVar81 <= nz0 - 2; k_imopVar81++) {
                            sum0 = sum0 + v[i_imopVar79][j_imopVar80][k_imopVar81][0] * v[i_imopVar79][j_imopVar80][k_imopVar81][0];
                            sum1 = sum1 + v[i_imopVar79][j_imopVar80][k_imopVar81][1] * v[i_imopVar79][j_imopVar80][k_imopVar81][1];
                            sum2 = sum2 + v[i_imopVar79][j_imopVar80][k_imopVar81][2] * v[i_imopVar79][j_imopVar80][k_imopVar81][2];
                            sum3 = sum3 + v[i_imopVar79][j_imopVar80][k_imopVar81][3] * v[i_imopVar79][j_imopVar80][k_imopVar81][3];
                            sum4 = sum4 + v[i_imopVar79][j_imopVar80][k_imopVar81][4] * v[i_imopVar79][j_imopVar80][k_imopVar81][4];
                        }
                    }
                }
// #pragma omp dummyFlush CRITICAL_START
...
#pragma omp single nowait
                {
                    for (m_imopVar82 = 0; m_imopVar82 < 5; m_imopVar82++) {
                        double _imopVarPre154;
                        double _imopVarPre155;
                        _imopVarPre154 = sum[m_imopVar82] / ((nx0 - 2) * (ny0 - 2) * (nz0 - 2));
                        _imopVarPre155 = sqrt(_imopVarPre154);
                        sum[m_imopVar82] = _imopVarPre155;
                    }
                }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
...
#pragma omp barrier
            ...
            double u51km1;
#pragma omp for nowait
            for (i_imopVar83 = 0; i_imopVar83 <= nx - 1; i_imopVar83++) {
                for (j_imopVar84 = 0; j_imopVar84 <= ny - 1; j_imopVar84++) {
                    for (k_imopVar85 = 0; k_imopVar85 <= nz - 1; k_imopVar85++) {
                        for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                            rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] = -frct[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86];
                        }
                    }
                }
            }
...
#pragma omp barrier
            ...
            L2 = nx - 1;
#pragma omp for nowait
            for (i_imopVar83 = L1; i_imopVar83 <= L2; i_imopVar83++) {
                for (j_imopVar84 = jst; j_imopVar84 <= jend; j_imopVar84++) {
                    for (k_imopVar85 = 1; k_imopVar85 <= nz - 2; k_imopVar85++) {
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][0] = u[i_imopVar83][j_imopVar84][k_imopVar85][1];
                        u21 = u[i_imopVar83][j_imopVar84][k_imopVar85][1] / u[i_imopVar83][j_imopVar84][k_imopVar85][0];
                        q = 0.50 * (u[i_imopVar83][j_imopVar84][k_imopVar85][1] * u[i_imopVar83][j_imopVar84][k_imopVar85][1] + u[i_imopVar83][j_imopVar84][k_imopVar85][2] * u[i_imopVar83][j_imopVar84][k_imopVar85][2] + u[i_imopVar83][j_imopVar84][k_imopVar85][3] * u[i_imopVar83][j_imopVar84][k_imopVar85][3]) / u[i_imopVar83][j_imopVar84][k_imopVar85][0];
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][1] = u[i_imopVar83][j_imopVar84][k_imopVar85][1] * u21 + 0.40e+00 * (u[i_imopVar83][j_imopVar84][k_imopVar85][4] - q);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][2] = u[i_imopVar83][j_imopVar84][k_imopVar85][2] * u21;
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][3] = u[i_imopVar83][j_imopVar84][k_imopVar85][3] * u21;
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][4] = (1.40e+00 * u[i_imopVar83][j_imopVar84][k_imopVar85][4] - 0.40e+00 * q) * u21;
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
            for (j_imopVar84 = jst; j_imopVar84 <= jend; j_imopVar84++) {
                for (k_imopVar85 = 1; k_imopVar85 <= nz - 2; k_imopVar85++) {
                    for (i_imopVar83 = ist; i_imopVar83 <= iend; i_imopVar83++) {
                        for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                            rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] - tx2 * (flux[i_imopVar83 + 1][j_imopVar84][k_imopVar85][m_imopVar86] - flux[i_imopVar83 - 1][j_imopVar84][k_imopVar85][m_imopVar86]);
                        }
                    }
                    L2 = nx - 1;
                    for (i_imopVar83 = ist; i_imopVar83 <= L2; i_imopVar83++) {
                        tmp_imopVar87 = 1.0 / u[i_imopVar83][j_imopVar84][k_imopVar85][0];
                        u21i = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][1];
                        u31i = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][2];
                        u41i = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][3];
                        u51i = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][4];
                        tmp_imopVar87 = 1.0 / u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][0];
                        u21im1 = tmp_imopVar87 * u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][1];
                        u31im1 = tmp_imopVar87 * u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][2];
                        u41im1 = tmp_imopVar87 * u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][3];
                        u51im1 = tmp_imopVar87 * u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][4];
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][1] = (4.0 / 3.0) * tx3 * (u21i - u21im1);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][2] = tx3 * (u31i - u31im1);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][3] = tx3 * (u41i - u41im1);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][4] = 0.50 * (1.0 - 1.40e+00 * 1.40e+00) * tx3 * (((u21i * u21i) + (u31i * u31i) + (u41i * u41i)) - ((u21im1 * u21im1) + (u31im1 * u31im1) + (u41im1 * u41im1))) + (1.0 / 6.0) * tx3 * ((u21i * u21i) - (u21im1 * u21im1)) + 1.40e+00 * 1.40e+00 * tx3 * (u51i - u51im1);
                    }
                    for (i_imopVar83 = ist; i_imopVar83 <= iend; i_imopVar83++) {
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][0] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][0] + dx1 * tx1 * (u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][0] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][0] + u[i_imopVar83 + 1][j_imopVar84][k_imopVar85][0]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][1] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][1] + tx3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83 + 1][j_imopVar84][k_imopVar85][1] - flux[i_imopVar83][j_imopVar84][k_imopVar85][1]) + dx2 * tx1 * (u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][1] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][1] + u[i_imopVar83 + 1][j_imopVar84][k_imopVar85][1]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][2] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][2] + tx3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83 + 1][j_imopVar84][k_imopVar85][2] - flux[i_imopVar83][j_imopVar84][k_imopVar85][2]) + dx3 * tx1 * (u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][2] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][2] + u[i_imopVar83 + 1][j_imopVar84][k_imopVar85][2]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][3] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][3] + tx3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83 + 1][j_imopVar84][k_imopVar85][3] - flux[i_imopVar83][j_imopVar84][k_imopVar85][3]) + dx4 * tx1 * (u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][3] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][3] + u[i_imopVar83 + 1][j_imopVar84][k_imopVar85][3]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][4] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][4] + tx3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83 + 1][j_imopVar84][k_imopVar85][4] - flux[i_imopVar83][j_imopVar84][k_imopVar85][4]) + dx5 * tx1 * (u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][4] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][4] + u[i_imopVar83 + 1][j_imopVar84][k_imopVar85][4]);
                    }
                    for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                        rsd[1][j_imopVar84][k_imopVar85][m_imopVar86] = rsd[1][j_imopVar84][k_imopVar85][m_imopVar86] - dssp * (+5.0 * u[1][j_imopVar84][k_imopVar85][m_imopVar86] - 4.0 * u[2][j_imopVar84][k_imopVar85][m_imopVar86] + u[3][j_imopVar84][k_imopVar85][m_imopVar86]);
                        rsd[2][j_imopVar84][k_imopVar85][m_imopVar86] = rsd[2][j_imopVar84][k_imopVar85][m_imopVar86] - dssp * (-4.0 * u[1][j_imopVar84][k_imopVar85][m_imopVar86] + 6.0 * u[2][j_imopVar84][k_imopVar85][m_imopVar86] - 4.0 * u[3][j_imopVar84][k_imopVar85][m_imopVar86] + u[4][j_imopVar84][k_imopVar85][m_imopVar86]);
                    }
                    ist1 = 3;
                    iend1 = nx - 4;
                    for (i_imopVar83 = ist1; i_imopVar83 <= iend1; i_imopVar83++) {
                        for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                            rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] - dssp * (u[i_imopVar83 - 2][j_imopVar84][k_imopVar85][m_imopVar86] - 4.0 * u[i_imopVar83 - 1][j_imopVar84][k_imopVar85][m_imopVar86] + 6.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] - 4.0 * u[i_imopVar83 + 1][j_imopVar84][k_imopVar85][m_imopVar86] + u[i_imopVar83 + 2][j_imopVar84][k_imopVar85][m_imopVar86]);
                        }
                    }
                    for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                        rsd[nx - 3][j_imopVar84][k_imopVar85][m_imopVar86] = rsd[nx - 3][j_imopVar84][k_imopVar85][m_imopVar86] - dssp * (u[nx - 5][j_imopVar84][k_imopVar85][m_imopVar86] - 4.0 * u[nx - 4][j_imopVar84][k_imopVar85][m_imopVar86] + 6.0 * u[nx - 3][j_imopVar84][k_imopVar85][m_imopVar86] - 4.0 * u[nx - 2][j_imopVar84][k_imopVar85][m_imopVar86]);
                        rsd[nx - 2][j_imopVar84][k_imopVar85][m_imopVar86] = rsd[nx - 2][j_imopVar84][k_imopVar85][m_imopVar86] - dssp * (u[nx - 4][j_imopVar84][k_imopVar85][m_imopVar86] - 4.0 * u[nx - 3][j_imopVar84][k_imopVar85][m_imopVar86] + 5.0 * u[nx - 2][j_imopVar84][k_imopVar85][m_imopVar86]);
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
            for (i_imopVar83 = ist; i_imopVar83 <= iend; i_imopVar83++) {
                for (j_imopVar84 = L1; j_imopVar84 <= L2; j_imopVar84++) {
                    for (k_imopVar85 = 1; k_imopVar85 <= nz - 2; k_imopVar85++) {
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][0] = u[i_imopVar83][j_imopVar84][k_imopVar85][2];
                        u31 = u[i_imopVar83][j_imopVar84][k_imopVar85][2] / u[i_imopVar83][j_imopVar84][k_imopVar85][0];
                        q = 0.50 * (u[i_imopVar83][j_imopVar84][k_imopVar85][1] * u[i_imopVar83][j_imopVar84][k_imopVar85][1] + u[i_imopVar83][j_imopVar84][k_imopVar85][2] * u[i_imopVar83][j_imopVar84][k_imopVar85][2] + u[i_imopVar83][j_imopVar84][k_imopVar85][3] * u[i_imopVar83][j_imopVar84][k_imopVar85][3]) / u[i_imopVar83][j_imopVar84][k_imopVar85][0];
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][1] = u[i_imopVar83][j_imopVar84][k_imopVar85][1] * u31;
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][2] = u[i_imopVar83][j_imopVar84][k_imopVar85][2] * u31 + 0.40e+00 * (u[i_imopVar83][j_imopVar84][k_imopVar85][4] - q);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][3] = u[i_imopVar83][j_imopVar84][k_imopVar85][3] * u31;
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][4] = (1.40e+00 * u[i_imopVar83][j_imopVar84][k_imopVar85][4] - 0.40e+00 * q) * u31;
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
            for (i_imopVar83 = ist; i_imopVar83 <= iend; i_imopVar83++) {
                for (k_imopVar85 = 1; k_imopVar85 <= nz - 2; k_imopVar85++) {
                    for (j_imopVar84 = jst; j_imopVar84 <= jend; j_imopVar84++) {
                        for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                            rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] - ty2 * (flux[i_imopVar83][j_imopVar84 + 1][k_imopVar85][m_imopVar86] - flux[i_imopVar83][j_imopVar84 - 1][k_imopVar85][m_imopVar86]);
                        }
                    }
                    L2 = ny - 1;
                    for (j_imopVar84 = jst; j_imopVar84 <= L2; j_imopVar84++) {
                        tmp_imopVar87 = 1.0 / u[i_imopVar83][j_imopVar84][k_imopVar85][0];
                        u21j = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][1];
                        u31j = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][2];
                        u41j = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][3];
                        u51j = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][4];
                        tmp_imopVar87 = 1.0 / u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][0];
                        u21jm1 = tmp_imopVar87 * u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][1];
                        u31jm1 = tmp_imopVar87 * u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][2];
                        u41jm1 = tmp_imopVar87 * u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][3];
                        u51jm1 = tmp_imopVar87 * u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][4];
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][1] = ty3 * (u21j - u21jm1);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][2] = (4.0 / 3.0) * ty3 * (u31j - u31jm1);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][3] = ty3 * (u41j - u41jm1);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][4] = 0.50 * (1.0 - 1.40e+00 * 1.40e+00) * ty3 * (((u21j * u21j) + (u31j * u31j) + (u41j * u41j)) - ((u21jm1 * u21jm1) + (u31jm1 * u31jm1) + (u41jm1 * u41jm1))) + (1.0 / 6.0) * ty3 * ((u31j * u31j) - (u31jm1 * u31jm1)) + 1.40e+00 * 1.40e+00 * ty3 * (u51j - u51jm1);
                    }
                    for (j_imopVar84 = jst; j_imopVar84 <= jend; j_imopVar84++) {
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][0] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][0] + dy1 * ty1 * (u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][0] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][0] + u[i_imopVar83][j_imopVar84 + 1][k_imopVar85][0]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][1] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][1] + ty3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83][j_imopVar84 + 1][k_imopVar85][1] - flux[i_imopVar83][j_imopVar84][k_imopVar85][1]) + dy2 * ty1 * (u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][1] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][1] + u[i_imopVar83][j_imopVar84 + 1][k_imopVar85][1]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][2] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][2] + ty3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83][j_imopVar84 + 1][k_imopVar85][2] - flux[i_imopVar83][j_imopVar84][k_imopVar85][2]) + dy3 * ty1 * (u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][2] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][2] + u[i_imopVar83][j_imopVar84 + 1][k_imopVar85][2]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][3] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][3] + ty3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83][j_imopVar84 + 1][k_imopVar85][3] - flux[i_imopVar83][j_imopVar84][k_imopVar85][3]) + dy4 * ty1 * (u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][3] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][3] + u[i_imopVar83][j_imopVar84 + 1][k_imopVar85][3]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][4] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][4] + ty3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83][j_imopVar84 + 1][k_imopVar85][4] - flux[i_imopVar83][j_imopVar84][k_imopVar85][4]) + dy5 * ty1 * (u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][4] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][4] + u[i_imopVar83][j_imopVar84 + 1][k_imopVar85][4]);
                    }
                    for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                        rsd[i_imopVar83][1][k_imopVar85][m_imopVar86] = rsd[i_imopVar83][1][k_imopVar85][m_imopVar86] - dssp * (+5.0 * u[i_imopVar83][1][k_imopVar85][m_imopVar86] - 4.0 * u[i_imopVar83][2][k_imopVar85][m_imopVar86] + u[i_imopVar83][3][k_imopVar85][m_imopVar86]);
                        rsd[i_imopVar83][2][k_imopVar85][m_imopVar86] = rsd[i_imopVar83][2][k_imopVar85][m_imopVar86] - dssp * (-4.0 * u[i_imopVar83][1][k_imopVar85][m_imopVar86] + 6.0 * u[i_imopVar83][2][k_imopVar85][m_imopVar86] - 4.0 * u[i_imopVar83][3][k_imopVar85][m_imopVar86] + u[i_imopVar83][4][k_imopVar85][m_imopVar86]);
                    }
                    jst1 = 3;
                    jend1 = ny - 4;
                    for (j_imopVar84 = jst1; j_imopVar84 <= jend1; j_imopVar84++) {
                        for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                            rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] - dssp * (u[i_imopVar83][j_imopVar84 - 2][k_imopVar85][m_imopVar86] - 4.0 * u[i_imopVar83][j_imopVar84 - 1][k_imopVar85][m_imopVar86] + 6.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] - 4.0 * u[i_imopVar83][j_imopVar84 + 1][k_imopVar85][m_imopVar86] + u[i_imopVar83][j_imopVar84 + 2][k_imopVar85][m_imopVar86]);
                        }
                    }
                    for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                        rsd[i_imopVar83][ny - 3][k_imopVar85][m_imopVar86] = rsd[i_imopVar83][ny - 3][k_imopVar85][m_imopVar86] - dssp * (u[i_imopVar83][ny - 5][k_imopVar85][m_imopVar86] - 4.0 * u[i_imopVar83][ny - 4][k_imopVar85][m_imopVar86] + 6.0 * u[i_imopVar83][ny - 3][k_imopVar85][m_imopVar86] - 4.0 * u[i_imopVar83][ny - 2][k_imopVar85][m_imopVar86]);
                        rsd[i_imopVar83][ny - 2][k_imopVar85][m_imopVar86] = rsd[i_imopVar83][ny - 2][k_imopVar85][m_imopVar86] - dssp * (u[i_imopVar83][ny - 4][k_imopVar85][m_imopVar86] - 4.0 * u[i_imopVar83][ny - 3][k_imopVar85][m_imopVar86] + 5.0 * u[i_imopVar83][ny - 2][k_imopVar85][m_imopVar86]);
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
            for (i_imopVar83 = ist; i_imopVar83 <= iend; i_imopVar83++) {
                for (j_imopVar84 = jst; j_imopVar84 <= jend; j_imopVar84++) {
                    for (k_imopVar85 = 0; k_imopVar85 <= nz - 1; k_imopVar85++) {
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][0] = u[i_imopVar83][j_imopVar84][k_imopVar85][3];
                        u41 = u[i_imopVar83][j_imopVar84][k_imopVar85][3] / u[i_imopVar83][j_imopVar84][k_imopVar85][0];
                        q = 0.50 * (u[i_imopVar83][j_imopVar84][k_imopVar85][1] * u[i_imopVar83][j_imopVar84][k_imopVar85][1] + u[i_imopVar83][j_imopVar84][k_imopVar85][2] * u[i_imopVar83][j_imopVar84][k_imopVar85][2] + u[i_imopVar83][j_imopVar84][k_imopVar85][3] * u[i_imopVar83][j_imopVar84][k_imopVar85][3]) / u[i_imopVar83][j_imopVar84][k_imopVar85][0];
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][1] = u[i_imopVar83][j_imopVar84][k_imopVar85][1] * u41;
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][2] = u[i_imopVar83][j_imopVar84][k_imopVar85][2] * u41;
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][3] = u[i_imopVar83][j_imopVar84][k_imopVar85][3] * u41 + 0.40e+00 * (u[i_imopVar83][j_imopVar84][k_imopVar85][4] - q);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][4] = (1.40e+00 * u[i_imopVar83][j_imopVar84][k_imopVar85][4] - 0.40e+00 * q) * u41;
                    }
                    for (k_imopVar85 = 1; k_imopVar85 <= nz - 2; k_imopVar85++) {
                        for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                            rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] - tz2 * (flux[i_imopVar83][j_imopVar84][k_imopVar85 + 1][m_imopVar86] - flux[i_imopVar83][j_imopVar84][k_imopVar85 - 1][m_imopVar86]);
                        }
                    }
                    for (k_imopVar85 = 1; k_imopVar85 <= nz - 1; k_imopVar85++) {
                        tmp_imopVar87 = 1.0 / u[i_imopVar83][j_imopVar84][k_imopVar85][0];
                        u21k = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][1];
                        u31k = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][2];
                        u41k = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][3];
                        u51k = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85][4];
                        tmp_imopVar87 = 1.0 / u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][0];
                        u21km1 = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][1];
                        u31km1 = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][2];
                        u41km1 = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][3];
                        u51km1 = tmp_imopVar87 * u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][4];
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][1] = tz3 * (u21k - u21km1);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][2] = tz3 * (u31k - u31km1);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][3] = (4.0 / 3.0) * tz3 * (u41k - u41km1);
                        flux[i_imopVar83][j_imopVar84][k_imopVar85][4] = 0.50 * (1.0 - 1.40e+00 * 1.40e+00) * tz3 * (((u21k * u21k) + (u31k * u31k) + (u41k * u41k)) - ((u21km1 * u21km1) + (u31km1 * u31km1) + (u41km1 * u41km1))) + (1.0 / 6.0) * tz3 * ((u41k * u41k) - (u41km1 * u41km1)) + 1.40e+00 * 1.40e+00 * tz3 * (u51k - u51km1);
                    }
                    for (k_imopVar85 = 1; k_imopVar85 <= nz - 2; k_imopVar85++) {
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][0] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][0] + dz1 * tz1 * (u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][0] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][0] + u[i_imopVar83][j_imopVar84][k_imopVar85 + 1][0]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][1] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][1] + tz3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83][j_imopVar84][k_imopVar85 + 1][1] - flux[i_imopVar83][j_imopVar84][k_imopVar85][1]) + dz2 * tz1 * (u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][1] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][1] + u[i_imopVar83][j_imopVar84][k_imopVar85 + 1][1]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][2] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][2] + tz3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83][j_imopVar84][k_imopVar85 + 1][2] - flux[i_imopVar83][j_imopVar84][k_imopVar85][2]) + dz3 * tz1 * (u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][2] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][2] + u[i_imopVar83][j_imopVar84][k_imopVar85 + 1][2]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][3] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][3] + tz3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83][j_imopVar84][k_imopVar85 + 1][3] - flux[i_imopVar83][j_imopVar84][k_imopVar85][3]) + dz4 * tz1 * (u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][3] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][3] + u[i_imopVar83][j_imopVar84][k_imopVar85 + 1][3]);
                        rsd[i_imopVar83][j_imopVar84][k_imopVar85][4] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][4] + tz3 * 1.00e-01 * 1.00e+00 * (flux[i_imopVar83][j_imopVar84][k_imopVar85 + 1][4] - flux[i_imopVar83][j_imopVar84][k_imopVar85][4]) + dz5 * tz1 * (u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][4] - 2.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][4] + u[i_imopVar83][j_imopVar84][k_imopVar85 + 1][4]);
                    }
                    for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                        rsd[i_imopVar83][j_imopVar84][1][m_imopVar86] = rsd[i_imopVar83][j_imopVar84][1][m_imopVar86] - dssp * (+5.0 * u[i_imopVar83][j_imopVar84][1][m_imopVar86] - 4.0 * u[i_imopVar83][j_imopVar84][2][m_imopVar86] + u[i_imopVar83][j_imopVar84][3][m_imopVar86]);
                        rsd[i_imopVar83][j_imopVar84][2][m_imopVar86] = rsd[i_imopVar83][j_imopVar84][2][m_imopVar86] - dssp * (-4.0 * u[i_imopVar83][j_imopVar84][1][m_imopVar86] + 6.0 * u[i_imopVar83][j_imopVar84][2][m_imopVar86] - 4.0 * u[i_imopVar83][j_imopVar84][3][m_imopVar86] + u[i_imopVar83][j_imopVar84][4][m_imopVar86]);
                    }
                    for (k_imopVar85 = 3; k_imopVar85 <= nz - 4; k_imopVar85++) {
                        for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                            rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] = rsd[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] - dssp * (u[i_imopVar83][j_imopVar84][k_imopVar85 - 2][m_imopVar86] - 4.0 * u[i_imopVar83][j_imopVar84][k_imopVar85 - 1][m_imopVar86] + 6.0 * u[i_imopVar83][j_imopVar84][k_imopVar85][m_imopVar86] - 4.0 * u[i_imopVar83][j_imopVar84][k_imopVar85 + 1][m_imopVar86] + u[i_imopVar83][j_imopVar84][k_imopVar85 + 2][m_imopVar86]);
                        }
                    }
                    for (m_imopVar86 = 0; m_imopVar86 < 5; m_imopVar86++) {
                        rsd[i_imopVar83][j_imopVar84][nz - 3][m_imopVar86] = rsd[i_imopVar83][j_imopVar84][nz - 3][m_imopVar86] - dssp * (u[i_imopVar83][j_imopVar84][nz - 5][m_imopVar86] - 4.0 * u[i_imopVar83][j_imopVar84][nz - 4][m_imopVar86] + 6.0 * u[i_imopVar83][j_imopVar84][nz - 3][m_imopVar86] - 4.0 * u[i_imopVar83][j_imopVar84][nz - 2][m_imopVar86]);
                        rsd[i_imopVar83][j_imopVar84][nz - 2][m_imopVar86] = rsd[i_imopVar83][j_imopVar84][nz - 2][m_imopVar86] - dssp * (u[i_imopVar83][j_imopVar84][nz - 4][m_imopVar86] - 4.0 * u[i_imopVar83][j_imopVar84][nz - 3][m_imopVar86] + 5.0 * u[i_imopVar83][j_imopVar84][nz - 2][m_imopVar86]);
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
...
#pragma omp for nowait
                for (i_imopVar88 = ist; i_imopVar88 <= iend; i_imopVar88++) {
                    for (j_imopVar89 = jst; j_imopVar89 <= jend; j_imopVar89++) {
                        for (k_imopVar90 = 1; k_imopVar90 <= nz0 - 2; k_imopVar90++) {
                            sum0 = sum0 + v[i_imopVar88][j_imopVar89][k_imopVar90][0] * v[i_imopVar88][j_imopVar89][k_imopVar90][0];
                            sum1 = sum1 + v[i_imopVar88][j_imopVar89][k_imopVar90][1] * v[i_imopVar88][j_imopVar89][k_imopVar90][1];
                            sum2 = sum2 + v[i_imopVar88][j_imopVar89][k_imopVar90][2] * v[i_imopVar88][j_imopVar89][k_imopVar90][2];
                            sum3 = sum3 + v[i_imopVar88][j_imopVar89][k_imopVar90][3] * v[i_imopVar88][j_imopVar89][k_imopVar90][3];
                            sum4 = sum4 + v[i_imopVar88][j_imopVar89][k_imopVar90][4] * v[i_imopVar88][j_imopVar89][k_imopVar90][4];
                        }
                    }
                }
// #pragma omp dummyFlush CRITICAL_START
...
#pragma omp single nowait
                {
                    for (m_imopVar91 = 0; m_imopVar91 < 5; m_imopVar91++) {
                        double _imopVarPre154;
                        double _imopVarPre155;
                        _imopVarPre154 = sum[m_imopVar91] / ((nx0 - 2) * (ny0 - 2) * (nz0 - 2));
                        _imopVarPre155 = sqrt(_imopVarPre154);
                        sum[m_imopVar91] = _imopVarPre155;
                    }
                }
            }
// #pragma omp dummyFlush BARRIER_START
