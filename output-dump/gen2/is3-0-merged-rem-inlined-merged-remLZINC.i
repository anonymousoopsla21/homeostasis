...
#pragma omp parallel
    {
        int iteration_imopVar0;
        iteration_imopVar0 = 1;
        INT_TYPE i_imopVar1;
        INT_TYPE k;
        11 - 9;
        INT_TYPE prv_buff1[(1 << 11)];
#pragma omp master
        {
            key_array[iteration_imopVar0] = iteration_imopVar0;
            key_array[iteration_imopVar0 + 10] = (1 << 11) - iteration_imopVar0;
            for (i_imopVar1 = 0; i_imopVar1 < 5; i_imopVar1++) {
                partial_verify_vals[i_imopVar1] = key_array[test_index_array[i_imopVar1]];
            }
            for (i_imopVar1 = 0; i_imopVar1 < (1 << 11); i_imopVar1++) {
                key_buff1[i_imopVar1] = 0;
            }
        }
// #pragma omp dummyFlush BARRIER_START
#pragma omp barrier
        for (i_imopVar1 = 0; i_imopVar1 < (1 << 11); i_imopVar1++) {
            prv_buff1[i_imopVar1] = 0;
        }
#pragma omp for nowait
        for (i_imopVar1 = 0; i_imopVar1 < (1 << 16); i_imopVar1++) {
            key_buff2[i_imopVar1] = key_array[i_imopVar1];
            prv_buff1[key_buff2[i_imopVar1]]++;
        }
        for (i_imopVar1 = 0; i_imopVar1 < (1 << 11) - 1; i_imopVar1++) {
            prv_buff1[i_imopVar1 + 1] += prv_buff1[i_imopVar1];
        }
// #pragma omp dummyFlush CRITICAL_START
#pragma omp critical
        {
            for (i_imopVar1 = 0; i_imopVar1 < (1 << 11); i_imopVar1++) {
                key_buff1[i_imopVar1] += prv_buff1[i_imopVar1];
            }
        }
// #pragma omp dummyFlush CRITICAL_END
#pragma omp master
        {
            for (i_imopVar1 = 0; i_imopVar1 < 5; i_imopVar1++) {
                k = partial_verify_vals[i_imopVar1];
                int _imopVarPre35;
                _imopVarPre35 = 0 <= k;
                if (_imopVarPre35) {
                    _imopVarPre35 = k <= (1 << 16) - 1;
                ...
                if (_imopVarPre35) {
                    switch ('S') {
                        case 'S': if (i_imopVar1 <= 2) {
                            if (key_buff1[k - 1] != test_rank_array[i_imopVar1] + iteration_imopVar0) {
                                printf("Failed partial verification: " "iteration %d, test key %d\n", iteration_imopVar0, i_imopVar1);
                            } else {
                                passed_verification++;
                            }
                        } else {
                        ...
                        break;
                        case 'W': if (i_imopVar1 < 2) {
                            if (key_buff1[k - 1] != test_rank_array[i_imopVar1] + (iteration_imopVar0 - 2)) {
                                printf("Failed partial verification: " "iteration %d, test key %d\n", iteration_imopVar0, i_imopVar1);
                            } else {
                                passed_verification++;
                            }
                        ...
                        break;
                        case 'A': if (i_imopVar1 <= 2) {
                            if (key_buff1[k - 1] != test_rank_array[i_imopVar1] + (iteration_imopVar0 - 1)) {
                                printf("Failed partial verification: " "iteration %d, test key %d\n", iteration_imopVar0, i_imopVar1);
                            } else {
                                passed_verification++;
                            }
                        ...
                        int _imopVarPre36;
                        int _imopVarPre37;
                        _imopVarPre36 = i_imopVar1 == 1;
                        if (!_imopVarPre36) {
                            _imopVarPre37 = i_imopVar1 == 2;
                            if (!_imopVarPre37) {
                                _imopVarPre37 = i_imopVar1 == 4;
                            }
                            _imopVarPre36 = _imopVarPre37;
                        }
                        if (_imopVarPre36) {
                    ...
                    if (_imopVarPre35) {
                        switch ('S') {
                            case 'S': if (i_imopVar77 <= 2) {
                                if (key_buff1[k - 1] != test_rank_array[i_imopVar77] + iteration) {
                                    printf("Failed partial verification: " "iteration %d, test key %d\n", iteration, i_imopVar77);
                                } else {
                                    passed_verification++;
                                }
                            } else {
                            ...
                            case 'W': if (i_imopVar77 < 2) {
                                if (key_buff1[k - 1] != test_rank_array[i_imopVar77] + (iteration - 2)) {
                                    printf("Failed partial verification: " "iteration %d, test key %d\n", iteration, i_imopVar77);
                                } else {
                                    passed_verification++;
                                }
                            ...
                            case 'A': if (i_imopVar77 <= 2) {
                                if (key_buff1[k - 1] != test_rank_array[i_imopVar77] + (iteration - 1)) {
                                    printf("Failed partial verification: " "iteration %d, test key %d\n", iteration, i_imopVar77);
                                } else {
                                    passed_verification++;
                                }
