...
int main(int argc, char **argv) {
    ...
    if (_imopVarPre134 == 0) {
        ...
        ptsTo(B) := [nullCell];
        ptsTo(C) := [nullCell];
        ptsTo(_imopVarPre50) := [heapCell#8];
        ]*/
        /*OUT: [ptsTo(stderr) := [nullCell];
        ptsTo(X) := [heapCell#1];
        ptsTo(_imopVarPre87) := [heapCell#1];
...
#pragma omp parallel num_threads(procs) shared(A_imopVar0, B, dim)
        {
            ...
            for (i = start; i < end; ++i) {
                ...
                ptsTo(C) := [nullCell];
                ptsTo(_imopVarPre50) := [heapCell#8];
                ptsTo(_imopVarPre61) := [heapCell#7];
                ptsTo(heapCell#8) := [heapCell#7];
                ]*/
                /*OUT: [ptsTo(stderr) := [nullCell];
                ptsTo(X) := [heapCell#1];
                ...
                ptsTo(_imopVarPre50) := [heapCell#8];
                ptsTo(_imopVarPre61) := [heapCell#7];
                ptsTo(_imopVarPre66) := [nullCell, heapCell#2];
                ptsTo(_imopVarPre67) := [heapCell#7];
                ptsTo(heapCell#8) := [heapCell#7];
                ]*/
                _imopVarPre67 = B[i];
                /*OUT: [ptsTo(stderr) := [nullCell];
                ...
                ptsTo(_imopVarPre61) := [heapCell#7];
                ptsTo(_imopVarPre66) := [nullCell, heapCell#2];
                ptsTo(_imopVarPre67) := [heapCell#7, nullCell];
                ptsTo(heapCell#8) := [heapCell#7];
                ]*/
...
#pragma omp parallel num_threads(procs) firstprivate(done)
        {
            ...
            ptsTo(_imopVarPre132) := [start_time];
            ptsTo(heapCell#1) := [heapCell#2];
            ptsTo(A_imopVar0) := [heapCell#1, heapCell#8];
            ptsTo(B) := [heapCell#1, heapCell#8];
            ptsTo(C) := [heapCell#1, heapCell#8, nullCell];
            ptsTo(_imopVarPre50) := [heapCell#8];
            ptsTo(heapCell#8) := [heapCell#7];
            ]*/
            while (!done) {
